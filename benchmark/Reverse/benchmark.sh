...
run_benchmark reverse call_by_value CCode copy_reduced
#run_benchmark reverse call_by_value CCode copy_reduced_noleaks
run_benchmark reverse call_by_value CCode naive
#run_benchmark reverse call_by_value CCode naive_noleaks
#Benchmark the generated Java code
run_benchmark reverse call_by_value JAVACode naive