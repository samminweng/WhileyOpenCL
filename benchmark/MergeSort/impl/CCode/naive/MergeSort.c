...
_SLICE_ARRAY(_20, items, pivot, end);
	...
	_21 = sortV1(_1DARRAY_COPY_PARAM(rhs), _22, _23);
	//assign %5 = %21  : int[]
	_1DARRAY_COPY(rhs, _21);
	//const %25 = 0 : int
	_25 = 0;
	//assign %24 = %25  : int
	_24 = _25;
...
blklab7:;
	...
	_20 = sortV1(_1DARRAY_COPY_PARAM(arr), _21, _23);
	//assign %3 = %20  : int[]
