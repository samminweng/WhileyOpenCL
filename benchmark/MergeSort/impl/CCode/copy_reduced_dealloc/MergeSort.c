...
long long* sortV1(long long* items, bool items_has_ownership, long long items_size, long long start, long long end){
	...
	_17_size = lhs_size; 	_17 = sortV1(lhs, false, lhs_size, _18, pivot);
	lhs_has_ownership = false;
	...
	_21_size = rhs_size; 	_21 = sortV1(rhs, false, rhs_size, _22, _23);
	rhs_has_ownership = false;
...
blklab7:;
	...
	if(_20_has_ownership){free(_20); _20_has_ownership = false;}
	_20_size = arr_size; 	_20 = sortV1(arr, false, arr_size, _21, _23);
	arr_has_ownership = false;
	_20_has_ownership = true;
	//assign %3 = %20  : int[]
	arr_size = _20_size; 
	if(arr_has_ownership){free(arr); arr_has_ownership = false;}
