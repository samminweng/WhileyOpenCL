...
END {	
	print "TestCase,ArrayType,Program,Optimization,ArraySize,1st,2nd,3rd,4th,5th,6th,7th,8th,9th,10th,Average";
	# Get program
	for(program in programs){
		...
		for(optimization in ops){
			...
			for(n=1;n<=num_of_ops;n++){
				parameter = params[n];
				str = testcase",call_by_reference,"program","optimization","parameter;
