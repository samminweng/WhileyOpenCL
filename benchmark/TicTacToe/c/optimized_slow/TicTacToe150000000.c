...
Board EmptyBoard(){
	...
	for(_i=_4; _i<_5; _i++){
		...
		_9=optimized_append(_pieces, &_pieces_size, _8, &_8_size, &_9_size);
		free(_8);
		//assign %0 = %9  : [int]
...
int main(int argc, char** argv){
	...
	Board _18;
	//invoke %4 = () TicTacToe150000000:EmptyBoard : function() -> TicTacToe150000000:Board
	_4=EmptyBoard();
...
//.blklab17
blklab17:;
		//invoke %18 = (%1, %2) TicTacToe150000000:play : function(TicTacToe150000000:Board,TicTacToe150000000:nat) -> TicTacToe150000000:Board
		_18=play(_b ,_p);
