...
BYTE* _decompress_(BYTE* data, size_t data_size, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	while(true){
		...
		//invoke (%26) = (%2, %3, %6) LZ77_opt_decompress:opt_append : function(byte[],LZ77_opt_decompress:nat,byte)->(byte[])
		{
			...
			_26 = _opt_append_(_1DARRAY_PARAM(items), items_length, item, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_26));
		}
		//assign %2 = %26  : byte[]
		// isCopyEliminated = true
...
blklab11:;
		...
		while(true){
			...
			{
				// isCopyEliminated of '_2' = true
				_34 = _opt_append_(_1DARRAY_PARAM(items), items_length, item, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_34));
			}
			//assign %2 = %34  : byte[]
			// isCopyEliminated = true
...
blklab9:;
	...
	{
		// isCopyEliminated of '_2' = true
		_39 = _resize_(_1DARRAY_PARAM(items), items_length, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_39));
	}
	//assign %1 = %39  : byte[]
	// isCopyEliminated = true
...
int main(int argc, char** args){
	...
	{
		// isCopyEliminated of '_2' = true
		_10 = _decompress_(_1DARRAY_PARAM(input_data), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_10));
	}
	//assign %3 = %10  : byte[]
	// isCopyEliminated = true
