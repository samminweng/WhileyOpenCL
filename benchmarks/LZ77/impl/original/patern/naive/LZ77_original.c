...
blklab22:;
	...
	{
		void* output_tmp;
		_33 = resize(_COPY_1DARRAY_PARAM_BYTE(output), _28, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_33));
	}
	//assign %1 = %33  : byte[]
...
int main(int argc, char** args){
	...
	{
		void* data_tmp;
		_22 = compress(_COPY_1DARRAY_PARAM_BYTE(data), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_22));
	}
	//assign %3 = %22  : byte[]
