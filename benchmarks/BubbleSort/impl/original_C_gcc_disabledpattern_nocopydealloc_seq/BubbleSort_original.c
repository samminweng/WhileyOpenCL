...
blklab8:;
		...
		{
			_FUNCTIONCALL_NO_COPY_PRE(_19, arr, 0, "liveness: arr = false, readonly: arr = false, return:arr = ALWAYS_RETURN" , "bubbleSort");
			_DEALLOC(_19);
			// isCopyEliminated of 'arr at 0' = true
			_19 = _bubbleSort_(arr, arr_size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_19));
			_19_dealloc = arr_dealloc;
			arr_dealloc = false;
		}
		//assign %6 = %19  : int[]
		// isCopyEliminated = true
