...
entry:
  ...
  %call1 = tail call i64* @copy1DArray_int64_t(i64* %call, i64 %arr_size) #8
  %cmp32 = icmp slt i64 %arr_size, 1
  br i1 %cmp32, label %blklab0, label %polly.split_new_and_old
...
polly.split_new_and_old:                          ; preds = %entry
  ...
  %polly.access.call1 = getelementptr i64, i64* %call1, i64 %3
  %4 = icmp ule i64* %polly.access.arr, %polly.access.call1
  %polly.access.call134 = getelementptr i64, i64* %call1, i64 %arr_size
  %5 = icmp ule i64* %polly.access.call134, %arr
  %6 = or i1 %4, %5
  %7 = and i1 %0, %6
...
if.end.preheader:                                 ; preds = %polly.split_new_and_old
  ...
  br i1 %min.iters.check, label %if.end.preheader48, label %min.iters.checked

min.iters.checked:                                ; preds = %if.end.preheader
  %n.vec = and i64 %11, -4
  %cmp.zero = icmp eq i64 %n.vec, 0
  br i1 %cmp.zero, label %if.end.preheader48, label %vector.memcheck

vector.memcheck:                                  ; preds = %min.iters.checked
  %12 = xor i64 %arr_size, -1
  %13 = icmp sgt i64 %12, -2
  %smax38 = select i1 %13, i64 %12, i64 -2
  %14 = sub i64 -2, %smax38
  %scevgep = getelementptr i64, i64* %call1, i64 %14
  %scevgep40 = getelementptr i64, i64* %call1, i64 %arr_size
  %15 = add i64 %smax38, %arr_size
  %16 = add i64 %15, 2
  %scevgep43 = getelementptr i64, i64* %arr, i64 %16
  %bound0 = icmp ult i64* %scevgep, %scevgep43
  %bound1 = icmp ugt i64* %scevgep40, %arr
  %memcheck.conflict = and i1 %bound0, %bound1
  %ind.end = sub i64 %arr_size, %n.vec
  br i1 %memcheck.conflict, label %if.end.preheader48, label %vector.body.preheader
...
vector.body.prol:                                 ; preds = %vector.body.prol.preheader
  ...
  %wide.load46.prol = load <2 x i64>, <2 x i64>* %22, align 8, !tbaa !1, !alias.scope !5
  %23 = add nsw i64 %arr_size, -1
  %24 = getelementptr inbounds i64, i64* %call1, i64 %23
  ...
  %reverse47.prol = shufflevector <2 x i64> %wide.load46.prol, <2 x i64> undef, <2 x i32> <i32 1, i32 0>
  %27 = getelementptr i64, i64* %24, i64 -2
  %28 = getelementptr i64, i64* %27, i64 -1
  %29 = bitcast i64* %28 to <2 x i64>*
  store <2 x i64> %reverse47.prol, <2 x i64>* %29, align 8, !tbaa !1, !alias.scope !8, !noalias !5
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  ...
  %wide.load46 = load <2 x i64>, <2 x i64>* %34, align 8, !tbaa !1, !alias.scope !5
  %35 = add nsw i64 %offset.idx, -1
  %36 = getelementptr inbounds i64, i64* %call1, i64 %35
  ...
  %reverse47 = shufflevector <2 x i64> %wide.load46, <2 x i64> undef, <2 x i32> <i32 1, i32 0>
  %39 = getelementptr i64, i64* %36, i64 -2
  %40 = getelementptr i64, i64* %39, i64 -1
  %41 = bitcast i64* %40 to <2 x i64>*
  store <2 x i64> %reverse47, <2 x i64>* %41, align 8, !tbaa !1, !alias.scope !8, !noalias !5
  ...
  %wide.load46.1 = load <2 x i64>, <2 x i64>* %45, align 8, !tbaa !1, !alias.scope !5
  %46 = add nsw i64 %offset.idx.1, -1
  %47 = getelementptr inbounds i64, i64* %call1, i64 %46
  ...
  %reverse47.1 = shufflevector <2 x i64> %wide.load46.1, <2 x i64> undef, <2 x i32> <i32 1, i32 0>
  %50 = getelementptr i64, i64* %47, i64 -2
  %51 = getelementptr i64, i64* %50, i64 -1
  %52 = bitcast i64* %51 to <2 x i64>*
  store <2 x i64> %reverse47.1, <2 x i64>* %52, align 8, !tbaa !1, !alias.scope !8, !noalias !5
...
middle.block:                                     ; preds = %vector.body.prol.loopexit, %middle.block.unr-lcssa
  ...
  br i1 %cmp.n, label %blklab0, label %if.end.preheader48

if.end.preheader48:                               ; preds = %middle.block, %vector.memcheck, %min.iters.checked, %if.end.preheader
  %i.033.ph = phi i64 [ %arr_size, %vector.memcheck ], [ %arr_size, %min.iters.checked ], [ %arr_size, %if.end.preheader ], [ %ind.end, %middle.block ]
  br label %if.end

if.end:                                           ; preds = %if.end.preheader48, %if.end
  %i.033 = phi i64 [ %sub2, %if.end ], [ %i.033.ph, %if.end.preheader48 ]
  ...
  store i64 %54, i64* %arrayidx3, align 8, !tbaa !1
...
polly.parallel.for:                               ; preds = %polly.split_new_and_old
  ...
  %polly.subfunc.arg.call1.i = load i64*, i64** %polly.subfn.storeaddr.call1, align 8
...
polly.par.loadIVBounds.preheader.i:               ; preds = %polly.parallel.for
  ...
  %scevgep2.i = getelementptr i64, i64* %polly.subfunc.arg.call1.i, i64 %60
...
entry:
  ...
  br i1 %cmp579, label %polly.parallel.for, label %blklab5

blklab5:                                          ; preds = %main_polly_subfn.exit, %entry
  ...
  %call18 = call i64* @create1DArray_int64_t(i64 0, i64 22) #8
  ...
  call void @println_s(i64* %call18, i64 22) #8
...
polly.loop_header.i:                              ; preds = %polly.loop_header.i, %polly.par.loadIVBounds.i
  ...
  store i64 %26, i64* %scevgep.i, align 8, !alias.scope !21, !noalias !23
  %polly.indvar_next.i = add nsw i64 %polly.indvar.i, 1
  %polly.loop_cond.i = icmp sgt i64 %polly.indvar.i, %polly.adjust_ub.i
  br i1 %polly.loop_cond.i, label %polly.par.checkNext.loopexit.i, label %polly.loop_header.i
...
polly.par.loadIVBounds.preheader:                 ; preds = %polly.par.setup
  ...
  %scevgep2 = getelementptr i64, i64* %polly.subfunc.arg.call1, i64 %7
...
!16 = !{!17}
!17 = distinct !{!17, !15, !"polly.alias.scope.call1"}
!18 = !{!14}
!19 = !{!20, !20, i64 0}
...
!26 = !{!27}
!27 = distinct !{!27, !25, !"polly.alias.scope.call1"}
!28 = !{!24}
!29 = distinct !{!29, !30, !"polly.alias.scope.call4"}
