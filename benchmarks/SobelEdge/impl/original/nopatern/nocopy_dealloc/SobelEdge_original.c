...
int main(int argc, char** args){
	...
	{
		_DEALLOC(_18);
		_18 = sobelEdgeDetection(_1DARRAY_PARAM(pixels), false, width, height, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_18));
	...
	{
		print_pbm(stdout, width, height, _1DARRAY_PARAM(newPixels), false);
