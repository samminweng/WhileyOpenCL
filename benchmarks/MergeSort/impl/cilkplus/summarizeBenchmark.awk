...
BEGIN {
	...
	## Compiler
	programtypes["mergesort"] = "seq cilk cilkpipeline seqcilk seqcilkpipeline";

	# The number of threads
	threads["seq"]="1";
	threads["cilk"]="1 2 4 8";
	threads["cilkpipeline"]="1 2 4 8";
	threads["seqcilk"]="1 2 4 8";
	threads["seqcilkpipeline"]="1 2 4 8";
	# Results
	cpu_utils[""] = "";
	exec_times[""] = "";
	counts[""]=0;
