...
blklab44:;
		...
		{
			void* till_tmp;
			_28 = _toString_(_COPY_1DARRAY_PARAM_int64_t(till), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_28));
		}
		...
		{
			void* _32_tmp;
			_30 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_32), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_30));
		}
		//const %33 = 85 : int
		_33 = 85;
		//invoke (%29) = (%0, %4, %30, %33) Cashtill_original:buy : method(whiley/lang/System:Console,Cashtill_original:Cash,Cashtill_original:Cash,int)->(Cashtill_original:Cash)
		{
			void* till_tmp;
			void* _30_tmp;
			_29 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_30), _33, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_29));
		}
		//assign %4 = %29  : int[]
		...
		{
			void* _37_tmp;
			_35 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_37), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_35));
		}
		//const %38 = 105 : int
		_38 = 105;
		//invoke (%34) = (%0, %4, %35, %38) Cashtill_original:buy : method(whiley/lang/System:Console,Cashtill_original:Cash,Cashtill_original:Cash,int)->(Cashtill_original:Cash)
		{
			void* till_tmp;
			void* _35_tmp;
			_34 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_35), _38, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_34));
		}
		//assign %4 = %34  : int[]
		...
		{
			void* _42_tmp;
			_40 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_42), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_40));
		}
		//const %43 = 5 : int
		_43 = 5;
		//invoke (%39) = (%0, %4, %40, %43) Cashtill_original:buy : method(whiley/lang/System:Console,Cashtill_original:Cash,Cashtill_original:Cash,int)->(Cashtill_original:Cash)
		{
			void* till_tmp;
			void* _40_tmp;
			_39 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_40), _43, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_39));
		}
		//assign %4 = %39  : int[]
		...
		{
			void* _47_tmp;
			_45 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_47), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_45));
		}
		//const %48 = 305 : int
		_48 = 305;
		//invoke (%44) = (%0, %4, %45, %48) Cashtill_original:buy : method(whiley/lang/System:Console,Cashtill_original:Cash,Cashtill_original:Cash,int)->(Cashtill_original:Cash)
		{
			void* till_tmp;
			void* _45_tmp;
			_44 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_45), _48, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_44));
		}
		//assign %4 = %44  : int[]
