...
entry:
  ...
  br i1 %cmp, label %if.end93.critedge, label %if.end8

if.end8:                                          ; preds = %entry
  %1 = load i64, i64* %call1, align 8, !tbaa !11
  %conv13 = trunc i64 %1 to i32
  %call14 = tail call i64* @create1DArray(i32 0, i32 %conv13) #7
  %cmp20160 = icmp slt i64 %1, 0
  br i1 %cmp20160, label %if.then74, label %polly.split_new_and_old
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.new
  %vec.ind = phi <2 x i64> [ <i64 0, i64 1>, %vector.body.preheader.new ], [ %step.add169.1, %vector.body ]
  ...
  %step.add169.1 = add <2 x i64> %vec.ind, <i64 8, i64 8>
...
if.end28:                                         ; preds = %if.end28.loopexit, %main_polly_subfn.exit
  ...
  br i1 %cmp76.i, label %if.then74, label %while.cond18.preheader.lr.ph.i
...
while.cond.loopexit.i:                            ; preds = %polly.stmt.blklab4.i
  ...
  br i1 %cmp.i, label %if.then74.loopexit, label %while.cond18.preheader.i
...
while.cond18.preheader.i:                         ; preds = %while.cond.loopexit.i, %while.cond18.preheader.lr.ph.i
  ...
  br i1 %cmp2073.i, label %polly.loop_header.preheader.i, label %if.then74.loopexit
...
polly.par.checkNext.loopexit.i:                   ; preds = %polly.loop_header.i165
...
polly.par.loadIVBounds.i:                         ; preds = %polly.par.loadIVBounds.i.preheader, %polly.par.checkNext.loopexit.i
  ...
  br label %polly.loop_header.i165

polly.loop_header.i165:                           ; preds = %polly.loop_header.i165, %polly.par.loadIVBounds.i
  %polly.indvar.i163 = phi i64 [ %polly.par.LB.i, %polly.par.loadIVBounds.i ], [ %polly.indvar_next.i, %polly.loop_header.i165 ]
  %scevgep.i164 = getelementptr i64, i64* %polly.subfunc.arg.call14.i, i64 %polly.indvar.i163
  %42 = sub i64 %polly.subfunc.arg..i, %polly.indvar.i163
  store i64 %42, i64* %scevgep.i164, align 8, !alias.scope !22, !noalias !24
  %polly.indvar_next.i = add nsw i64 %polly.indvar.i163, 1
  %polly.loop_cond.i = icmp sgt i64 %polly.indvar.i163, %polly.adjust_ub.i
  br i1 %polly.loop_cond.i, label %polly.par.checkNext.loopexit.i, label %polly.loop_header.i165
...
!3 = !{!4, !5, !6}
!4 = distinct !{!4, !2, !"polly.alias.scope.last_swapped.1"}
!5 = distinct !{!5, !2, !"polly.alias.scope.last_swapped.074"}
...
!18 = !{!19, !20, !21}
!19 = distinct !{!19, !17, !"polly.alias.scope.last_swapped.1"}
!20 = distinct !{!20, !17, !"polly.alias.scope.last_swapped.074"}
