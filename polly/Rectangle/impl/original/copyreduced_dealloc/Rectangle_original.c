...
int main(int argc, char** args){
	...
	//invoke (%15) = (%3, %4) Rectangle_original:updateRec : function(Rectangle_original:Rectangle,Rectangle_original:Point)->(Rectangle_original:Rectangle)
