...
entry:
  ...
  store i64 67108864, i64* %R, align 8
...
if.end:                                           ; preds = %for.end12
  ...
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([100 x i8], [100 x i8]* @.str.2, i32 0, i32 0), i64 68719476736, i32 1024, i64 %13)
  ret i32 0
}
