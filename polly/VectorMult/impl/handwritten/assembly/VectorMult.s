...
entry:
  ...
  store i64 17179869184, i64* %SIZE, align 8
  %0 = load i64, i64* %SIZE, align 8
  %div = sdiv i64 %0, 1048576
  store i64 %div, i64* %repeats, align 8
  %1 = load i64, i64* %repeats, align 8
  %mul = mul i64 %1, 4
...
for.cond:                                         ; preds = %for.inc14, %entry
  ...
  %4 = load i64, i64* %repeats, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds i32, i32* %6, i64 %5
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx7 = getelementptr inbounds i32, i32* %11, i64 %10
  ...
  %mul12 = mul nsw i32 %14, %16
  %add = add nsw i32 %12, %mul12
  %17 = load i64, i64* %r, align 8
  %18 = load i32*, i32** %p, align 8
  %arrayidx13 = getelementptr inbounds i32, i32* %18, i64 %17
...
if.end:                                           ; preds = %for.end24
  ...
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([102 x i8], [102 x i8]* @.str.2, i32 0, i32 0), i64 %30, i32 1048576, i64 %31)
  ret i32 0
}
