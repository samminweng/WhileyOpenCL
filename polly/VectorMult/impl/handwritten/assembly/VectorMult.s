...
entry:
  ...
  store i64 262144, i64* %repeats, align 8
  %0 = load i64, i64* %repeats, align 8
  %mul = mul i64 %0, 4
...
for.cond:                                         ; preds = %for.inc14, %entry
  ...
  %3 = load i64, i64* %repeats, align 8
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %6, 4096
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %7 = load i32, i32* %i, align 4
  %idxprom = sext i32 %7 to i64
  %arrayidx4 = getelementptr inbounds [4096 x i32], [4096 x i32]* @u, i64 0, i64 %idxprom
  store i32 1, i32* %arrayidx4, align 4
  %8 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %8 to i64
  %arrayidx6 = getelementptr inbounds [4096 x i32], [4096 x i32]* @v, i64 0, i64 %idxprom5
  ...
  %arrayidx9 = getelementptr inbounds [4096 x i32], [4096 x i32]* @u, i64 0, i64 %idxprom8
  %13 = load i32, i32* %arrayidx9, align 4
  %14 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %14 to i64
  %arrayidx11 = getelementptr inbounds [4096 x i32], [4096 x i32]* @v, i64 0, i64 %idxprom10
...
for.cond17:                                       ; preds = %for.inc22, %for.end16
  ...
  %21 = load i64, i64* %repeats, align 8
...
for.end24:                                        ; preds = %for.cond17
  ...
  %cmp25 = icmp ne i64 %27, 1073741824
...
if.end:                                           ; preds = %for.end24
  ...
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([102 x i8], [102 x i8]* @.str.2, i32 0, i32 0), i32 1073741824, i32 4096, i64 %28)
  ret i32 0
}
