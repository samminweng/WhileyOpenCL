...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %arrayidx = getelementptr inbounds [64 x i32], [64 x i32]* @u, i64 0, i64 %indvars.iv
  store i32 1, i32* %arrayidx, align 4
  %arrayidx5 = getelementptr inbounds [64 x i32], [64 x i32]* @v, i64 0, i64 %indvars.iv
  store i32 1, i32* %arrayidx5, align 4
  %arrayidx7 = getelementptr inbounds [64 x i32], [64 x i32]* @u, i64 0, i64 %indvars.iv
  %0 = load i32, i32* %arrayidx7, align 4
  %arrayidx9 = getelementptr inbounds [64 x i32], [64 x i32]* @v, i64 0, i64 %indvars.iv
...
if.end:                                           ; preds = %for.end12
  ...
  %call16 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([100 x i8], [100 x i8]* @.str.2, i64 0, i64 0), i64 17179869184, i32 64, i64 %add.lcssa.lcssa) #4
  ret i32 0
}
