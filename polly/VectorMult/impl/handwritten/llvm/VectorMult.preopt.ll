...
for.body3:                                        ; preds = %for.body, %for.body3
  ...
  %arrayidx4 = getelementptr inbounds [4096 x i32], [4096 x i32]* @u, i64 0, i64 %indvars.iv
  store i32 1, i32* %arrayidx4, align 4
  %arrayidx6 = getelementptr inbounds [4096 x i32], [4096 x i32]* @v, i64 0, i64 %indvars.iv
  store i32 1, i32* %arrayidx6, align 4
  %arrayidx7 = getelementptr inbounds i32, i32* %0, i64 %r.04
  %1 = load i32, i32* %arrayidx7, align 4
  %arrayidx9 = getelementptr inbounds [4096 x i32], [4096 x i32]* @u, i64 0, i64 %indvars.iv
  %2 = load i32, i32* %arrayidx9, align 4
  %arrayidx11 = getelementptr inbounds [4096 x i32], [4096 x i32]* @v, i64 0, i64 %indvars.iv
...
if.end:                                           ; preds = %for.end24
  ...
  %call29 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([102 x i8], [102 x i8]* @.str.2, i64 0, i64 0), i32 1073741824, i32 4096, i64 %add21.lcssa) #4
  ret i32 0
}
