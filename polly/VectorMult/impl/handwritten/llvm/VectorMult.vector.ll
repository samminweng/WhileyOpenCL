...
polly.stmt.polly.stmt.for.inc31:                  ; preds = %polly.loop_header32
  ...
  %_p_scalar__p_scalar_ = load i32, i32* %scevgep3940, align 4, !alias.scope !92, !noalias !95
  %scevgep42 = getelementptr i8, i8* %scevgep41, i64 %52
  %scevgep4243 = bitcast i8* %scevgep42 to i32*
  %_p_scalar_12_p_scalar_ = load i32, i32* %scevgep4243, align 4, !alias.scope !90, !noalias !96
  ...
  %_p_scalar_.1_p_scalar_ = load i32, i32* %scevgep4647, align 4, !alias.scope !92, !noalias !95
  %scevgep50 = getelementptr i8, i8* %scevgep49, i64 %53
  %scevgep5051 = bitcast i8* %scevgep50 to i32*
  %_p_scalar_12.1_p_scalar_ = load i32, i32* %scevgep5051, align 4, !alias.scope !90, !noalias !96
  ...
  %_p_scalar_.2_p_scalar_ = load i32, i32* %scevgep5455, align 4, !alias.scope !92, !noalias !95
  %scevgep58 = getelementptr i8, i8* %scevgep57, i64 %54
  %scevgep5859 = bitcast i8* %scevgep58 to i32*
  %_p_scalar_12.2_p_scalar_ = load i32, i32* %scevgep5859, align 4, !alias.scope !90, !noalias !96
  ...
  %_p_scalar_.3_p_scalar_ = load i32, i32* %scevgep6263, align 4, !alias.scope !92, !noalias !95
  %scevgep66 = getelementptr i8, i8* %scevgep65, i64 %55
  %scevgep6667 = bitcast i8* %scevgep66 to i32*
  %_p_scalar_12.3_p_scalar_ = load i32, i32* %scevgep6667, align 4, !alias.scope !90, !noalias !96
...
!90 = distinct !{!90, !87, !"polly.alias.scope.call1"}
!91 = distinct !{!91, !87, !"polly.alias.scope.total.02.phiops.0"}
!92 = distinct !{!92, !87, !"polly.alias.scope.call"}
!93 = distinct !{!93, !87, !"polly.alias.scope.tmp.04.phiops.0"}
!94 = distinct !{!94, !87, !"polly.alias.scope.p_add45.4"}
!95 = !{!89, !86, !90, !91, !93, !94}
!96 = !{!89, !86, !91, !92, !93, !94}
