...
polly.stmt.vector.body4:                          ; preds = %polly.stmt.vector.body4, %polly.stmt.for.cond17.preheader
  ...
  %wide.load_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep78, align 4, !alias.scope !80, !noalias !84
  %scevgep10 = getelementptr i8, i8* %scevgep9, i64 %42
  %scevgep1011 = bitcast i8* %scevgep10 to <4 x i32>*
  %wide.load18_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep1011, align 4, !alias.scope !78, !noalias !85
  ...
  %wide.load.1_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep1516, align 4, !alias.scope !80, !noalias !84
  %scevgep19 = getelementptr i8, i8* %scevgep18, i64 %42
  %scevgep1920 = bitcast i8* %scevgep19 to <4 x i32>*
  %wide.load18.1_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep1920, align 4, !alias.scope !78, !noalias !85
  ...
  %wide.load.2_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep2526, align 4, !alias.scope !80, !noalias !84
  %scevgep29 = getelementptr i8, i8* %scevgep28, i64 %42
  %scevgep2930 = bitcast i8* %scevgep29 to <4 x i32>*
  %wide.load18.2_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep2930, align 4, !alias.scope !78, !noalias !85
  ...
  %wide.load.3_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep3536, align 4, !alias.scope !80, !noalias !84
  %scevgep39 = getelementptr i8, i8* %scevgep38, i64 %42
  %scevgep3940 = bitcast i8* %scevgep39 to <4 x i32>*
  %wide.load18.3_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep3940, align 4, !alias.scope !78, !noalias !85
...
!76 = distinct !{!76, !74, !"polly.alias.scope.vec.phi"}
!77 = distinct !{!77, !74, !"polly.alias.scope.vec.phi31"}
!78 = distinct !{!78, !74, !"polly.alias.scope.call1"}
!79 = distinct !{!79, !74, !"polly.alias.scope."}
!80 = distinct !{!80, !74, !"polly.alias.scope.call"}
!81 = distinct !{!81, !74, !"polly.alias.scope..lcssa45"}
!82 = distinct !{!82, !74, !"polly.alias.scope."}
!83 = distinct !{!83, !74, !"polly.alias.scope.vec.phi30"}
!84 = !{!76, !77, !73, !78, !79, !81, !82, !83}
!85 = !{!76, !77, !73, !79, !80, !81, !82, !83}
