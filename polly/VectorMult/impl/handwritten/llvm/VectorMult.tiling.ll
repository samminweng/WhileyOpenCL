...
polly.stmt.vector.body4:                          ; preds = %polly.loop_header1
  ...
  %wide.load_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep78, align 4, !alias.scope !97, !noalias !105
  ...
  %wide.load.1_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep1516, align 4, !alias.scope !97, !noalias !105
  ...
  %wide.load.2_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep2526, align 4, !alias.scope !97, !noalias !105
  ...
  %wide.load.3_p_scalar_ = load <4 x i32>, <4 x i32>* %scevgep3536, align 4, !alias.scope !97, !noalias !105
...
!105 = !{!98, !99, !100, !101, !102, !103, !94, !104}
