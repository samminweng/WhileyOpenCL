...
polly.stmt.for.inc31:                             ; preds = %polly.stmt.for.inc31, %polly.loop_preheader2
  ...
  %_p_scalar_12 = load i32, i32* %scevgep1011, align 4, !alias.scope !65, !noalias !72
  ...
  %_p_scalar_12.1 = load i32, i32* %scevgep1011.1, align 4, !alias.scope !65, !noalias !72
  ...
  %_p_scalar_12.2 = load i32, i32* %scevgep1011.2, align 4, !alias.scope !65, !noalias !72
  ...
  %_p_scalar_12.3 = load i32, i32* %scevgep1011.3, align 4, !alias.scope !65, !noalias !72
...
polly.stmt.polly.stmt.for.inc31:                  ; preds = %polly.loop_header32
  ...
  %_p_scalar__p_scalar_ = load i32, i32* %scevgep3940, align 4, !alias.scope !90, !noalias !95
  %scevgep42 = getelementptr i8, i8* %scevgep41, i64 %52
  %scevgep4243 = bitcast i8* %scevgep42 to i32*
  %_p_scalar_12_p_scalar_ = load i32, i32* %scevgep4243, align 4, !alias.scope !89, !noalias !96
  ...
  %_p_scalar_.1_p_scalar_ = load i32, i32* %scevgep4647, align 4, !alias.scope !90, !noalias !95
  %scevgep50 = getelementptr i8, i8* %scevgep49, i64 %53
  %scevgep5051 = bitcast i8* %scevgep50 to i32*
  %_p_scalar_12.1_p_scalar_ = load i32, i32* %scevgep5051, align 4, !alias.scope !89, !noalias !96
  ...
  %_p_scalar_.2_p_scalar_ = load i32, i32* %scevgep5455, align 4, !alias.scope !90, !noalias !95
  %scevgep58 = getelementptr i8, i8* %scevgep57, i64 %54
  %scevgep5859 = bitcast i8* %scevgep58 to i32*
  %_p_scalar_12.2_p_scalar_ = load i32, i32* %scevgep5859, align 4, !alias.scope !89, !noalias !96
  ...
  %_p_scalar_.3_p_scalar_ = load i32, i32* %scevgep6263, align 4, !alias.scope !90, !noalias !95
  %scevgep66 = getelementptr i8, i8* %scevgep65, i64 %55
  %scevgep6667 = bitcast i8* %scevgep66 to i32*
  %_p_scalar_12.3_p_scalar_ = load i32, i32* %scevgep6667, align 4, !alias.scope !89, !noalias !96
...
!65 = distinct !{!65, !63, !"polly.alias.scope.call1"}
...
!70 = distinct !{!70, !63, !"polly.alias.scope.add30.lcssa"}
!71 = !{!65, !66, !62, !68, !69, !70}
!72 = !{!66, !62, !67, !68, !69, !70}
...
!89 = distinct !{!89, !87, !"polly.alias.scope.call1"}
!90 = distinct !{!90, !87, !"polly.alias.scope.call"}
...
!94 = distinct !{!94, !87, !"polly.alias.scope.tmp.04.phiops.0"}
!95 = !{!89, !86, !91, !92, !93, !94}
!96 = !{!86, !90, !91, !92, !93, !94}
