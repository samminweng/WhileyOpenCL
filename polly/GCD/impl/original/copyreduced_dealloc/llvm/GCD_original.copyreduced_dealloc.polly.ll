...
blklab5.i.us181:                                  ; preds = %blklab4.i.us178
  %sub10.i.us183 = sub nsw i64 %b.addr.0.ph35.i173.us194, %a.addr.033.i.us179
...
if.then83:                                        ; preds = %if.then83.loopexit, %if.end5
  ...
  %18 = bitcast i64* %call44 to <2 x i64>*
