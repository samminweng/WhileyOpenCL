...
.LBB1_2:                                # %while.cond8.preheader.us
	...
	imulq	%rbx, %r12
.Ltmp29:
	#DEBUG_VALUE: gcd_cached:_23 <- %R12
	#DEBUG_VALUE: gcd_cached:_17 <- %R12
	#DEBUG_VALUE: gcd_cached:_16 <- %R12
	#DEBUG_VALUE: gcd_cached:_13 <- %R12
	.loc	1 130 7                 # GCD.c:130:7
	testq	%r9, %r9
	je	.LBB1_3
.Ltmp30:
# BB#11:                                # %if.end13.us118.preheader
...
.Ltmp36:
	.p2align	4, 0x90
.LBB1_14:                               # %if.end22.us134
                                        #   in Loop: Header=BB1_12 Depth=2
	.loc	1 150 14                # GCD.c:150:14
	movq	%r9, (%rax,%r12,8)
.LBB1_15:                               # %blklab12.us140
                                        #   in Loop: Header=BB1_12 Depth=2
.Ltmp37:
...
# BB#6:                                 # %vector.body.prol
	...
	#DEBUG_VALUE: gcd_cached:_13 <- %R12
	.loc	1 136 14                # GCD.c:136:14
	movdqu	%xmm0, (%rax,%r12,8)
	movdqu	%xmm1, 16(%rax,%r12,8)
	movl	$4, %esi
.Ltmp43:
...
.Ltmp46:
	.loc	1 136 14                # GCD.c:136:14
	movdqu	%xmm3, 32(%r13,%rsi,8)
	movdqu	%xmm2, 48(%r13,%rsi,8)
.Ltmp47:
	.loc	1 69 12                 # GCD.c:69:12
	addq	$8, %rsi
	cmpq	%r14, %rsi
...
.Ltmp49:
	...
	jne	.LBB1_10
.Ltmp50:
.LBB1_16:                               # %blklab9.loopexit.us
                                        #   in Loop: Header=BB1_2 Depth=1
	#DEBUG_VALUE: gcd_cached:_27 <- 1
	.loc	1 201 8                 # GCD.c:201:8
	incq	%r9
.Ltmp51:
	#DEBUG_VALUE: gcd_cached:_28 <- %R9
	#DEBUG_VALUE: gcd_cached:a <- %R9
	#DEBUG_VALUE: gcd_cached:i <- %R9
	.loc	1 114 6                 # GCD.c:114:6
	addq	%r10, %r13
	cmpq	%rbx, %r9
	jne	.LBB1_2
...
.LBB2_3:                                # %while.cond8.preheader.us.i
	...
	imulq	%rdx, %r15
.Ltmp93:
	#DEBUG_VALUE: gcd_cached:_23 <- %R15
	#DEBUG_VALUE: gcd_cached:_17 <- %R15
	#DEBUG_VALUE: gcd_cached:_16 <- %R15
	#DEBUG_VALUE: gcd_cached:_13 <- %R15
	.loc	1 130 7                 # GCD.c:130:7
	testq	%rdi, %rdi
	je	.LBB2_4
.Ltmp94:
# BB#12:                                # %if.end13.us118.preheader.i
...
.Ltmp100:
	...
	movq	(%r8,%rbx,8), %rax
.Ltmp101:
	#DEBUG_VALUE: gcd_cached:_22 <- %RAX
	.loc	1 182 14                # GCD.c:182:14
	movq	%rax, (%rbp)
	jmp	.LBB2_16
.Ltmp102:
	.p2align	4, 0x90
.LBB2_15:                               # %if.end22.us134.i
                                        #   in Loop: Header=BB2_13 Depth=2
	.loc	1 150 14                # GCD.c:150:14
	movq	%rdi, (%r8,%r15,8)
.LBB2_16:                               # %blklab12.us140.i
                                        #   in Loop: Header=BB2_13 Depth=2
.Ltmp103:
	#DEBUG_VALUE: gcd_cached:_25 <- 1
	.loc	1 190 9                 # GCD.c:190:9
...
# BB#7:                                 # %vector.body.prol
	...
	#DEBUG_VALUE: gcd_cached:_13 <- %R15
	.loc	1 136 14                # GCD.c:136:14
	movdqu	%xmm0, (%r8,%r15,8)
	movdqu	%xmm1, 16(%r8,%r15,8)
	movl	$4, %eax
.Ltmp108:
.LBB2_8:                                # %vector.body.preheader.split
                                        #   in Loop: Header=BB2_3 Depth=1
	#DEBUG_VALUE: gcd_cached:_23 <- %R15
	#DEBUG_VALUE: gcd_cached:_17 <- %R15
	#DEBUG_VALUE: gcd_cached:_16 <- %R15
...
.Ltmp113:
	.loc	1 136 14                # GCD.c:136:14
	movdqu	%xmm3, 32(%r12,%rax,8)
	movdqu	%xmm2, 48(%r12,%rax,8)
.Ltmp114:
	.loc	1 77 12                 # GCD.c:77:12
	addq	$8, %rax
	cmpq	%r11, %rax
...
.LBB2_17:                               # %blklab9.loopexit.us.i
	...
	jne	.LBB2_3
.Ltmp118:
# BB#18:                                # %if.end27.preheader.preheader
...
.Ltmp126:
	...
	movaps	.LCPI2_3(%rip), %xmm0   # xmm0 = [78,117]
	movups	%xmm0, (%r14)
	.loc	1 318 38 is_stmt 0      # GCD.c:318:38
	movaps	.LCPI2_4(%rip), %xmm0   # xmm0 = [109,98]
	movups	%xmm0, 16(%r14)
	.loc	1 318 65                # GCD.c:318:65
	movaps	.LCPI2_5(%rip), %xmm0   # xmm0 = [101,114]
	movups	%xmm0, 32(%r14)
	.loc	1 318 93                # GCD.c:318:93
	movaps	.LCPI2_6(%rip), %xmm0   # xmm0 = [58,32]
	movups	%xmm0, 48(%r14)
.Ltmp127:
...
.Ltmp131:
	...
	movaps	.LCPI2_7(%rip), %xmm0   # xmm0 = [32,78]
	movups	%xmm0, (%r13)
	.loc	1 331 37 is_stmt 0      # GCD.c:331:37
	movaps	.LCPI2_8(%rip), %xmm0   # xmm0 = [117,109]
	movups	%xmm0, 16(%r13)
	.loc	1 331 65                # GCD.c:331:65
	movaps	.LCPI2_9(%rip), %xmm0   # xmm0 = [98,101]
	movups	%xmm0, 32(%r13)
	.loc	1 331 92                # GCD.c:331:92
	movaps	.LCPI2_10(%rip), %xmm0  # xmm0 = [114,58]
	movups	%xmm0, 48(%r13)
...
.Ltmp136:
	#DEBUG_VALUE: main:_30_has_ownership <- 0
.LBB2_42:                               # %blklab4.lr.ph.i.preheader
                                        #   in Loop: Header=BB2_36 Depth=2
	#DEBUG_VALUE: main:_20 <- %R14
	#DEBUG_VALUE: gcd:b <- %R12
	#DEBUG_VALUE: main:_25 <- %R13
...
.Ltmp137:
	...
	movaps	.LCPI2_11(%rip), %xmm0  # xmm0 = [32,71]
	movups	%xmm0, (%r15)
	.loc	1 344 37 is_stmt 0      # GCD.c:344:37
	movdqa	.LCPI2_12(%rip), %xmm0  # xmm0 = [67,68]
	movdqu	%xmm0, 16(%r15)
