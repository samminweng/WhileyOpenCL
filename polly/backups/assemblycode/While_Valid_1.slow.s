...
entry:
  ...
  %4 = load i64, i64* %_6_size, align 8
  store i64 %4, i64* %_5_size, align 8
  %5 = load i64*, i64** %_5, align 8
  store i64* %5, i64** %_r, align 8
  %6 = load i64, i64* %_5_size, align 8
...
while.body:                                       ; preds = %while.cond
  %9 = load i64, i64* %_ls_size.addr, align 8
  store i64 %9, i64* %_7, align 8
  %10 = load i64, i64* %_i, align 8
...
if.end:                                           ; preds = %while.body
  ...
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.13, i32 0, i32 0))
  call void @exit(i32 0) #5
  unreachable
...
blklab1:                                          ; preds = %if.then
  ...
  %13 = load i64, i64* %_i, align 8
  %14 = load i64, i64* %_9, align 8
  %sub = sub nsw i64 %13, %14
  store i64 %sub, i64* %_10, align 8
  %15 = load i64, i64* %_10, align 8
  store i64 %15, i64* %_i, align 8
  %16 = load i64, i64* %_i, align 8
  %17 = load i64*, i64** %_ls.addr, align 8
  ...
  %19 = load i64, i64* %_12_size, align 8
  %mul = mul i64 %19, 8
  %call2 = call noalias i8* @malloc(i64 %mul) #4
  %20 = bitcast i8* %call2 to i64*
  store i64* %20, i64** %_12, align 8
  %21 = load i64, i64* %_11, align 8
  %22 = load i64*, i64** %_12, align 8
  %arrayidx3 = getelementptr inbounds i64, i64* %22, i64 0
  store i64 %21, i64* %arrayidx3, align 8
  %23 = load i64, i64* %_r_size, align 8
  %24 = load i64, i64* %_12_size, align 8
  %add = add nsw i64 %23, %24
  store i64 %add, i64* %_13_size, align 8
  %25 = load i64*, i64** %_r, align 8
  %26 = load i64*, i64** %_12, align 8
  %call4 = call i64* @append(i64* %25, i64* %_r_size, i64* %26, i64* %_12_size, i64* %_13_size)
  store i64* %call4, i64** %_13, align 8
  %27 = load i64*, i64** %_12, align 8
  %28 = bitcast i64* %27 to i8*
  call void @free(i8* %28) #4
  %29 = load i64*, i64** %_13, align 8
  store i64* %29, i64** %_r, align 8
  %30 = load i64, i64* %_13_size, align 8
  store i64 %30, i64* %_r_size, align 8
  br label %while.cond
