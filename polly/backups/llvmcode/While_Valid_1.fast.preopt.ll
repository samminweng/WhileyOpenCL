...
entry.split:                                      ; preds = %entry
  %call = tail call i64* @clone(i64* %_ls, i64 %_ls_size)
...
while.body:                                       ; preds = %while.body.lr.ph, %blklab1
  %_19.04 = phi i64 [ 0, %while.body.lr.ph ], [ %add, %blklab1 ]
  %_i.03 = phi i64 [ %_ls_size, %while.body.lr.ph ], [ %sub, %blklab1 ]
  %cmp1 = icmp sgt i64 %_i.03, %_ls_size
  br i1 %cmp1, label %if.end, label %blklab1

if.end:                                           ; preds = %while.body
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.13, i64 0, i64 0), i64 4, i64 1, %struct._IO_FILE* %0) #5
  tail call void @exit(i32 0) #6
  unreachable

blklab1:                                          ; preds = %while.body
  %sub = add nsw i64 %_i.03, -1
  %arrayidx = getelementptr inbounds i64, i64* %_ls, i64 %sub
  %2 = load i64, i64* %arrayidx, align 8
  %arrayidx3 = getelementptr inbounds i64, i64* %call, i64 %_19.04
  store i64 %2, i64* %arrayidx3, align 8
  %add = add nsw i64 %_19.04, 1
  %cmp = icmp sgt i64 %_i.03, 1
...
blklab0:                                          ; preds = %while.cond.blklab0_crit_edge, %entry.split
  %_19.0.lcssa = phi i64 [ %add, %while.cond.blklab0_crit_edge ], [ 0, %entry.split ]
  %cmp4 = icmp eq i64 %_19.0.lcssa, %_ls_size
  br i1 %cmp4, label %blklab3, label %if.end.6

if.end.6:                                         ; preds = %blklab0
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %4 = tail call i64 @fwrite(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.13, i64 0, i64 0), i64 4, i64 1, %struct._IO_FILE* %3) #5
  tail call void @exit(i32 0) #6
  unreachable

blklab3:                                          ; preds = %blklab0
  ret i64* %call
}
