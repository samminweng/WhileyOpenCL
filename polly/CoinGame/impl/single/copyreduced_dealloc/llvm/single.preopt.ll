; ModuleID = 'llvm/single.preopt.ll.tmp'
...
entry.split:                                      ; preds = %entry
  ...
  br i1 %cmp153, label %while.cond1.preheader.preheader, label %if.end58
...
while.cond1.preheader.i:                          ; preds = %while.cond1.preheader.i.preheader, %blklab2.i
  ...
  %s.0154.i = phi i64 [ %add56.i, %blklab2.i ], [ 0, %while.cond1.preheader.i.preheader ]
  br label %if.end5.i

if.end5.i:                                        ; preds = %blklab6.i, %while.cond1.preheader.i
  %i.0152.i = phi i64 [ 0, %while.cond1.preheader.i ], [ %add.i, %blklab6.i ]
  %j.0151.i = phi i64 [ %s.0154.i, %while.cond1.preheader.i ], [ %add54.i, %blklab6.i ]
...
blklab6.i:                                        ; preds = %if.end26.i, %blklab5.i
  ...
  %xor.i = xor i64 %x.0.i, %y.0.i
  %cmp31.i = icmp slt i64 %x.0.i, %y.0.i
  %and.i = select i1 %cmp31.i, i64 %xor.i, i64 0
  %xor34.i = xor i64 %and.i, %y.0.i
  %add35.i = add nsw i64 %xor34.i, %i.0152.i
  %xor36.i = xor i64 %z.0.i, %y.0.i
  %cmp37.i = icmp slt i64 %y.0.i, %z.0.i
  %and41.i = select i1 %cmp37.i, i64 %xor36.i, i64 0
  %xor42.i = xor i64 %and41.i, %z.0.i
  %add43.i = add nsw i64 %xor42.i, %j.0151.i
  %xor44.i = xor i64 %add43.i, %add35.i
  %cmp45.i = icmp slt i64 %add35.i, %add43.i
  %and49.i = select i1 %cmp45.i, i64 %xor44.i, i64 0
  %xor50.i = xor i64 %and49.i, %add35.i
  %add52.i = add nsw i64 %.pre.i, %j.0151.i
  %arrayidx53.i = getelementptr inbounds i64, i64* %call11, i64 %add52.i
  store i64 %xor50.i, i64* %arrayidx53.i, align 8, !tbaa !1
  %add54.i = add nuw nsw i64 %j.0151.i, 1
  %exitcond.i = icmp eq i64 %add.i, %indvars.iv.i
  br i1 %exitcond.i, label %blklab2.i, label %if.end5.i

blklab2.i:                                        ; preds = %blklab6.i
  %add56.i = add nuw nsw i64 %s.0154.i, 1
  %indvars.iv.next.i = add i64 %indvars.iv.i, -1
  %exitcond155.i = icmp eq i64 %add56.i, %1
