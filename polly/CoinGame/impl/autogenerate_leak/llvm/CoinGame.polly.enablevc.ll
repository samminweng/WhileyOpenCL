...
blklab4:                                          ; preds = %if.end5, %if.end11
  ...
  %add15 = add nuw nsw i64 %i.0150, 2
...
if.end18:                                         ; preds = %blklab4
  ...
  %add21 = add nsw i64 %mul20, %j.0149
...
blklab5:                                          ; preds = %blklab4, %if.end18
  ...
  %cmp24 = icmp slt i64 %j.0149, 2
  %.pre = mul nsw i64 %i.0150, 9223372036854775807
  br i1 %cmp24, label %blklab6, label %if.end26

if.end26:                                         ; preds = %blklab5
  %add28 = add nsw i64 %j.0149, -2
...
blklab6:                                          ; preds = %blklab5, %if.end26
  ...
  %add37 = add nsw i64 %y.0.x.0, %i.0150
  %add38 = add nsw i64 %z.1, %j.0149
  %cmp39 = icmp sgt i64 %add37, %add38
  %add44 = add nsw i64 %.pre, %j.0149
  ...
  %add50 = add nuw nsw i64 %j.0149, 1
  %exitcond = icmp eq i64 %add, %indvars.iv
  br i1 %exitcond, label %blklab2, label %if.end5

blklab2:                                          ; preds = %blklab6
  %add52 = add nuw nsw i64 %s.0152, 1
  %indvars.iv.next = add i64 %indvars.iv, -1
  %exitcond153 = icmp eq i64 %add52, 9223372036854775807
  br i1 %exitcond153, label %blklab0.loopexit, label %while.cond1.preheader
...
polly.stmt.blklab6:                               ; preds = %polly.cond176, %polly.stmt.if.end26
  ...
  %p_add37 = add nsw i64 %p_y.0.x.0, %polly.indvar159
  ...
  store i64 %p_add37.p_add38, i64* %uglygep189190, align 8, !alias.scope !5, !noalias !7
...
polly.stmt.if.end11:                              ; preds = %polly.loop_header155
  ...
  %_p_scalar_ = load i64, i64* %uglygep165, align 8, !alias.scope !5, !noalias !7
...
polly.stmt.if.end18:                              ; preds = %polly.cond166
  ...
  %_p_scalar_175 = load i64, i64* %uglygep173174, align 8, !alias.scope !5, !noalias !7
...
polly.stmt.if.end26:                              ; preds = %polly.cond176
  ...
  %_p_scalar_185 = load i64, i64* %uglygep183184, align 8, !alias.scope !5, !noalias !7
  br label %polly.stmt.blklab6
}

; Function Attrs: noreturn nounwind uwtable
define i32 @main(i32 %argc, i8** %args) #1 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %28 = bitcast i8* %arrayidx58 to <2 x i64>*
  store <2 x i64> <i64 115, i64 32>, <2 x i64>* %28, align 8, !tbaa !1
  tail call void @printf_s(i64* %3, i64 50) #5
  %call60 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %2)
  %call61 = tail call noalias i8* @malloc(i64 184) #5
  %29 = bitcast i8* %call61 to i64*
  %30 = bitcast i8* %call61 to <2 x i64>*
...
!11 = distinct !{!11, !6, !"polly.alias.scope.z.0"}
!12 = !{!13, !13, i64 0}
