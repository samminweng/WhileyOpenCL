...
int main(int argc, char** args){
	...
	//assign %3 = %11  : int[]
	_COPY_1DARRAY(moves, _11, T_INT);
	//invoke (%12) = (%3, %2) CoinGame_array:findMoves : function(int[],int)->(int[])
	{
		void* moves_tmp;
		_UPDATE_1DARRAY_SIZE(_12, moves);
		_12 = findMoves(moves_tmp = _COPY_1DARRAY_PARAM(moves, T_INT), n);
	}
	//assign %3 = %12  : int[]
	_COPY_1DARRAY(moves, _12, T_INT);
	//const %13 = 1 : int
	_13 = 1;
	//sub %14 = %2, %13 : int
	_14=n-_13;
