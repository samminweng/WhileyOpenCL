...
int main(int argc, char** args){
	...
	_DEALLOC(_12);
	_12 = findMoves(_1DARRAY_PARAM(moves), moves_dealloc, n);
	_TRANSFER_DEALLOC(_12, moves);
	//assign %3 = %12  : int[]
	_DEALLOC(moves);
