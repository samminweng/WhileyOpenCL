...
polly.loop_header.i527:                           ; preds = %polly.stmt.blklab7.exit.i, %polly.par.loadIVBounds.i522
  ...
  %_p_scalar_3.i = load i64, i64* %scevgep2.i526, align 8, !alias.scope !56, !noalias !57
...
polly.loop_header.i544:                           ; preds = %polly.stmt.blklab8.exit.i, %polly.par.loadIVBounds.i538
  ...
  %_p_scalar_3.i543 = load i64, i64* %scevgep2.i542, align 8, !alias.scope !64, !noalias !65
...
polly.loop_header420:                             ; preds = %polly.loop_header420, %polly.loop_preheader421
  ...
  store i64 %polly.storemerge, i64* %uglygep432, align 8, !alias.scope !71, !noalias !74
...
polly.loop_header:                                ; preds = %polly.loop_header, %polly.par.loadIVBounds
  ...
  store i64 0, i64* %scevgep, align 8, !alias.scope !72, !noalias !77
  %polly.indvar_next = add nsw i64 %polly.indvar, 1
  %polly.loop_cond = icmp sgt i64 %polly.indvar, %polly.adjust_ub
  br i1 %polly.loop_cond, label %polly.par.checkNext.loopexit, label %polly.loop_header
}
...
polly.loop_header:                                ; preds = %polly.loop_header, %polly.par.loadIVBounds
  ...
  %_p_scalar_ = load i64, i64* %uglygep3, align 8, !alias.scope !71, !noalias !74
  %scevgep4 = getelementptr i64, i64* %polly.subfunc.arg.call12, i64 %polly.indvar
  store i64 %_p_scalar_, i64* %scevgep4, align 8, !alias.scope !72, !noalias !77
  %polly.indvar_next = add nsw i64 %polly.indvar, 1
  %polly.loop_cond = icmp sgt i64 %polly.indvar, %polly.adjust_ub
  br i1 %polly.loop_cond, label %polly.par.checkNext.loopexit, label %polly.loop_header
}
...
polly.loop_header:                                ; preds = %polly.stmt.blklab7.exit, %polly.par.loadIVBounds
  ...
  %_p_scalar_3 = load i64, i64* %scevgep2, align 8, !alias.scope !72, !noalias !77
...
!10 = distinct !{!10, !6, !"polly.alias.scope.moves"}
!11 = distinct !{!11, !6, !"polly.alias.scope.call12"}
...
!18 = distinct !{!18, !13, !"polly.alias.scope.call12"}
...
!32 = distinct !{!32, !27, !"polly.alias.scope.call12"}
!33 = !{!29, !30, !31, !26}
...
!40 = distinct !{!40, !35, !"polly.alias.scope.call12"}
!41 = !{!37, !39, !34, !40}
...
!48 = distinct !{!48, !43, !"polly.alias.scope.call12"}
!49 = !{!46, !47, !42, !48}
...
!54 = distinct !{!54, !51, !"polly.alias.scope.storemerge"}
!55 = distinct !{!55, !51, !"polly.alias.scope.moves"}
!56 = distinct !{!56, !51, !"polly.alias.scope.call12"}
!57 = !{!53, !50, !54, !55}
...
!64 = distinct !{!64, !59, !"polly.alias.scope.call12"}
!65 = !{!58, !61, !62, !63}
...
!70 = distinct !{!70, !67, !"polly.alias.scope.storemerge"}
!71 = distinct !{!71, !67, !"polly.alias.scope.moves"}
!72 = distinct !{!72, !67, !"polly.alias.scope.call12"}
!73 = !{!66, !70, !71, !72}
!74 = !{!69, !66, !70, !72}
!75 = !{!76, !76, i64 0}
