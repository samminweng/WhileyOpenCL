...
int main(int argc, char** args){
	...
	//assign %3 = %11  : int[]
	_DEALLOC(moves);
	_COPY_1DARRAY_LONGLONG(moves, _11);
	_ADD_DEALLOC(moves);
	//invoke (%12) = (%3, %2) CoinGame_array:findMoves : function(int[],int)->(int[])
	{
		void* moves_tmp;
		_DEALLOC(_12);
		_12 = findMoves(_COPY_1DARRAY_PARAM_LONGLONG(moves), false, n, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_12));
