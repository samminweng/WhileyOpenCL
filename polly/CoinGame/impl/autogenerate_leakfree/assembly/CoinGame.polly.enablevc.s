...
# BB#2:                                 # %if.end122.critedge
	...
	#DEBUG_VALUE: main:_6_size <- %EBX
	#DEBUG_VALUE: main:_6 <- %R15
	.loc	1 337 2 discriminator 1 # CoinGame.c:337:2
	movq	%r15, %rdi
	movq	%r14, %rsi
	callq	free2DArray
.Ltmp58:
	#DEBUG_VALUE: main:_6_has_ownership <- 0
	.loc	1 343 2                 # CoinGame.c:343:2
	xorl	%edi, %edi
	callq	exit
.Ltmp59:
.LBB1_1:                                # %if.then103
	...
	#DEBUG_VALUE: main:_6_size <- %EBX
	#DEBUG_VALUE: main:_6 <- %R15
	.loc	1 278 6                 # CoinGame.c:278:6
	movq	(%rax), %rbx
.Ltmp60:
	#DEBUG_VALUE: main:_9 <- 0
	#DEBUG_VALUE: main:n <- %RBX
	.loc	1 282 7                 # CoinGame.c:282:7
	movl	%ebx, %esi
	imull	%esi, %esi
	.loc	1 285 2                 # CoinGame.c:285:2
	xorl	%edi, %edi
	callq	gen1DArray
.Ltmp61:
...
.Ltmp67:
	...
	.loc	1 328 2                 # CoinGame.c:328:2
	movl	$184, %edi
	callq	malloc
	movq	%rax, %rbx
.Ltmp68:
	#DEBUG_VALUE: main:_23 <- %RBX
	.loc	1 329 9                 # CoinGame.c:329:9
	movaps	.LCPI1_24(%rip), %xmm0  # xmm0 = [80,97]
	movups	%xmm0, (%rbx)
	.loc	1 329 35 is_stmt 0      # CoinGame.c:329:35
	movaps	.LCPI1_25(%rip), %xmm0  # xmm0 = [115,115]
	movups	%xmm0, 16(%rbx)
	.loc	1 329 63                # CoinGame.c:329:63
	movaps	.LCPI1_26(%rip), %xmm0  # xmm0 = [32,67]
	movups	%xmm0, 32(%rbx)
	.loc	1 329 89                # CoinGame.c:329:89
	movaps	.LCPI1_27(%rip), %xmm0  # xmm0 = [111,105]
	movups	%xmm0, 48(%rbx)
	.loc	1 329 117               # CoinGame.c:329:117
	movaps	.LCPI1_28(%rip), %xmm0  # xmm0 = [110,71]
	movups	%xmm0, 64(%rbx)
	.loc	1 316 146 is_stmt 1     # CoinGame.c:316:146
	movaps	.LCPI1_5(%rip), %xmm0   # xmm0 = [97,109]
	.loc	1 329 145               # CoinGame.c:329:145
	movups	%xmm0, 80(%rbx)
	.loc	1 316 36                # CoinGame.c:316:36
	movaps	.LCPI1_1(%rip), %xmm0   # xmm0 = [101,32]
	.loc	1 329 174               # CoinGame.c:329:174
	movups	%xmm0, 96(%rbx)
	.loc	1 329 203 is_stmt 0     # CoinGame.c:329:203
	movaps	.LCPI1_29(%rip), %xmm0  # xmm0 = [116,101]
	movups	%xmm0, 112(%rbx)
	.loc	1 329 233               # CoinGame.c:329:233
	movaps	.LCPI1_30(%rip), %xmm0  # xmm0 = [115,116]
	movups	%xmm0, 128(%rbx)
	.loc	1 329 263               # CoinGame.c:329:263
	movaps	.LCPI1_31(%rip), %xmm0  # xmm0 = [32,99]
	movups	%xmm0, 144(%rbx)
	.loc	1 329 291               # CoinGame.c:329:291
	movaps	.LCPI1_32(%rip), %xmm0  # xmm0 = [97,115]
	movups	%xmm0, 160(%rbx)
	.loc	1 329 320               # CoinGame.c:329:320
	movq	$101, 176(%rbx)
.Ltmp69:
	#DEBUG_VALUE: main:_23_has_ownership <- 1
	.loc	1 332 2 is_stmt 1       # CoinGame.c:332:2
	movl	$23, %esi
	movq	%rbx, %rdi
	callq	println_s
.Ltmp70:
...
.Ltmp73:
	#DEBUG_VALUE: main:_18_has_ownership <- 0
	.loc	1 342 2 discriminator 1 # CoinGame.c:342:2
	movq	%rbx, %rdi
	callq	free
.Ltmp74:
	#DEBUG_VALUE: main:_23_has_ownership <- 0
