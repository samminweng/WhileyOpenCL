...
# BB#2:                                 # %polly.loop_preheader314
	...
	movl	$3, %ecx
	je	.LBB1_1
# BB#3:                                 # %polly.loop_preheader325.split
                                        #   in Loop: Header=BB1_1 Depth=1
	cmpq	%rdx, %r8
	js	.LBB1_17
# BB#4:                                 # %polly.loop_header334.us625.1.preheader
                                        #   in Loop: Header=BB1_1 Depth=1
	movq	%rdx, %rsi
	negq	%rsi
	leaq	Y+112(,%rdx,4), %rdi
	movq	$-1, %rbx
	.p2align	4, 0x90
.LBB1_5:                                # %polly.loop_header334.us625.1
	...
	jmp	.LBB1_6
	.p2align	4, 0x90
.LBB1_10:                               # %polly.loop_preheader325.split.us
                                        #   in Loop: Header=BB1_1 Depth=1
	movl	$4, %esi
	subq	%rdx, %rsi
	cmpq	%rdx, %r8
	js	.LBB1_11
# BB#13:                                # %polly.loop_header350.us.us.preheader
                                        #   in Loop: Header=BB1_1 Depth=1
	movq	%rdx, %rdi
	negq	%rdi
	leaq	Y(,%rdx,4), %rbx
	movq	$-1, %rcx
	.p2align	4, 0x90
.LBB1_14:                               # %polly.loop_header350.us.us
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rbx)
	incq	%rcx
	...
	cmpq	%rsi, %rcx
	jle	.LBB1_14
# BB#15:                                # %polly.loop_header334.us.us.1.preheader
                                        #   in Loop: Header=BB1_1 Depth=1
	leaq	Y+112(,%rdx,4), %rsi
	movq	$-1, %rbx
	.p2align	4, 0x90
.LBB1_16:                               # %polly.loop_header334.us.us.1
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rsi)
	incq	%rbx
	...
	jle	.LBB1_16
	jmp	.LBB1_6
.LBB1_11:                               # %polly.loop_header350.us.preheader
                                        #   in Loop: Header=BB1_1 Depth=1
	leaq	Y(,%rdx,4), %rdi
	movq	$-1, %rbx
	.p2align	4, 0x90
.LBB1_12:                               # %polly.loop_header350.us
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rdi)
	incq	%rbx
...
# BB#7:
	...
	xorl	%esi, %esi
	jmp	.LBB1_21
.LBB1_32:                               # %polly.merge382.thread
                                        #   in Loop: Header=BB1_21 Depth=1
	incq	%rdx
	movq	%rdx, %rax
	jmp	.LBB1_21
	.p2align	4, 0x90
.LBB1_18:                               # %polly.merge382
                                        #   in Loop: Header=BB1_21 Depth=1
	leaq	1(%rdx), %rax
	cmpq	$5, %rdx
	jl	.LBB1_21
	jmp	.LBB1_19
	.p2align	4, 0x90
.LBB1_20:                               # %polly.loop_preheader374
                                        #   in Loop: Header=BB1_21 Depth=1
	movl	$0, X(,%rdx,4)
	movl	$0, X+28(,%rdx,4)
	movl	$0, X+56(,%rdx,4)
...
.LBB1_21:                               # %polly.loop_header363
	...
	cmpq	$3, %rdx
	jl	.LBB1_20
# BB#22:                                # %polly.loop_preheader386.split.us
                                        #   in Loop: Header=BB1_21 Depth=1
	movl	$4, %eax
	subq	%rdx, %rax
	cmpq	%rdx, %r8
	js	.LBB1_23
# BB#25:                                # %polly.loop_header412.us.us.preheader
                                        #   in Loop: Header=BB1_21 Depth=1
	movq	%rdx, %rdi
	negq	%rdi
	leaq	X(,%rdx,4), %rbx
	movq	$-1, %rcx
	.p2align	4, 0x90
.LBB1_26:                               # %polly.loop_header412.us.us
	...
	cmpq	%rax, %rcx
	jle	.LBB1_26
# BB#27:                                # %polly.loop_header396.us.us.1.preheader
                                        #   in Loop: Header=BB1_21 Depth=1
	leaq	X+112(,%rdx,4), %rax
	movq	$-1, %rbx
	.p2align	4, 0x90
.LBB1_28:                               # %polly.loop_header396.us.us.1
                                        #   Parent Loop BB1_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rax)
	incq	%rbx
	...
	jmp	.LBB1_18
	.p2align	4, 0x90
.LBB1_29:                               # %polly.loop_preheader386.split
                                        #   in Loop: Header=BB1_21 Depth=1
	cmpq	%rdx, %r8
	js	.LBB1_32
# BB#30:                                # %polly.loop_header396.us604.1.preheader
                                        #   in Loop: Header=BB1_21 Depth=1
	movq	%rdx, %rax
	negq	%rax
	...
	movq	$-1, %rbx
	.p2align	4, 0x90
.LBB1_31:                               # %polly.loop_header396.us604.1
                                        #   Parent Loop BB1_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rdi)
	incq	%rbx
	...
	jle	.LBB1_31
	jmp	.LBB1_18
.LBB1_23:                               # %polly.loop_header412.us.preheader
                                        #   in Loop: Header=BB1_21 Depth=1
	leaq	X(,%rdx,4), %rdi
	movq	$-1, %rbx
	.p2align	4, 0x90
.LBB1_24:                               # %polly.loop_header412.us
                                        #   Parent Loop BB1_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rdi)
	incq	%rbx
...
.LBB1_19:
	...
	movl	$2, %r11d
	jmp	.LBB1_44
.LBB1_55:                               # %polly.merge442.thread
                                        #   in Loop: Header=BB1_44 Depth=1
	incq	%rdx
	movq	%rdx, %rsi
	jmp	.LBB1_44
	.p2align	4, 0x90
.LBB1_33:                               # %polly.merge442
                                        #   in Loop: Header=BB1_44 Depth=1
	leaq	1(%rdx), %rsi
	cmpq	$5, %rdx
	jl	.LBB1_44
	jmp	.LBB1_34
	.p2align	4, 0x90
.LBB1_43:                               # %polly.loop_preheader434
                                        #   in Loop: Header=BB1_44 Depth=1
	movl	$0, Z(,%rdx,4)
	movl	$0, Z+28(,%rdx,4)
	movl	$0, Z+56(,%rdx,4)
...
.LBB1_44:                               # %polly.loop_header423
	...
	cmpq	$3, %rdx
	jl	.LBB1_43
# BB#45:                                # %polly.loop_preheader446.split.us
                                        #   in Loop: Header=BB1_44 Depth=1
	movl	$4, %esi
	subq	%rdx, %rsi
	cmpq	%rdx, %r14
	js	.LBB1_46
# BB#48:                                # %polly.loop_header472.us.us.preheader
                                        #   in Loop: Header=BB1_44 Depth=1
	movq	%rdx, %rdi
	negq	%rdi
	leaq	Z(,%rdx,4), %rax
	movq	$-1, %rcx
	.p2align	4, 0x90
.LBB1_49:                               # %polly.loop_header472.us.us
	...
	cmpq	%rsi, %rcx
	jle	.LBB1_49
# BB#50:                                # %polly.loop_header456.us.us.1.preheader
                                        #   in Loop: Header=BB1_44 Depth=1
	leaq	Z+112(,%rdx,4), %rax
	movq	$-1, %rcx
	.p2align	4, 0x90
.LBB1_51:                               # %polly.loop_header456.us.us.1
                                        #   Parent Loop BB1_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rax)
	incq	%rcx
	...
	jmp	.LBB1_33
	.p2align	4, 0x90
.LBB1_52:                               # %polly.loop_preheader446.split
                                        #   in Loop: Header=BB1_44 Depth=1
	cmpq	%rdx, %r14
	js	.LBB1_55
# BB#53:                                # %polly.loop_header456.us583.1.preheader
                                        #   in Loop: Header=BB1_44 Depth=1
	movq	%rdx, %rax
	negq	%rax
	...
	movq	$-1, %rsi
	.p2align	4, 0x90
.LBB1_54:                               # %polly.loop_header456.us583.1
                                        #   Parent Loop BB1_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rcx)
	incq	%rsi
	...
	jle	.LBB1_54
	jmp	.LBB1_33
.LBB1_46:                               # %polly.loop_header472.us.preheader
                                        #   in Loop: Header=BB1_44 Depth=1
	leaq	Z(,%rdx,4), %rax
	movq	$-1, %rcx
	.p2align	4, 0x90
.LBB1_47:                               # %polly.loop_header472.us
                                        #   Parent Loop BB1_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	$0, (%rax)
	incq	%rcx
...
# BB#56:                                # %polly.loop_preheader491
	...
	xorl	%edx, %edx
	.p2align	4, 0x90
.LBB1_57:                               # %polly.loop_header490
                                        #   Parent Loop BB1_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	M+20(%rcx,%rdx), %ebp
	movl	%ebp, Y(%rcx,%rdx)
	incq	%rbx
	addq	$28, %rdx
	cmpq	%rax, %rbx
	jle	.LBB1_57
.LBB1_36:                               # %polly.loop_exit492
                                        #   in Loop: Header=BB1_35 Depth=1
	cmpq	$3, %r12
	movq	%r12, %rax
	cmovgq	%r10, %rax
	testq	%rax, %rax
	js	.LBB1_37
# BB#58:                                # %polly.loop_preheader504
                                        #   in Loop: Header=BB1_35 Depth=1
	decq	%rax
	movq	$-1, %rcx
	movq	%r15, %rdx
	.p2align	4, 0x90
.LBB1_59:                               # %polly.loop_header503
                                        #   Parent Loop BB1_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	M+48(%rdx), %ebx
	movl	%ebx, X(%rdx)
...
.LBB1_37:                               # %polly.cond516
	...
	jle	.LBB1_38
	.p2align	4, 0x90
.LBB1_60:                               # %polly.loop_header520
                                        #   Parent Loop BB1_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	X-4(%rbx,%r13,4), %edx
...
.Ltmp49:
	...
	addl	(%rax), %edx
	movl	Z-4(%rbx,%r13,4), %edi
	cmpl	%edi, %ebp
	cmovlel	%ebp, %edi
	.loc	1 76 14 discriminator 6 # CoinGame.c:76:14
	addl	-4(%rax,%r13,4), %edi
	cmpl	%edi, %edx
	cmovgel	%edx, %edi
	movl	%edi, M-4(%rbx,%r13,4)
	decq	%rcx
	addq	$4, %rax
	addq	$28, %rbx
	cmpq	%r13, %rcx
...
# BB#39:                                #   in Loop: Header=BB1_35 Depth=1
	...
	decq	%rsi
	.p2align	4, 0x90
.LBB1_40:                               # %polly.loop_header545
                                        #   Parent Loop BB1_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	M-8(%rax,%r15), %ecx
	movl	%ecx, Z(%rax,%r15)
	incq	%rsi
	addq	$28, %rax
	cmpq	%r12, %rsi
	jl	.LBB1_40
.LBB1_41:                               # %polly.loop_exit547
                                        #   in Loop: Header=BB1_35 Depth=1
	incq	%r13
	decq	%r14
	addq	$4, %r15
