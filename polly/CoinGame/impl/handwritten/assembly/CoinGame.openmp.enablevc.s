...
# BB#11:                                # %polly.loop_preheader321
	...
	xorl	%esi, %esi
	.p2align	4, 0x90
.LBB1_12:                               # %polly.loop_header320
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	M+20(%rdx,%rsi), %ebp
	movl	%ebp, Y(%rdx,%rsi)
	incq	%rbx
	addq	$28, %rsi
	cmpq	%rax, %rbx
	jle	.LBB1_12
.LBB1_2:                                # %polly.loop_exit322
                                        #   in Loop: Header=BB1_1 Depth=1
	cmpq	$3, %r11
	movq	%r11, %rax
	cmovgq	%r9, %rax
	testq	%rax, %rax
	js	.LBB1_3
# BB#13:                                # %polly.loop_preheader331
                                        #   in Loop: Header=BB1_1 Depth=1
	decq	%rax
	movq	$-1, %rdx
	movq	%r14, %rsi
	.p2align	4, 0x90
.LBB1_14:                               # %polly.loop_header330
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	M+48(%rsi), %ebx
	movl	%ebx, X(%rsi)
...
.LBB1_3:                                # %polly.cond
	...
	jle	.LBB1_4
	.p2align	4, 0x90
.LBB1_15:                               # %polly.loop_header343
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	X-4(%rbx,%r13,4), %esi
...
# BB#5:                                 #   in Loop: Header=BB1_1 Depth=1
	...
	decq	%rcx
	.p2align	4, 0x90
.LBB1_6:                                # %polly.loop_header368
                                        #   Parent Loop BB1_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	M-8(%rax,%r14), %edx
	movl	%edx, Z(%rax,%r14)
	incq	%rcx
	addq	$28, %rax
	cmpq	%r11, %rcx
	jl	.LBB1_6
.LBB1_7:                                # %polly.loop_exit370
                                        #   in Loop: Header=BB1_1 Depth=1
	incq	%r13
	decq	%r12
	addq	$4, %r14
...
# BB#5:                                 # %polly.par.loadIVBounds.split.us
	...
	js	.LBB4_12
	.p2align	4, 0x90
.LBB4_6:                                # %polly.loop_header.us.us
...
# BB#8:                                 #   in Loop: Header=BB4_6 Depth=2
	...
	movq	%r14, %rsi
	.p2align	4, 0x90
.LBB4_9:                                # %polly.loop_header2.us.us
                                        #   Parent Loop BB4_4 Depth=1
	...
	jmp	.LBB4_11
	.p2align	4, 0x90
.LBB4_10:                               # %polly.loop_header15.us.us
                                        #   Parent Loop BB4_4 Depth=1
                                        #     Parent Loop BB4_6 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movl	$0, (%rsi)
...
.LBB4_15:                               # %polly.merge.us
	...
	jmp	.LBB4_3
	.p2align	4, 0x90
.LBB4_16:                               # %polly.par.loadIVBounds.split
                                        #   in Loop: Header=BB4_4 Depth=1
	cmpq	$0, 8(%rsp)             # 8-byte Folded Reload
	js	.LBB4_21
	.p2align	4, 0x90
.LBB4_17:                               # %polly.loop_header.us31
                                        #   Parent Loop BB4_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_19 Depth 3
	cmpq	$1, %rcx
...
# BB#18:                                #   in Loop: Header=BB4_17 Depth=2
	...
	movq	%r14, %rsi
	.p2align	4, 0x90
.LBB4_19:                               # %polly.loop_header2.us41
                                        #   Parent Loop BB4_4 Depth=1
	...
	cmpq	%rbp, %rdx
	jle	.LBB4_19
.LBB4_20:                               # %polly.merge.us46
                                        #   in Loop: Header=BB4_17 Depth=2
	cmpq	%rax, %rcx
	leaq	1(%rcx), %rcx
	jle	.LBB4_17
	jmp	.LBB4_3
.LBB4_21:                               # %polly.par.loadIVBounds.split.split
                                        #   in Loop: Header=BB4_4 Depth=1
	testq	%r13, %r13
	js	.LBB4_22
	.p2align	4, 0x90
.LBB4_24:                               # %polly.loop_header.us53
                                        #   Parent Loop BB4_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_26 Depth 3
	cmpq	$1, %rcx
...
# BB#25:                                #   in Loop: Header=BB4_24 Depth=2
	...
	movq	%r14, %rsi
	.p2align	4, 0x90
.LBB4_26:                               # %polly.loop_header2.us63
                                        #   Parent Loop BB4_4 Depth=1
	...
	cmpq	%rbp, %rdx
	jle	.LBB4_26
.LBB4_27:                               # %polly.merge.us68
                                        #   in Loop: Header=BB4_24 Depth=2
	cmpq	%rax, %rcx
	leaq	1(%rcx), %rcx
	jle	.LBB4_24
	jmp	.LBB4_3
.LBB4_22:                               # %polly.loop_header.preheader
                                        #   in Loop: Header=BB4_4 Depth=1
	decq	%rcx
	.p2align	4, 0x90
.LBB4_23:                               # %polly.loop_header
                                        #   Parent Loop BB4_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	incq	%rcx
	cmpq	%rax, %rcx
	jle	.LBB4_23
	.p2align	4, 0x90
.LBB4_3:                                # %polly.par.checkNext.loopexit
                                        #   in Loop: Header=BB4_4 Depth=1
	leaq	24(%rsp), %rdi
	leaq	16(%rsp), %rsi
	callq	GOMP_loop_runtime_next
...
.LBB4_2:                                # %polly.par.exit
	...
	retq
.Lfunc_end4:
	.size	maxMoney_polly_subfn_polly_subfn, .Lfunc_end4-maxMoney_polly_subfn_polly_subfn
	.cfi_endproc
...
.LBB5_7:                                # %polly.parallel.for
                                        #   in Loop: Header=BB5_5 Depth=2
	movq	%rbx, 24(%rsp)
	movl	$maxMoney_polly_subfn_8_polly_subfn, %edi
	xorl	%edx, %edx
	xorl	%ecx, %ecx
	movl	$2, %r8d
	movl	$1, %r9d
	...
	callq	GOMP_parallel_loop_runtime_start
	movq	%r12, %rdi
	callq	maxMoney_polly_subfn_8_polly_subfn
	callq	GOMP_parallel_end
...
.LBB5_2:                                # %polly.par.exit
	...
	retq
.Lfunc_end5:
	.size	maxMoney_polly_subfn_8, .Lfunc_end5-maxMoney_polly_subfn_8
	.cfi_endproc

	.p2align	4, 0x90
	.type	maxMoney_polly_subfn_8_polly_subfn,@function
maxMoney_polly_subfn_8_polly_subfn:     # @maxMoney_polly_subfn_8_polly_subfn
.Lfunc_begin6:
	.cfi_startproc
# BB#0:                                 # %polly.par.setup
	pushq	%rbp
...
.LBB6_2:                                # %polly.par.exit
	...
	retq
.Lfunc_end6:
	.size	maxMoney_polly_subfn_8_polly_subfn, .Lfunc_end6-maxMoney_polly_subfn_8_polly_subfn
	.cfi_endproc
...
.LBB7_7:                                # %polly.parallel.for
                                        #   in Loop: Header=BB7_5 Depth=2
	movq	%rbx, 24(%rsp)
	movl	$maxMoney_polly_subfn_9_polly_subfn, %edi
	xorl	%edx, %edx
	xorl	%ecx, %ecx
	movl	$2, %r8d
	movl	$1, %r9d
	...
	callq	GOMP_parallel_loop_runtime_start
	movq	%r12, %rdi
	callq	maxMoney_polly_subfn_9_polly_subfn
	callq	GOMP_parallel_end
...
.LBB7_2:                                # %polly.par.exit
	...
	retq
.Lfunc_end7:
	.size	maxMoney_polly_subfn_9, .Lfunc_end7-maxMoney_polly_subfn_9
	.cfi_endproc

	.p2align	4, 0x90
	.type	maxMoney_polly_subfn_9_polly_subfn,@function
maxMoney_polly_subfn_9_polly_subfn:     # @maxMoney_polly_subfn_9_polly_subfn
.Lfunc_begin8:
	.cfi_startproc
# BB#0:                                 # %polly.par.setup
	pushq	%rbp
...
.LBB8_16:                               # %polly.par.loadIVBounds.split
	...
	js	.LBB8_21
	.p2align	4, 0x90
.LBB8_17:                               # %polly.loop_header.us29
                                        #   Parent Loop BB8_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_19 Depth 3
	cmpq	$1, %rcx
...
# BB#18:                                #   in Loop: Header=BB8_17 Depth=2
	...
	movq	%r14, %rsi
	.p2align	4, 0x90
.LBB8_19:                               # %polly.loop_header2.us39
                                        #   Parent Loop BB8_4 Depth=1
...
.LBB8_21:                               # %polly.par.loadIVBounds.split.split
	...
	js	.LBB8_22
	.p2align	4, 0x90
.LBB8_24:                               # %polly.loop_header.us51
                                        #   Parent Loop BB8_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_26 Depth 3
	cmpq	$1, %rcx
...
# BB#25:                                #   in Loop: Header=BB8_24 Depth=2
	...
	movq	%r14, %rsi
	.p2align	4, 0x90
.LBB8_26:                               # %polly.loop_header2.us61
                                        #   Parent Loop BB8_4 Depth=1
...
.LBB8_2:                                # %polly.par.exit
	...
	retq
.Lfunc_end8:
	.size	maxMoney_polly_subfn_9_polly_subfn, .Lfunc_end8-maxMoney_polly_subfn_9_polly_subfn
	.cfi_endproc
