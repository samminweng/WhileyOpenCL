...
blklab2:                                          ; preds = %blklab6
  ...
  %exitcond155 = icmp eq i64 %add52, 9223372036854775807
...
polly.stmt.blklab6:                               ; preds = %polly.cond178, %polly.stmt.if.end26
  ...
  %p_cmp31 = icmp sgt i64 %x.0.phiops.0, %y.0.phiops.0
  %p_y.0.x.0 = select i1 %p_cmp31, i64 %y.0.phiops.0, i64 %x.0.phiops.0
  %p_cmp34 = icmp sgt i64 %z.0.phiops.0, %y.0.phiops.0
  %p_z.1 = select i1 %p_cmp34, i64 %y.0.phiops.0, i64 %z.0.phiops.0
  %p_add37 = add nsw i64 %p_y.0.x.0, %polly.indvar161
  %p_add38 = add nsw i64 %p_z.1, %11
  %p_cmp39 = icmp sgt i64 %p_add37, %p_add38
  %p_add37.p_add38 = select i1 %p_cmp39, i64 %p_add37, i64 %p_add38
  %uglygep191 = getelementptr i8, i8* %scevgep189190, i64 %17
  %uglygep191192 = bitcast i8* %uglygep191 to i64*
  store i64 %p_add37.p_add38, i64* %uglygep191192, align 8, !alias.scope !5, !noalias !7
...
entry:
  ...
  %0 = load i64*, i64** %call, align 8, !tbaa !12
...
if.then122:                                       ; preds = %entry
  ...
  %call38 = tail call i64* @create1DArray(i32 0, i32 50) #5
  ...
  tail call void @printf_s(i64* %call38, i64 50) #5
  %call89 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %2)
  %call94 = tail call i64* @create1DArray(i32 0, i32 23) #5
  ...
  tail call void @println_s(i64* %call94, i64 23) #5
  ...
  tail call void @free(i8* %phitmp260) #5
  tail call void @free2DArray(i64** %call, i64 %conv) #5
  tail call void @free(i8* %phitmp259) #5
...
!9 = distinct !{!9, !6, !"polly.alias.scope.storemerge"}
!10 = distinct !{!10, !6, !"polly.alias.scope.y.0"}
!11 = distinct !{!11, !6, !"polly.alias.scope.x.0"}
!12 = !{!13, !13, i64 0}
