...
if.then119:                                       ; preds = %entry
  ...
  %call35 = tail call i64* @create1DArray(i32 0, i32 50) #5
  ...
  tail call void @printf_s(i64* %call35, i64 50) #5
  %call86 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %2)
  %call91 = tail call i64* @create1DArray(i32 0, i32 23) #5
  ...
  tail call void @println_s(i64* %call91, i64 23) #5
  ...
  tail call void @free(i8* %phitmp255) #5
  tail call void @free2DArray(i64** %call, i64 %conv) #5
  tail call void @free(i8* %phitmp254) #5
