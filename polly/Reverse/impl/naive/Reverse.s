...
blklab3:                                          ; preds = %if.end7, %if.then
  ...
  %call8 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.20, i32 0, i32 0))
...
if.end21:                                         ; preds = %blklab5
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %41, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.20, i32 0, i32 0))
  call void @exit(i32 -1) #7
  unreachable
...
if.end27:                                         ; preds = %blklab7
  ...
  %call28 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.20, i32 0, i32 0))
  call void @exit(i32 -1) #7
  unreachable

blklab8:                                          ; preds = %if.then26
  store i64 36, i64* %_23_size, align 8
  %call29 = call noalias i8* @malloc(i64 288) #6
  ...
  %call66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.21, i32 0, i32 0), i64 %87)
  br label %blklab4
