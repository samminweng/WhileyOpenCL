...
entry:
  ...
  br i1 %cmp, label %if.end91.critedge, label %if.end8

if.end8:                                          ; preds = %entry
  %1 = load i64, i64* %call1, align 8, !tbaa !5
  %conv13 = trunc i64 %1 to i32
  %call14 = tail call i64* @create1DArray(i32 0, i32 %conv13) #6
  %cmp20156 = icmp sgt i64 %1, 0
  br i1 %cmp20156, label %polly.parallel.for, label %if.end28
...
blklab2.i:                                        ; preds = %if.end18.i, %if.end28
  ...
  br i1 %cmp15.i, label %if.then72, label %if.end18.i
...
if.then72:                                        ; preds = %blklab2.i
  %5 = bitcast i64* %call14 to i8*
  tail call void @free(i8* %5) #6
  %6 = load i64, i64* %call.i, align 8, !tbaa !5
  %call37 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i64 %6)
  %sub38 = add nsw i64 %1, -1
  %arrayidx39 = getelementptr inbounds i64, i64* %call.i, i64 %sub38
  %7 = load i64, i64* %arrayidx39, align 8, !tbaa !5
  %call40 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i64 %7)
  %call45 = tail call i64* @create1DArray(i32 0, i32 22) #6
  %8 = bitcast i64* %call45 to <2 x i64>*
  ...
  tail call void @println_s(i64* %call45, i64 22) #6
  %phitmp = bitcast i64* %call45 to i8*
  %phitmp155 = bitcast i64* %call.i to i8*
  %19 = bitcast i64* %call1 to i8*
  tail call void @free(i8* %19) #6
  tail call void @free(i8* %phitmp155) #6
