...
while.body:                                       ; preds = %entry, %blklab1
  %8 = load i64, i64* %ls_size.addr, align 8
  store i64 %8, i64* %_9, align 8
...
if.end:                                           ; preds = %while.body
  %11 = load i64, i64* %r_size, align 8
  store i64 %11, i64* %_10, align 8
  %12 = load i64, i64* %ls_size.addr, align 8
  store i64 %12, i64* %_11, align 8
  %13 = load i64, i64* %_10, align 8
...
blklab3:                                          ; preds = %if.end6, %if.then
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
...
if.then10:                                        ; preds = %blklab2
  br label %blklab0

if.end11:                                         ; preds = %blklab2
  %18 = load i64, i64* %ls_size.addr, align 8
  store i64 %18, i64* %_13, align 8
  %19 = load i64, i64* %_13, align 8
  %20 = load i64, i64* %i, align 8
  %sub = sub nsw i64 %19, %20
  store i64 %sub, i64* %_14, align 8
  %21 = load i64, i64* %_14, align 8
  %22 = load i64*, i64** %ls.addr, align 8
  ...
  store i64 %24, i64* %item, align 8
  store i64 1, i64* %_16, align 8
  %25 = load i64, i64* %i, align 8
  %26 = load i64, i64* %_16, align 8
  %sub12 = sub nsw i64 %25, %26
  store i64 %sub12, i64* %_17, align 8
  %27 = load i64, i64* %_17, align 8
  store i64 %27, i64* %i, align 8
  %28 = load i64, i64* %item, align 8
  %29 = load i64, i64* %i, align 8
  %30 = load i64*, i64** %r, align 8
  %arrayidx13 = getelementptr inbounds i64, i64* %30, i64 %29
  store i64 %28, i64* %arrayidx13, align 8
  br label %blklab1

blklab1:                                          ; preds = %if.end11
  br label %while.body

blklab0:                                          ; preds = %if.then10
...
blklab6:                                          ; preds = %if.end9
  br label %while.body

blklab5:                                          ; preds = %if.then8
  %28 = load i64, i64* %arr_size, align 8
  store i64 %28, i64* %_16_size, align 8
  %29 = load i64*, i64** %arr, align 8
  %30 = load i64, i64* %arr_size, align 8
  %call13 = call i64* @reverse(i64* %29, i64 %30)
  store i64* %call13, i64** %_16, align 8
  %31 = load i64, i64* %_16_size, align 8
  store i64 %31, i64* %arr_size, align 8
  %32 = load i64*, i64** %_16, align 8
  store i64* %32, i64** %arr, align 8
  store i64 0, i64* %_17, align 8
  %33 = load i64, i64* %_17, align 8
  %34 = load i64*, i64** %arr, align 8
  %arrayidx14 = getelementptr inbounds i64, i64* %34, i64 %33
  %35 = load i64, i64* %arrayidx14, align 8
  store i64 %35, i64* %_18, align 8
  store i64 0, i64* %_19, align 8
  %36 = load i64, i64* %_18, align 8
  %37 = load i64, i64* %_19, align 8
  %cmp15 = icmp eq i64 %36, %37
  br i1 %cmp15, label %if.then17, label %if.end18

if.then17:                                        ; preds = %blklab5
  br label %blklab7

if.end18:                                         ; preds = %blklab5
  %38 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call19 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %38, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
  call void @exit(i32 -1) #4
  unreachable

blklab7:                                          ; preds = %if.then17
  %39 = load i64, i64* %max, align 8
  %40 = load i64*, i64** %arr, align 8
  %arrayidx20 = getelementptr inbounds i64, i64* %40, i64 %39
  %41 = load i64, i64* %arrayidx20, align 8
  store i64 %41, i64* %_20, align 8
  %42 = load i64, i64* %_20, align 8
  %43 = load i64, i64* %max, align 8
  %cmp21 = icmp eq i64 %42, %43
  br i1 %cmp21, label %if.then23, label %if.end24

if.then23:                                        ; preds = %blklab7
  br label %blklab8

if.end24:                                         ; preds = %blklab7
  %44 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call25 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %44, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
  call void @exit(i32 -1) #4
  unreachable

blklab8:                                          ; preds = %if.then23
  store i64 36, i64* %_23_size, align 8
  %call26 = call noalias i8* @malloc(i64 288) #5
  %45 = bitcast i8* %call26 to i64*
  store i64* %45, i64** %_23, align 8
  %46 = load i64*, i64** %_23, align 8
  %arrayidx27 = getelementptr inbounds i64, i64* %46, i64 0
  store i64 80, i64* %arrayidx27, align 8
  %47 = load i64*, i64** %_23, align 8
  %arrayidx28 = getelementptr inbounds i64, i64* %47, i64 1
  store i64 97, i64* %arrayidx28, align 8
  %48 = load i64*, i64** %_23, align 8
  %arrayidx29 = getelementptr inbounds i64, i64* %48, i64 2
  store i64 115, i64* %arrayidx29, align 8
  %49 = load i64*, i64** %_23, align 8
  %arrayidx30 = getelementptr inbounds i64, i64* %49, i64 3
  store i64 115, i64* %arrayidx30, align 8
  %50 = load i64*, i64** %_23, align 8
  %arrayidx31 = getelementptr inbounds i64, i64* %50, i64 4
  store i64 32, i64* %arrayidx31, align 8
  %51 = load i64*, i64** %_23, align 8
  %arrayidx32 = getelementptr inbounds i64, i64* %51, i64 5
  store i64 82, i64* %arrayidx32, align 8
  %52 = load i64*, i64** %_23, align 8
  %arrayidx33 = getelementptr inbounds i64, i64* %52, i64 6
  store i64 101, i64* %arrayidx33, align 8
  %53 = load i64*, i64** %_23, align 8
  %arrayidx34 = getelementptr inbounds i64, i64* %53, i64 7
  store i64 118, i64* %arrayidx34, align 8
  %54 = load i64*, i64** %_23, align 8
  %arrayidx35 = getelementptr inbounds i64, i64* %54, i64 8
  store i64 101, i64* %arrayidx35, align 8
  %55 = load i64*, i64** %_23, align 8
  %arrayidx36 = getelementptr inbounds i64, i64* %55, i64 9
  store i64 114, i64* %arrayidx36, align 8
  %56 = load i64*, i64** %_23, align 8
  %arrayidx37 = getelementptr inbounds i64, i64* %56, i64 10
  store i64 115, i64* %arrayidx37, align 8
  %57 = load i64*, i64** %_23, align 8
  %arrayidx38 = getelementptr inbounds i64, i64* %57, i64 11
  store i64 101, i64* %arrayidx38, align 8
  %58 = load i64*, i64** %_23, align 8
  %arrayidx39 = getelementptr inbounds i64, i64* %58, i64 12
  store i64 32, i64* %arrayidx39, align 8
  %59 = load i64*, i64** %_23, align 8
  %arrayidx40 = getelementptr inbounds i64, i64* %59, i64 13
  store i64 116, i64* %arrayidx40, align 8
  %60 = load i64*, i64** %_23, align 8
  %arrayidx41 = getelementptr inbounds i64, i64* %60, i64 14
  store i64 101, i64* %arrayidx41, align 8
  %61 = load i64*, i64** %_23, align 8
  %arrayidx42 = getelementptr inbounds i64, i64* %61, i64 15
  store i64 115, i64* %arrayidx42, align 8
  %62 = load i64*, i64** %_23, align 8
  %arrayidx43 = getelementptr inbounds i64, i64* %62, i64 16
  store i64 116, i64* %arrayidx43, align 8
  %63 = load i64*, i64** %_23, align 8
  %arrayidx44 = getelementptr inbounds i64, i64* %63, i64 17
  store i64 32, i64* %arrayidx44, align 8
  %64 = load i64*, i64** %_23, align 8
  %arrayidx45 = getelementptr inbounds i64, i64* %64, i64 18
  store i64 99, i64* %arrayidx45, align 8
  %65 = load i64*, i64** %_23, align 8
  %arrayidx46 = getelementptr inbounds i64, i64* %65, i64 19
  store i64 97, i64* %arrayidx46, align 8
  %66 = load i64*, i64** %_23, align 8
  %arrayidx47 = getelementptr inbounds i64, i64* %66, i64 20
  store i64 115, i64* %arrayidx47, align 8
  %67 = load i64*, i64** %_23, align 8
  %arrayidx48 = getelementptr inbounds i64, i64* %67, i64 21
  store i64 101, i64* %arrayidx48, align 8
  %68 = load i64*, i64** %_23, align 8
  %arrayidx49 = getelementptr inbounds i64, i64* %68, i64 22
  store i64 32, i64* %arrayidx49, align 8
  %69 = load i64*, i64** %_23, align 8
  %arrayidx50 = getelementptr inbounds i64, i64* %69, i64 23
  store i64 119, i64* %arrayidx50, align 8
  %70 = load i64*, i64** %_23, align 8
  %arrayidx51 = getelementptr inbounds i64, i64* %70, i64 24
  store i64 105, i64* %arrayidx51, align 8
  %71 = load i64*, i64** %_23, align 8
  %arrayidx52 = getelementptr inbounds i64, i64* %71, i64 25
  store i64 116, i64* %arrayidx52, align 8
  %72 = load i64*, i64** %_23, align 8
  %arrayidx53 = getelementptr inbounds i64, i64* %72, i64 26
  store i64 104, i64* %arrayidx53, align 8
  %73 = load i64*, i64** %_23, align 8
  %arrayidx54 = getelementptr inbounds i64, i64* %73, i64 27
  store i64 32, i64* %arrayidx54, align 8
  %74 = load i64*, i64** %_23, align 8
  %arrayidx55 = getelementptr inbounds i64, i64* %74, i64 28
  store i64 105, i64* %arrayidx55, align 8
  %75 = load i64*, i64** %_23, align 8
  %arrayidx56 = getelementptr inbounds i64, i64* %75, i64 29
  store i64 110, i64* %arrayidx56, align 8
  %76 = load i64*, i64** %_23, align 8
  %arrayidx57 = getelementptr inbounds i64, i64* %76, i64 30
  store i64 112, i64* %arrayidx57, align 8
  %77 = load i64*, i64** %_23, align 8
  %arrayidx58 = getelementptr inbounds i64, i64* %77, i64 31
  store i64 117, i64* %arrayidx58, align 8
  %78 = load i64*, i64** %_23, align 8
  %arrayidx59 = getelementptr inbounds i64, i64* %78, i64 32
  store i64 116, i64* %arrayidx59, align 8
  %79 = load i64*, i64** %_23, align 8
  %arrayidx60 = getelementptr inbounds i64, i64* %79, i64 33
  store i64 32, i64* %arrayidx60, align 8
  %80 = load i64*, i64** %_23, align 8
  %arrayidx61 = getelementptr inbounds i64, i64* %80, i64 34
  store i64 61, i64* %arrayidx61, align 8
  %81 = load i64*, i64** %_23, align 8
  %arrayidx62 = getelementptr inbounds i64, i64* %81, i64 35
  store i64 32, i64* %arrayidx62, align 8
  %82 = load i64*, i64** %_23, align 8
  %83 = load i64, i64* %_23_size, align 8
  call void @printf_s(i64* %82, i64 %83)
  %84 = load i64, i64* %max, align 8
  %call63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i64 %84)
  br label %blklab4
