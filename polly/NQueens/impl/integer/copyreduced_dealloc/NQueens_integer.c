...
int main(int argc, char** args){
	...
	_DEALLOC_1DARRAY_STRUCT(queens, POS);
	_UPDATE_1DARRAY(queens, _12);
	_TRANSFER_DEALLOC(queens, _12);
	//const %14 = 0 : int
	_14 = 0;
	//invoke (%13) = (%3, %14, %2) NQueens_integer:run : function(NQueens_integer:POS[],int,int)->(int)
	{
		_13 = run(_1DARRAY_PARAM(queens), false, _14, n);
		_RETAIN_DEALLOC(queens, "true-false-false" , "run");
	}
	//assign %4 = %13  : int
	num_solutions = _13;
	...
	_DEALLOC(_17);
	_NEW_1DARRAY_LONGLONG(_17, 33, 0);
	...
	_DEALLOC(_30);
	_NEW_1DARRAY_LONGLONG(_30, 11, 0);
