...
blklab10.preheader:                               ; preds = %while.cond.preheader
  ...
  %1 = bitcast %struct.POS** %arrayidx74 to i8**
...
if.end70.us:                                      ; preds = %blklab14.preheader.us, %blklab14.blklab12_crit_edge.us
  ...
  store i64 %col.0249.us280, i64* %2, align 8, !tbaa !9
  %r.us = bitcast i8* %call71.us to i64*
  store i64 %n, i64* %r.us, align 8, !tbaa !7
  %3 = load i8*, i8** %1, align 8, !tbaa !5
  tail call void @free(i8* %3) #6
  store i8* %call71.us, i8** %1, align 8, !tbaa !5
  %call.i.us = tail call noalias i8* @malloc(i64 %mul.i) #6
  %4 = bitcast i8* %call.i.us to %struct.POS**
...
for.body.i.us:                                    ; preds = %for.body.i.us.preheader, %for.body.i.us
  ...
  %5 = bitcast %struct.POS** %arrayidx.i.us to <2 x i64>**
  %6 = load <2 x i64>*, <2 x i64>** %5, align 8, !tbaa !5
  %call.i.i.us = tail call noalias i8* @malloc(i64 16) #6
  %7 = load <2 x i64>, <2 x i64>* %6, align 8, !tbaa !1
  %8 = bitcast i8* %call.i.i.us to <2 x i64>*
  store <2 x i64> %7, <2 x i64>* %8, align 8, !tbaa !1
  %arrayidx4.i.us = getelementptr inbounds %struct.POS*, %struct.POS** %4, i64 %indvars.iv.i.us
  %9 = bitcast %struct.POS** %arrayidx4.i.us to i8**
  store i8* %call.i.i.us, i8** %9, align 8, !tbaa !5
...
copy_array_POS.exit.us:                           ; preds = %copy_array_POS.exit.us.loopexit, %if.end70.us
  %call80.us = tail call i64 @run(%struct.POS** %4, i64 %dim, i1 zeroext true, i64 %add78, i64 %dim)
...
polly.split_new_and_old.us:                       ; preds = %polly.split_new_and_old.us.preheader, %blklab18.us
  %10 = phi i1 [ %17, %blklab18.us ], [ true, %polly.split_new_and_old.us.preheader ]
  %i.0248258.us = phi i64 [ %add.us, %blklab18.us ], [ 0, %polly.split_new_and_old.us.preheader ]
  br i1 %10, label %blklab20.us, label %blklab18.us
...
blklab20.us:                                      ; preds = %polly.split_new_and_old.us
  ...
  %11 = load %struct.POS*, %struct.POS** %arrayidx48.us, align 8, !tbaa !5
  %r1.i.us = getelementptr inbounds %struct.POS, %struct.POS* %11, i64 0, i32 0
  %12 = load i64, i64* %r1.i.us, align 8, !tbaa !7
  %c2.i.us = getelementptr inbounds %struct.POS, %struct.POS* %11, i64 0, i32 1
  %13 = load i64, i64* %c2.i.us, align 8, !tbaa !9
  %cmp.i.us = icmp eq i64 %12, %n
  %cmp3.i.us = icmp eq i64 %13, %col.0249.us280
...
blklab0.i.us:                                     ; preds = %blklab20.us
  %sub.i.us = sub nsw i64 %13, %col.0249.us280
  %ispos.i.us = icmp sgt i64 %sub.i.us, -1
  %neg.i.us = sub i64 0, %sub.i.us
  %14 = select i1 %ispos.i.us, i64 %sub.i.us, i64 %neg.i.us
  %sub8.i.us = sub nsw i64 %12, %n
  %ispos49.i.us = icmp sgt i64 %sub8.i.us, -1
  %neg50.i.us = sub i64 0, %sub8.i.us
  %15 = select i1 %ispos49.i.us, i64 %sub8.i.us, i64 %neg50.i.us
  %cmp10.i.us = icmp eq i64 %14, %15
...
conflict.exit.us:                                 ; preds = %blklab0.i.us, %blklab20.us
  ...
  %16 = xor i64 %retval.0.i.us, 1
  br label %blklab18.us

blklab18.us:                                      ; preds = %conflict.exit.us, %polly.split_new_and_old.us
  %_23.0.ph.merge.us = phi i64 [ %16, %conflict.exit.us ], [ 0, %polly.split_new_and_old.us ]
  %add.us = add nuw nsw i64 %i.0248258.us, 1
  %17 = icmp eq i64 %_23.0.ph.merge.us, 1
...
blklab14.blklab12_crit_edge.us:                   ; preds = %blklab18.us
  br i1 %17, label %if.end70.us, label %blklab22.us
...
if.end70:                                         ; preds = %blklab14.preheader, %blklab12
  ...
  store i8* %call71, i8** %1, align 8, !tbaa !5
...
for.body91:                                       ; preds = %for.body91.preheader, %for.body91
  ...
  %37 = bitcast %struct.POS** %arrayidx93 to i8**
