...
entry.split:                                      ; preds = %entry
  ...
  %putchar7 = tail call i32 @putchar(i32 125) #5
  ret void
}
...
for.body.preheader:                               ; preds = %entry.split
  ...
  %.pre = load %struct.POS**, %struct.POS*** %queens4, align 8, !tbaa !12
  br label %for.body
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.body.preheader ]
  %arrayidx = getelementptr inbounds %struct.POS*, %struct.POS** %.pre, i64 %indvars.iv
  %7 = bitcast %struct.POS** %arrayidx to <2 x i64>**
  %8 = load <2 x i64>*, <2 x i64>** %7, align 8, !tbaa !5
  %call.i = tail call noalias i8* @malloc(i64 16) #5
  %9 = load <2 x i64>, <2 x i64>* %8, align 8, !tbaa !1
  %10 = bitcast i8* %call.i to <2 x i64>*
  store <2 x i64> %9, <2 x i64>* %10, align 8, !tbaa !1
  %arrayidx8 = getelementptr inbounds %struct.POS*, %struct.POS** %3, i64 %indvars.iv
  %11 = bitcast %struct.POS** %arrayidx8 to i8**
  store i8* %call.i, i8** %11, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body:                                         ; preds = %for.body.preheader, %copy_NQueen.exit
  ...
  %mul.i = shl i64 %2, 3
  %call1.i = tail call noalias i8* @malloc(i64 %mul.i) #5
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry.split
  ...
  %call4 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i64 %1)
  %putchar11 = tail call i32 @putchar(i32 125) #5
  ret void
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %putchar.i = tail call i32 @putchar(i32 123) #5
  %call1.i = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #5
  %r.i = getelementptr inbounds %struct.POS, %struct.POS* %3, i64 0, i32 0
  %4 = load i64, i64* %r.i, align 8, !tbaa !7
  %call2.i = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i64 %4) #5
  %call3.i = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0)) #5
  %c.i = getelementptr inbounds %struct.POS, %struct.POS* %3, i64 0, i32 1
  %5 = load i64, i64* %c.i, align 8, !tbaa !9
  %call4.i = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i64 %5) #5
  %putchar7.i = tail call i32 @putchar(i32 125) #5
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
...
cleanup:                                          ; preds = %if.then14, %blklab0, %if.then6, %blklab1
  %retval.0 = phi i64 [ 1, %if.then6 ], [ 1, %blklab1 ], [ %., %if.then14 ], [ %., %blklab0 ]
  ret i64 %retval.0
}

; Function Attrs: nounwind uwtable
define %struct.NQueen* @run(%struct.NQueen* %nq, i1 zeroext %nq_dealloc, i64 %n, i64 %dim) local_unnamed_addr #0 {
entry:
  br label %entry.split
...
blklab10.lr.ph:                                   ; preds = %blklab6
  ...
  br i1 %or.cond509.not516, label %blklab10.us.preheader, label %blklab10

blklab10.us.preheader:                            ; preds = %blklab10.lr.ph
  %frombool = zext i1 %nq_dealloc to i8
  br label %blklab10.us

blklab10.us:                                      ; preds = %blklab10.us.preheader, %blklab22.us
  %nq.pn.us = phi %struct.NQueen* [ %nq.addr.1.us, %blklab22.us ], [ %nq, %blklab10.us.preheader ]
  %nq_dealloc.addr.0527.us = phi i8 [ %nq_dealloc.addr.1.us, %blklab22.us ], [ %frombool, %blklab10.us.preheader ]
  %col.0526.us = phi i64 [ %add175.us, %blklab22.us ], [ 0, %blklab10.us.preheader ]
  %queens530.us = getelementptr inbounds %struct.NQueen, %struct.NQueen* %nq.pn.us, i64 0, i32 0
  %cmp102.us = icmp slt i64 %col.0526.us, %dim
  br i1 %cmp102.us, label %blklab14.preheader.us, label %cleanup.loopexit

blklab14.preheader.us:                            ; preds = %blklab10.us
  br i1 %cmp125549, label %if.end128.us.preheader, label %if.end153.us

if.end128.us.preheader:                           ; preds = %blklab14.preheader.us
  br label %if.end128.us

if.end128.us:                                     ; preds = %if.end128.us.preheader, %blklab18.us
  %cmp137551.us = phi i1 [ %cmp137.us, %blklab18.us ], [ true, %if.end128.us.preheader ]
  %i.0520550.us = phi i64 [ %add146.us, %blklab18.us ], [ 0, %if.end128.us.preheader ]
  br i1 %cmp137551.us, label %blklab20.us, label %blklab18.us

blklab20.us:                                      ; preds = %if.end128.us
  %2 = load %struct.POS**, %struct.POS*** %queens530.us, align 8, !tbaa !12
  %arrayidx131.us = getelementptr inbounds %struct.POS*, %struct.POS** %2, i64 %i.0520550.us
  %3 = load %struct.POS*, %struct.POS** %arrayidx131.us, align 8, !tbaa !5
  %r1.i.us = getelementptr inbounds %struct.POS, %struct.POS* %3, i64 0, i32 0
  %4 = load i64, i64* %r1.i.us, align 8, !tbaa !7
  %c2.i.us = getelementptr inbounds %struct.POS, %struct.POS* %3, i64 0, i32 1
  %5 = load i64, i64* %c2.i.us, align 8, !tbaa !9
  %cmp.i.us = icmp eq i64 %4, %n
  %cmp3.i.us = icmp eq i64 %5, %col.0526.us
...
blklab0.i.us:                                     ; preds = %blklab20.us
  %sub.i.us = sub nsw i64 %5, %col.0526.us
  %ispos.i.us = icmp sgt i64 %sub.i.us, -1
  %neg.i.us = sub i64 0, %sub.i.us
  %6 = select i1 %ispos.i.us, i64 %sub.i.us, i64 %neg.i.us
  %sub8.i.us = sub nsw i64 %4, %n
  %ispos49.i.us = icmp sgt i64 %sub8.i.us, -1
  %neg50.i.us = sub i64 0, %sub8.i.us
  %7 = select i1 %ispos49.i.us, i64 %sub8.i.us, i64 %neg50.i.us
  %cmp10.i.us = icmp eq i64 %6, %7
...
conflict.exit.us:                                 ; preds = %blklab0.i.us, %blklab20.us
  ...
  %8 = xor i64 %retval.0.i.us, 1
  br label %blklab18.us

blklab18.us:                                      ; preds = %conflict.exit.us, %if.end128.us
  %_28.0.us = phi i64 [ 0, %if.end128.us ], [ %8, %conflict.exit.us ]
  %add146.us = add nuw nsw i64 %i.0520550.us, 1
  %cmp137.us = icmp eq i64 %_28.0.us, 1
  %exitcond.us = icmp eq i64 %add146.us, %n
  br i1 %exitcond.us, label %blklab12.us, label %if.end128.us

blklab12.us:                                      ; preds = %blklab18.us
  %cmp137.us.lcssa = phi i1 [ %cmp137.us, %blklab18.us ]
  br i1 %cmp137.us.lcssa, label %if.end153.us, label %blklab22.us

if.end153.us:                                     ; preds = %blklab12.us, %blklab14.preheader.us
  %call154.us = tail call noalias i8* @malloc(i64 16) #5
  %c.us = getelementptr inbounds i8, i8* %call154.us, i64 8
  %9 = bitcast i8* %c.us to i64*
  store i64 %col.0526.us, i64* %9, align 8, !tbaa !9
  %r.us = bitcast i8* %call154.us to i64*
  store i64 %n, i64* %r.us, align 8, !tbaa !7
  %10 = and i8 %nq_dealloc.addr.0527.us, 1
  %tobool155.us = icmp ne i8 %10, 0
  br i1 %tobool155.us, label %if.then156.us, label %if.end161.us

if.then156.us:                                    ; preds = %if.end153.us
  %11 = load %struct.POS**, %struct.POS*** %queens530.us, align 8, !tbaa !12
  %arrayidx158.us = getelementptr inbounds %struct.POS*, %struct.POS** %11, i64 %n
  %12 = bitcast %struct.POS** %arrayidx158.us to i8**
  %13 = load i8*, i8** %12, align 8, !tbaa !5
  tail call void @free(i8* %13) #5
  %14 = load %struct.POS**, %struct.POS*** %queens530.us, align 8, !tbaa !12
  %arrayidx160.us = getelementptr inbounds %struct.POS*, %struct.POS** %14, i64 %n
  store %struct.POS* null, %struct.POS** %arrayidx160.us, align 8, !tbaa !5
  br label %if.end161.us

if.end161.us:                                     ; preds = %if.then156.us, %if.end153.us
  %15 = load %struct.POS**, %struct.POS*** %queens530.us, align 8, !tbaa !12
  %arrayidx163.us = getelementptr inbounds %struct.POS*, %struct.POS** %15, i64 %n
  %16 = bitcast %struct.POS** %arrayidx163.us to i8**
  store i8* %call154.us, i8** %16, align 8, !tbaa !5
  %call169.us = tail call %struct.NQueen* @run(%struct.NQueen* %nq.pn.us, i1 zeroext %tobool155.us, i64 %add164, i64 %dim)
  br label %blklab22.us

blklab22.us:                                      ; preds = %if.end161.us, %blklab12.us
  %nq_dealloc.addr.1.us = phi i8 [ %nq_dealloc.addr.0527.us, %blklab12.us ], [ 1, %if.end161.us ]
  %nq.addr.1.us = phi %struct.NQueen* [ %nq.pn.us, %blklab12.us ], [ %call169.us, %if.end161.us ]
  %add175.us = add nuw nsw i64 %col.0526.us, 1
  %queens_size.us = getelementptr inbounds %struct.NQueen, %struct.NQueen* %nq.addr.1.us, i64 0, i32 1
  %17 = load i64, i64* %queens_size.us, align 8, !tbaa !10
  %cmp92.us = icmp sgt i64 %17, %n
  %cmp98.us = icmp eq i64 %17, %dim
  %or.cond.us = and i1 %cmp92.us, %cmp98.us
  br i1 %or.cond.us, label %blklab10.us, label %blklab11.loopexit

blklab11.loopexit:                                ; preds = %blklab22.us
  br label %blklab11

blklab11:                                         ; preds = %blklab11.loopexit, %blklab6
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !5
  %19 = tail call i64 @fwrite(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i64 0, i64 0), i64 4, i64 1, %struct._IO_FILE* %18) #7
  tail call void @exit(i32 -1) #8
  unreachable

blklab10:                                         ; preds = %blklab10.lr.ph
  %cmp102 = icmp sgt i64 %dim, 0
  br i1 %cmp102, label %blklab15, label %cleanup

blklab15:                                         ; preds = %blklab10
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !5
  %21 = tail call i64 @fwrite(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i64 0, i64 0), i64 4, i64 1, %struct._IO_FILE* %20) #7
  tail call void @exit(i32 -1) #8
  unreachable

cleanup.loopexit:                                 ; preds = %blklab10.us
  %nq.pn.us.lcssa = phi %struct.NQueen* [ %nq.pn.us, %blklab10.us ]
  br label %cleanup

cleanup:                                          ; preds = %cleanup.loopexit, %blklab10, %if.end
  %retval.0 = phi %struct.NQueen* [ %nq, %if.end ], [ %nq, %blklab10 ], [ %nq.pn.us.lcssa, %cleanup.loopexit ]
...
if.end5:                                          ; preds = %entry.split
  ...
  %mul = shl i64 %1, 3
  %call19 = tail call noalias i8* @malloc(i64 %mul) #5
...
if.end50.thread:                                  ; preds = %if.end5
  %call52418 = tail call noalias i8* @malloc(i64 %mul) #5
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  ...
  tail call void @llvm.memset.p0i8.i64(i8* %call.i, i8 0, i64 16, i32 8, i1 false)
...
for.body60.preheader:                             ; preds = %for.body26
  %call52 = tail call noalias i8* @malloc(i64 %mul) #5
...
for.body60:                                       ; preds = %for.body60, %for.body60.preheader
  ...
  %7 = load <2 x i64>*, <2 x i64>** %6, align 8, !tbaa !5
  %call.i412 = tail call noalias i8* @malloc(i64 16) #5
  %8 = load <2 x i64>, <2 x i64>* %7, align 8, !tbaa !1
...
if.then191:                                       ; preds = %if.then191.loopexit, %if.end50.thread
  ...
  %call.i417 = tail call noalias i8* @malloc(i64 24) #5
  ...
  %call96 = tail call i64* @create1DArray(i32 0, i32 33) #5
  ...
  tail call void @println_s(i64* %call96, i64 33) #5
  %call134 = tail call i64* @create1DArray(i32 0, i32 4) #5
  ...
  tail call void @printf_s(i64* %call144, i64 6) #5
  ...
  %call157 = tail call i64* @create1DArray(i32 0, i32 11) #5
  ...
  tail call void @println_s(i64* %call157, i64 11) #5
...
free_NQueen.exit:                                 ; preds = %free_NQueen.exit.loopexit, %if.then191
  ...
  tail call void @free(i8* %phitmp393) #5
  tail call void @free(i8* %phitmp392) #5
  tail call void @free(i8* %phitmp391) #5
  tail call void @free(i8* %phitmp) #5
  br label %if.end240

if.end240:                                        ; preds = %free_NQueen.exit, %entry.split
