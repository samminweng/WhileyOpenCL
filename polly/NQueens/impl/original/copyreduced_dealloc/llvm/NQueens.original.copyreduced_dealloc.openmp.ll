...
while.cond.preheader:                             ; preds = %entry
  %queens_size645 = getelementptr inbounds %struct.NQueen, %struct.NQueen* %nq, i64 0, i32 1
  %0 = load i64, i64* %queens_size645, align 8, !tbaa !10
  %cmp109647 = icmp sgt i64 %0, %n
  br i1 %cmp109647, label %if.end129.preheader, label %blklab11

if.end129.preheader:                              ; preds = %while.cond.preheader
  %add246 = add nsw i64 %n, 1
  %cmp161641 = icmp sgt i64 %dim, %n
  %cmp193673 = icmp sgt i64 %n, 0
  br label %if.end129
...
if.end129:                                        ; preds = %if.end129.preheader, %blklab22
  %2 = phi i64 [ %23, %blklab22 ], [ %0, %if.end129.preheader ]
  %nq.pn = phi %struct.NQueen* [ %nq.addr.1, %blklab22 ], [ %nq, %if.end129.preheader ]
  %col.0648 = phi i64 [ %add256, %blklab22 ], [ 0, %if.end129.preheader ]
  %queens651 = getelementptr inbounds %struct.NQueen, %struct.NQueen* %nq.pn, i64 0, i32 0
...
blklab11:                                         ; preds = %blklab11.loopexit, %while.cond.preheader
...
blklab10:                                         ; preds = %if.end129
  %cmp136 = icmp slt i64 %col.0648, %dim
  br i1 %cmp136, label %while.cond140.preheader, label %cleanup.loopexit

while.cond140.preheader:                          ; preds = %blklab10
  br i1 %cmp161641, label %if.end185.preheader, label %blklab15

if.end185.preheader:                              ; preds = %while.cond140.preheader
  br i1 %cmp193673, label %polly.split_new_and_old.preheader, label %if.end238
...
polly.split_new_and_old:                          ; preds = %polly.split_new_and_old.preheader, %blklab18
  ...
  %i.0644674 = phi i64 [ %add231, %blklab18 ], [ 0, %polly.split_new_and_old.preheader ]
  br i1 %7, label %blklab20, label %blklab18

blklab20:                                         ; preds = %polly.split_new_and_old
  %8 = load %struct.POS**, %struct.POS*** %queens651, align 8, !tbaa !12
  %arrayidx216 = getelementptr inbounds %struct.POS*, %struct.POS** %8, i64 %i.0644674
...
blklab18:                                         ; preds = %polly.split_new_and_old, %conflict.exit
  ...
  %add231 = add nuw nsw i64 %i.0644674, 1
  %cmp193 = icmp slt i64 %add231, %n
  %15 = icmp eq i64 %_28.0.ph.merge, 1
  br i1 %cmp193, label %polly.split_new_and_old, label %blklab12

blklab12:                                         ; preds = %blklab18
  br i1 %15, label %if.end238, label %blklab22

if.end238:                                        ; preds = %if.end185.preheader, %blklab12
  %call239 = tail call noalias i8* @malloc(i64 16) #6
  %c = getelementptr inbounds i8, i8* %call239, i64 8
  %16 = bitcast i8* %c to i64*
  store i64 %col.0648, i64* %16, align 8, !tbaa !9
  %r = bitcast i8* %call239 to i64*
  store i64 %n, i64* %r, align 8, !tbaa !7
  %17 = load %struct.POS**, %struct.POS*** %queens651, align 8, !tbaa !12
  %arrayidx241 = getelementptr inbounds %struct.POS*, %struct.POS** %17, i64 %n
  %18 = bitcast %struct.POS** %arrayidx241 to i8**
  %19 = load i8*, i8** %18, align 8, !tbaa !5
  tail call void @free(i8* %19) #6
  %20 = load %struct.POS**, %struct.POS*** %queens651, align 8, !tbaa !12
  %arrayidx243 = getelementptr inbounds %struct.POS*, %struct.POS** %20, i64 %n
  store %struct.POS* null, %struct.POS** %arrayidx243, align 8, !tbaa !5
  %21 = load %struct.POS**, %struct.POS*** %queens651, align 8, !tbaa !12
  %arrayidx245 = getelementptr inbounds %struct.POS*, %struct.POS** %21, i64 %n
  %22 = bitcast %struct.POS** %arrayidx245 to i8**
  store i8* %call239, i8** %22, align 8, !tbaa !5
  %call250 = tail call %struct.NQueen* @run(%struct.NQueen* %nq.pn, i1 zeroext undef, i64 %add246, i64 %dim)
  br label %blklab22

blklab22:                                         ; preds = %blklab12, %if.end238
  %nq.addr.1 = phi %struct.NQueen* [ %nq.pn, %blklab12 ], [ %call250, %if.end238 ]
  %add256 = add nuw nsw i64 %col.0648, 1
...
entry:
  ...
  br i1 %cmp, label %if.end222.critedge, label %if.end8
...
if.end8:                                          ; preds = %entry
  ...
  %cmp26376 = icmp sgt i64 %1, 0
  br i1 %cmp26376, label %for.body29.preheader, label %if.then173
...
for.body29:                                       ; preds = %for.body29.preheader, %for.body29
  ...
  br i1 %exitcond, label %if.then173.loopexit, label %for.body29

if.then173.loopexit:                              ; preds = %for.body29
  br label %if.then173

if.then173:                                       ; preds = %if.then173.loopexit, %if.end8
  %call.i379 = tail call noalias i8* @malloc(i64 24) #6
  %4 = bitcast i8* %call.i379 to %struct.NQueen*
  %num_solutions1.i = getelementptr inbounds i8, i8* %call.i379, i64 16
  %5 = bitcast i8* %num_solutions1.i to i64*
  store i64 0, i64* %5, align 8, !tbaa !13
  %queens_size2.i = getelementptr inbounds i8, i8* %call.i379, i64 8
  %6 = bitcast i8* %queens_size2.i to i64*
  store i64 %1, i64* %6, align 8, !tbaa !10
  %7 = bitcast i8* %call.i379 to i8**
  store i8* %call22, i8** %7, align 8, !tbaa !12
  %call68 = tail call %struct.NQueen* @run(%struct.NQueen* %4, i1 zeroext undef, i64 0, i64 %1)
  %call78 = tail call i64* @create1DArray(i32 0, i32 33) #6
  %8 = bitcast i64* %call78 to <2 x i64>*
  store <2 x i64> <i64 78, i64 45>, <2 x i64>* %8, align 8, !tbaa !1
  %arrayidx81 = getelementptr inbounds i64, i64* %call78, i64 2
  %9 = bitcast i64* %arrayidx81 to <2 x i64>*
  store <2 x i64> <i64 81, i64 117>, <2 x i64>* %9, align 8, !tbaa !1
  %arrayidx83 = getelementptr inbounds i64, i64* %call78, i64 4
  %10 = bitcast i64* %arrayidx83 to <2 x i64>*
  store <2 x i64> <i64 101, i64 101>, <2 x i64>* %10, align 8, !tbaa !1
  %arrayidx85 = getelementptr inbounds i64, i64* %call78, i64 6
  %11 = bitcast i64* %arrayidx85 to <2 x i64>*
  store <2 x i64> <i64 110, i64 32>, <2 x i64>* %11, align 8, !tbaa !1
  %arrayidx87 = getelementptr inbounds i64, i64* %call78, i64 8
  %12 = bitcast i64* %arrayidx87 to <2 x i64>*
  store <2 x i64> <i64 80, i64 114>, <2 x i64>* %12, align 8, !tbaa !1
  %arrayidx89 = getelementptr inbounds i64, i64* %call78, i64 10
  %13 = bitcast i64* %arrayidx89 to <2 x i64>*
  store <2 x i64> <i64 111, i64 98>, <2 x i64>* %13, align 8, !tbaa !1
  %arrayidx91 = getelementptr inbounds i64, i64* %call78, i64 12
  %14 = bitcast i64* %arrayidx91 to <2 x i64>*
  store <2 x i64> <i64 108, i64 101>, <2 x i64>* %14, align 8, !tbaa !1
  %arrayidx93 = getelementptr inbounds i64, i64* %call78, i64 14
  %15 = bitcast i64* %arrayidx93 to <2 x i64>*
  store <2 x i64> <i64 109, i64 32>, <2 x i64>* %15, align 8, !tbaa !1
  %arrayidx95 = getelementptr inbounds i64, i64* %call78, i64 16
  %16 = bitcast i64* %arrayidx95 to <2 x i64>*
  store <2 x i64> <i64 111, i64 110>, <2 x i64>* %16, align 8, !tbaa !1
  %arrayidx97 = getelementptr inbounds i64, i64* %call78, i64 18
  %17 = bitcast i64* %arrayidx97 to <2 x i64>*
  store <2 x i64> <i64 32, i64 97>, <2 x i64>* %17, align 8, !tbaa !1
  %arrayidx99 = getelementptr inbounds i64, i64* %call78, i64 20
  %18 = bitcast i64* %arrayidx99 to <2 x i64>*
  store <2 x i64> <i64 32, i64 78>, <2 x i64>* %18, align 8, !tbaa !1
  %arrayidx101 = getelementptr inbounds i64, i64* %call78, i64 22
  %19 = bitcast i64* %arrayidx101 to <2 x i64>*
  store <2 x i64> <i64 32, i64 88>, <2 x i64>* %19, align 8, !tbaa !1
  %arrayidx103 = getelementptr inbounds i64, i64* %call78, i64 24
  %20 = bitcast i64* %arrayidx103 to <2 x i64>*
  store <2 x i64> <i64 32, i64 78>, <2 x i64>* %20, align 8, !tbaa !1
  %arrayidx105 = getelementptr inbounds i64, i64* %call78, i64 26
  %21 = bitcast i64* %arrayidx105 to <2 x i64>*
  store <2 x i64> <i64 32, i64 66>, <2 x i64>* %21, align 8, !tbaa !1
  %arrayidx107 = getelementptr inbounds i64, i64* %call78, i64 28
  %22 = bitcast i64* %arrayidx107 to <2 x i64>*
  store <2 x i64> <i64 111, i64 97>, <2 x i64>* %22, align 8, !tbaa !1
  %arrayidx109 = getelementptr inbounds i64, i64* %call78, i64 30
  %23 = bitcast i64* %arrayidx109 to <2 x i64>*
  store <2 x i64> <i64 114, i64 100>, <2 x i64>* %23, align 8, !tbaa !1
  %arrayidx111 = getelementptr inbounds i64, i64* %call78, i64 32
  store i64 46, i64* %arrayidx111, align 8, !tbaa !1
  tail call void @println_s(i64* %call78, i64 33) #6
  %call116 = tail call i64* @create1DArray(i32 0, i32 4) #6
  %24 = bitcast i64* %call116 to <2 x i64>*
  store <2 x i64> <i64 78, i64 32>, <2 x i64>* %24, align 8, !tbaa !1
  %arrayidx119 = getelementptr inbounds i64, i64* %call116, i64 2
  %25 = bitcast i64* %arrayidx119 to <2 x i64>*
  store <2 x i64> <i64 61, i64 32>, <2 x i64>* %25, align 8, !tbaa !1
  tail call void @printf_s(i64* %call116, i64 4) #6
  %call121 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i64 0, i64 0), i64 %1)
  %call126 = tail call i64* @create1DArray(i32 0, i32 6) #6
  %26 = bitcast i64* %call126 to <2 x i64>*
  store <2 x i64> <i64 70, i64 111>, <2 x i64>* %26, align 8, !tbaa !1
  %arrayidx129 = getelementptr inbounds i64, i64* %call126, i64 2
  %27 = bitcast i64* %arrayidx129 to <2 x i64>*
  store <2 x i64> <i64 117, i64 110>, <2 x i64>* %27, align 8, !tbaa !1
  %arrayidx131 = getelementptr inbounds i64, i64* %call126, i64 4
  %28 = bitcast i64* %arrayidx131 to <2 x i64>*
  store <2 x i64> <i64 100, i64 32>, <2 x i64>* %28, align 8, !tbaa !1
  tail call void @printf_s(i64* %call126, i64 6) #6
  %num_solutions133 = getelementptr inbounds %struct.NQueen, %struct.NQueen* %call68, i64 0, i32 2
  %29 = load i64, i64* %num_solutions133, align 8, !tbaa !13
  %call134 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i64 %29)
  %call139 = tail call i64* @create1DArray(i32 0, i32 11) #6
  %30 = bitcast i64* %call139 to <2 x i64>*
  store <2 x i64> <i64 32, i64 115>, <2 x i64>* %30, align 8, !tbaa !1
  %arrayidx142 = getelementptr inbounds i64, i64* %call139, i64 2
  %31 = bitcast i64* %arrayidx142 to <2 x i64>*
  store <2 x i64> <i64 111, i64 108>, <2 x i64>* %31, align 8, !tbaa !1
  %arrayidx144 = getelementptr inbounds i64, i64* %call139, i64 4
  %32 = bitcast i64* %arrayidx144 to <2 x i64>*
  store <2 x i64> <i64 117, i64 116>, <2 x i64>* %32, align 8, !tbaa !1
  %arrayidx146 = getelementptr inbounds i64, i64* %call139, i64 6
  %33 = bitcast i64* %arrayidx146 to <2 x i64>*
  store <2 x i64> <i64 105, i64 111>, <2 x i64>* %33, align 8, !tbaa !1
  %arrayidx148 = getelementptr inbounds i64, i64* %call139, i64 8
  %34 = bitcast i64* %arrayidx148 to <2 x i64>*
  store <2 x i64> <i64 110, i64 115>, <2 x i64>* %34, align 8, !tbaa !1
  %arrayidx150 = getelementptr inbounds i64, i64* %call139, i64 10
  store i64 46, i64* %arrayidx150, align 8, !tbaa !1
  tail call void @println_s(i64* %call139, i64 11) #6
  %phitmp = bitcast i64* %call139 to i8*
  %phitmp367 = bitcast i64* %call126 to i8*
  %phitmp368 = bitcast i64* %call116 to i8*
  %phitmp369 = bitcast i64* %call78 to i8*
  %35 = bitcast i64* %call1 to i8*
  tail call void @free(i8* %35) #6
  %queens_size.i = getelementptr inbounds %struct.NQueen, %struct.NQueen* %call68, i64 0, i32 1
  %36 = load i64, i64* %queens_size.i, align 8, !tbaa !10
  %cmp16.i = icmp sgt i64 %36, 0
  %queens.i = getelementptr inbounds %struct.NQueen, %struct.NQueen* %call68, i64 0, i32 0
  br i1 %cmp16.i, label %for.body.i.preheader, label %free_NQueen.exit

for.body.i.preheader:                             ; preds = %if.then173
  br label %for.body.i
...
free_NQueen.exit:                                 ; preds = %free_NQueen.exit.loopexit, %if.then173
  %42 = bitcast %struct.NQueen* %call68 to i8**
  %43 = load i8*, i8** %42, align 8, !tbaa !12
  tail call void @free(i8* %43) #6
  %44 = bitcast %struct.NQueen* %call68 to i8*
  tail call void @free(i8* %44) #6
  tail call void @free2DArray(i64** %call, i64 %conv) #6
  tail call void @free(i8* %phitmp369) #6
  tail call void @free(i8* %phitmp368) #6
  tail call void @free(i8* %phitmp367) #6
  tail call void @free(i8* %phitmp) #6
  br label %if.end222

if.end222.critedge:                               ; preds = %entry
  tail call void @free2DArray(i64** %call, i64 %conv) #6
  br label %if.end222

if.end222:                                        ; preds = %if.end222.critedge, %free_NQueen.exit
