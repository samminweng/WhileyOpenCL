...
int main(int argc, char** args){
	...
	{
		_DEALLOC(_10);
		_10 = appendArray(_1DARRAY_PARAM(data), false, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_10));
		_RETAIN_DEALLOC(data, "false-false-false" , "appendArray");
		_ADD_DEALLOC(_10);
	}
	//assign %4 = %10  : int[]
	_DEALLOC(arr);
	_UPDATE_1DARRAY(arr, _10);
	_TRANSFER_DEALLOC(arr, _10);
