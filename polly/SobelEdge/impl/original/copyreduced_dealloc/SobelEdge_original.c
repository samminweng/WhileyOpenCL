...
int main(int argc, char** args){
	...
	//assign %6 = %22  : int[]
	_DEALLOC(pixels);
	_UPDATE_1DARRAY(pixels, _22);
	_TRANSFER_DEALLOC(pixels, _22);
	//const %23 = 0 : int
	_23 = 0;
	//const %24 = 0 : int
	_24 = 0;
	...
	//assign %7 = %26  : int[]
	_DEALLOC(newPixels);
	_UPDATE_1DARRAY(newPixels, _26);
	_TRANSFER_DEALLOC(newPixels, _26);
	//const %27 = 1 : int
	_27 = 1;
	//neg %28 = %27 : int
	_28= -_27;
	...
	//assign %8 = %39  : int[]
	_DEALLOC(v_sobel);
	_UPDATE_1DARRAY(v_sobel, _39);
	_TRANSFER_DEALLOC(v_sobel, _39);
	//const %40 = 1 : int
	_40 = 1;
	//const %41 = 2 : int
	_41 = 2;
	...
	//assign %9 = %52  : int[]
	_DEALLOC(h_sobel);
	_UPDATE_1DARRAY(h_sobel, _52);
	_TRANSFER_DEALLOC(h_sobel, _52);
	//const %53 = 0 : int
	_53 = 0;
	//assign %10 = %53  : int
	x = _53;
	...
	while(true){
		...
		while(true){
			...
			_57 = convolution(_1DARRAY_PARAM(pixels), !pixels_dealloc, width, height, x, y, _1DARRAY_PARAM(v_sobel), !v_sobel_dealloc);
			//assign %13 = %57  : int
			v_g = _57;
			//invoke (%58) = (%6, %3, %4, %10, %11, %9) SobelEdge_original:convolution : function(int[],int,int,int,int,int[])->(int)
			_58 = convolution(_1DARRAY_PARAM(pixels), !pixels_dealloc, width, height, x, y, _1DARRAY_PARAM(h_sobel), !h_sobel_dealloc);
			//assign %14 = %58  : int
			h_g = _58;
