...
if.end:                                           ; preds = %entry.split
  ...
  %div = sdiv i64 %add1, 2
  %call = tail call i64* @slice(i64* %items, i64 %items_size, i64 %start, i64 %div)
  %sub = sub nsw i64 %div, %start
  %call2 = tail call i64* @copy(i64* %call, i64 %sub)
  %call3 = tail call i64* @copy(i64* %call2, i64 %sub)
  %call4 = tail call i64* @sortV1(i64* %call3, i64 %sub, i64 0, i64 %div)
  %call5 = tail call i64* @copy(i64* %call4, i64 %sub)
  %call6 = tail call i64* @slice(i64* %items, i64 %items_size, i64 %div, i64 %end)
  %sub7 = sub nsw i64 %end, %div
  %call8 = tail call i64* @copy(i64* %call6, i64 %sub7)
  %sub9 = sub nsw i64 %end, %div
  %call10 = tail call i64* @copy(i64* %call8, i64 %sub7)
  %call11 = tail call i64* @sortV1(i64* %call10, i64 %sub7, i64 0, i64 %sub9)
  %call12 = tail call i64* @copy(i64* %call11, i64 %sub7)
  %sub13 = sub nsw i64 %end, %start
  %cmp148 = icmp sgt i64 %sub13, 0
  %sub17 = sub nsw i64 %div, %start
  %cmp189 = icmp sgt i64 %sub17, 0
  %or.cond10 = and i1 %cmp148, %cmp189
  %sub21 = sub nsw i64 %end, %div
  %cmp2211 = icmp sgt i64 %sub21, 0
  %or.cond112 = and i1 %cmp2211, %or.cond10
  br i1 %or.cond112, label %if.end24.lr.ph, label %while.body36.preheader

if.end24.lr.ph:                                   ; preds = %if.end
  br label %if.end24

while.body.while.body36.preheader_crit_edge:      ; preds = %blklab2
  %add35.lcssa = phi i64 [ %add35, %blklab2 ]
  %l.1.lcssa = phi i64 [ %l.1, %blklab2 ]
  %r.1.lcssa = phi i64 [ %r.1, %blklab2 ]
  br label %while.body36.preheader

while.body36.preheader:                           ; preds = %while.body.while.body36.preheader_crit_edge, %if.end
  %l.0.lcssa = phi i64 [ %l.1.lcssa, %while.body.while.body36.preheader_crit_edge ], [ 0, %if.end ]
  %r.0.lcssa = phi i64 [ %r.1.lcssa, %while.body.while.body36.preheader_crit_edge ], [ 0, %if.end ]
  %i.0.lcssa = phi i64 [ %add35.lcssa, %while.body.while.body36.preheader_crit_edge ], [ 0, %if.end ]
  %sub37 = sub nsw i64 %div, %start
  %cmp385 = icmp slt i64 %l.0.lcssa, %sub37
  br i1 %cmp385, label %if.end40.lr.ph, label %while.body45.preheader

if.end40.lr.ph:                                   ; preds = %while.body36.preheader
  %0 = add i64 %i.0.lcssa, %div
  %1 = sub i64 %0, %l.0.lcssa
  %2 = sub i64 %div, %start
  br label %if.end40

if.end24:                                         ; preds = %if.end24.lr.ph, %blklab2
  %l.015 = phi i64 [ 0, %if.end24.lr.ph ], [ %l.1, %blklab2 ]
  %r.014 = phi i64 [ 0, %if.end24.lr.ph ], [ %r.1, %blklab2 ]
  %i.013 = phi i64 [ 0, %if.end24.lr.ph ], [ %add35, %blklab2 ]
  %arrayidx = getelementptr inbounds i64, i64* %call5, i64 %l.015
  %3 = load i64, i64* %arrayidx, align 8
  %arrayidx25 = getelementptr inbounds i64, i64* %call12, i64 %r.014
  %4 = load i64, i64* %arrayidx25, align 8
  %cmp26 = icmp sgt i64 %3, %4
  br i1 %cmp26, label %blklab3, label %if.end28

if.end28:                                         ; preds = %if.end24
  %arrayidx29 = getelementptr inbounds i64, i64* %call5, i64 %l.015
  %5 = load i64, i64* %arrayidx29, align 8
  %arrayidx30 = getelementptr inbounds i64, i64* %items, i64 %i.013
  store i64 %5, i64* %arrayidx30, align 8
  %add31 = add nsw i64 %l.015, 1
  br label %blklab2

blklab3:                                          ; preds = %if.end24
  %arrayidx32 = getelementptr inbounds i64, i64* %call12, i64 %r.014
  %6 = load i64, i64* %arrayidx32, align 8
  %arrayidx33 = getelementptr inbounds i64, i64* %items, i64 %i.013
  store i64 %6, i64* %arrayidx33, align 8
  %add34 = add nsw i64 %r.014, 1
  br label %blklab2

blklab2:                                          ; preds = %if.end28, %blklab3
  %r.1 = phi i64 [ %add34, %blklab3 ], [ %r.014, %if.end28 ]
  %l.1 = phi i64 [ %l.015, %blklab3 ], [ %add31, %if.end28 ]
  %add35 = add nuw nsw i64 %i.013, 1
  %cmp14 = icmp slt i64 %add35, %sub13
  %cmp18 = icmp slt i64 %l.1, %sub17
  %or.cond = and i1 %cmp14, %cmp18
  %cmp22 = icmp slt i64 %r.1, %sub21
  %or.cond1 = and i1 %cmp22, %or.cond
  br i1 %or.cond1, label %if.end24, label %while.body.while.body36.preheader_crit_edge

while.body36.while.body45.preheader_crit_edge:    ; preds = %if.end40
  %7 = sub i64 %1, %start
  br label %while.body45.preheader

while.body45.preheader:                           ; preds = %while.body36.while.body45.preheader_crit_edge, %while.body36.preheader
  %i.1.lcssa = phi i64 [ %7, %while.body36.while.body45.preheader_crit_edge ], [ %i.0.lcssa, %while.body36.preheader ]
  %sub46 = sub nsw i64 %end, %div
  %cmp472 = icmp slt i64 %r.0.lcssa, %sub46
  br i1 %cmp472, label %if.end49.lr.ph, label %blklab0.loopexit

if.end49.lr.ph:                                   ; preds = %while.body45.preheader
  %8 = sub i64 %end, %div
  br label %if.end49

if.end40:                                         ; preds = %if.end40.lr.ph, %if.end40
  %l.27 = phi i64 [ %l.0.lcssa, %if.end40.lr.ph ], [ %add44, %if.end40 ]
  %i.16 = phi i64 [ %i.0.lcssa, %if.end40.lr.ph ], [ %add43, %if.end40 ]
  %arrayidx41 = getelementptr inbounds i64, i64* %call5, i64 %l.27
  %9 = load i64, i64* %arrayidx41, align 8
  %arrayidx42 = getelementptr inbounds i64, i64* %items, i64 %i.16
  store i64 %9, i64* %arrayidx42, align 8
  %add44 = add nsw i64 %l.27, 1
  %add43 = add nsw i64 %i.16, 1
  %exitcond19 = icmp ne i64 %add44, %2
  br i1 %exitcond19, label %if.end40, label %while.body36.while.body45.preheader_crit_edge

if.end49:                                         ; preds = %if.end49.lr.ph, %if.end49
  %r.24 = phi i64 [ %r.0.lcssa, %if.end49.lr.ph ], [ %add53, %if.end49 ]
  %i.23 = phi i64 [ %i.1.lcssa, %if.end49.lr.ph ], [ %add52, %if.end49 ]
  %arrayidx50 = getelementptr inbounds i64, i64* %call12, i64 %r.24
  %10 = load i64, i64* %arrayidx50, align 8
  %arrayidx51 = getelementptr inbounds i64, i64* %items, i64 %i.23
  store i64 %10, i64* %arrayidx51, align 8
  %add53 = add nsw i64 %r.24, 1
  %add52 = add nsw i64 %i.23, 1
  %exitcond = icmp ne i64 %add53, %8
  br i1 %exitcond, label %if.end49, label %while.body45.blklab0.loopexit_crit_edge

while.body45.blklab0.loopexit_crit_edge:          ; preds = %if.end49
  br label %blklab0.loopexit

blklab0.loopexit:                                 ; preds = %while.body45.blklab0.loopexit_crit_edge, %while.body45.preheader
  br label %blklab0

blklab0:                                          ; preds = %blklab0.loopexit, %entry.split
  ret i64* %items
}
...
if.end:                                           ; preds = %entry.split
  ...
  br i1 %cmp71, label %blklab10, label %if.end10.lr.ph
...
if.end10:                                         ; preds = %if.end10, %if.end10.lr.ph
  ...
  br i1 %exitcond, label %if.end10, label %while.body.blklab10_crit_edge

while.body.blklab10_crit_edge:                    ; preds = %if.end10
  br label %blklab10

blklab10:                                         ; preds = %while.body.blklab10_crit_edge, %if.end
  %add14 = add nsw i64 %call1, 1
  %call15 = tail call i64* @copy(i64* %call6, i64 %add)
  %call16 = tail call i64* @sortV1(i64* %call15, i64 %add, i64 0, i64 %add14)
  %call17 = tail call i64* @copy(i64* %call16, i64 %add)
  %2 = load i64, i64* %call17, align 8
  %cmp19 = icmp eq i64 %2, 0
  br i1 %cmp19, label %blklab12, label %if.end22
...
blklab12:                                         ; preds = %blklab10
  %arrayidx24 = getelementptr inbounds i64, i64* %call17, i64 %call1
  %5 = load i64, i64* %arrayidx24, align 8
  %cmp25 = icmp eq i64 %5, %call1
  br i1 %cmp25, label %blklab13, label %if.end28
...
blklab13:                                         ; preds = %blklab12
  %call30 = tail call noalias i8* @malloc(i64 304) #6
  %8 = bitcast i8* %call30 to i64*
  store i64 80, i64* %8, align 8
  %arrayidx32 = getelementptr inbounds i8, i8* %call30, i64 8
  %9 = bitcast i8* %arrayidx32 to i64*
  store i64 97, i64* %9, align 8
  %arrayidx33 = getelementptr inbounds i8, i8* %call30, i64 16
  %10 = bitcast i8* %arrayidx33 to i64*
  store i64 115, i64* %10, align 8
  %arrayidx34 = getelementptr inbounds i8, i8* %call30, i64 24
  %11 = bitcast i8* %arrayidx34 to i64*
  store i64 115, i64* %11, align 8
  %arrayidx35 = getelementptr inbounds i8, i8* %call30, i64 32
  %12 = bitcast i8* %arrayidx35 to i64*
  store i64 32, i64* %12, align 8
  %arrayidx36 = getelementptr inbounds i8, i8* %call30, i64 40
  %13 = bitcast i8* %arrayidx36 to i64*
  store i64 77, i64* %13, align 8
  %arrayidx37 = getelementptr inbounds i8, i8* %call30, i64 48
  %14 = bitcast i8* %arrayidx37 to i64*
  store i64 101, i64* %14, align 8
  %arrayidx38 = getelementptr inbounds i8, i8* %call30, i64 56
  %15 = bitcast i8* %arrayidx38 to i64*
  store i64 114, i64* %15, align 8
  %arrayidx39 = getelementptr inbounds i8, i8* %call30, i64 64
  %16 = bitcast i8* %arrayidx39 to i64*
  store i64 103, i64* %16, align 8
  %arrayidx40 = getelementptr inbounds i8, i8* %call30, i64 72
  %17 = bitcast i8* %arrayidx40 to i64*
  store i64 101, i64* %17, align 8
  %arrayidx41 = getelementptr inbounds i8, i8* %call30, i64 80
  %18 = bitcast i8* %arrayidx41 to i64*
  store i64 83, i64* %18, align 8
  %arrayidx42 = getelementptr inbounds i8, i8* %call30, i64 88
  %19 = bitcast i8* %arrayidx42 to i64*
  store i64 111, i64* %19, align 8
  %arrayidx43 = getelementptr inbounds i8, i8* %call30, i64 96
  %20 = bitcast i8* %arrayidx43 to i64*
  store i64 114, i64* %20, align 8
  %arrayidx44 = getelementptr inbounds i8, i8* %call30, i64 104
  %21 = bitcast i8* %arrayidx44 to i64*
  store i64 116, i64* %21, align 8
  %arrayidx45 = getelementptr inbounds i8, i8* %call30, i64 112
  %22 = bitcast i8* %arrayidx45 to i64*
  store i64 32, i64* %22, align 8
  %arrayidx46 = getelementptr inbounds i8, i8* %call30, i64 120
  %23 = bitcast i8* %arrayidx46 to i64*
  store i64 116, i64* %23, align 8
  %arrayidx47 = getelementptr inbounds i8, i8* %call30, i64 128
  %24 = bitcast i8* %arrayidx47 to i64*
  store i64 101, i64* %24, align 8
  %arrayidx48 = getelementptr inbounds i8, i8* %call30, i64 136
  %25 = bitcast i8* %arrayidx48 to i64*
  store i64 115, i64* %25, align 8
  %arrayidx49 = getelementptr inbounds i8, i8* %call30, i64 144
  %26 = bitcast i8* %arrayidx49 to i64*
  store i64 116, i64* %26, align 8
  %arrayidx50 = getelementptr inbounds i8, i8* %call30, i64 152
  %27 = bitcast i8* %arrayidx50 to i64*
  store i64 32, i64* %27, align 8
  %arrayidx51 = getelementptr inbounds i8, i8* %call30, i64 160
  %28 = bitcast i8* %arrayidx51 to i64*
  store i64 99, i64* %28, align 8
  %arrayidx52 = getelementptr inbounds i8, i8* %call30, i64 168
  %29 = bitcast i8* %arrayidx52 to i64*
  store i64 97, i64* %29, align 8
  %arrayidx53 = getelementptr inbounds i8, i8* %call30, i64 176
  %30 = bitcast i8* %arrayidx53 to i64*
  store i64 115, i64* %30, align 8
  %arrayidx54 = getelementptr inbounds i8, i8* %call30, i64 184
  %31 = bitcast i8* %arrayidx54 to i64*
  store i64 101, i64* %31, align 8
  %arrayidx55 = getelementptr inbounds i8, i8* %call30, i64 192
  %32 = bitcast i8* %arrayidx55 to i64*
  store i64 32, i64* %32, align 8
  %arrayidx56 = getelementptr inbounds i8, i8* %call30, i64 200
  %33 = bitcast i8* %arrayidx56 to i64*
  store i64 119, i64* %33, align 8
  %arrayidx57 = getelementptr inbounds i8, i8* %call30, i64 208
  %34 = bitcast i8* %arrayidx57 to i64*
  store i64 105, i64* %34, align 8
  %arrayidx58 = getelementptr inbounds i8, i8* %call30, i64 216
  %35 = bitcast i8* %arrayidx58 to i64*
  store i64 116, i64* %35, align 8
  %arrayidx59 = getelementptr inbounds i8, i8* %call30, i64 224
  %36 = bitcast i8* %arrayidx59 to i64*
  store i64 104, i64* %36, align 8
  %arrayidx60 = getelementptr inbounds i8, i8* %call30, i64 232
  %37 = bitcast i8* %arrayidx60 to i64*
  store i64 32, i64* %37, align 8
  %arrayidx61 = getelementptr inbounds i8, i8* %call30, i64 240
  %38 = bitcast i8* %arrayidx61 to i64*
  store i64 105, i64* %38, align 8
  %arrayidx62 = getelementptr inbounds i8, i8* %call30, i64 248
  %39 = bitcast i8* %arrayidx62 to i64*
  store i64 110, i64* %39, align 8
  %arrayidx63 = getelementptr inbounds i8, i8* %call30, i64 256
  %40 = bitcast i8* %arrayidx63 to i64*
  store i64 112, i64* %40, align 8
  %arrayidx64 = getelementptr inbounds i8, i8* %call30, i64 264
  %41 = bitcast i8* %arrayidx64 to i64*
  store i64 117, i64* %41, align 8
  %arrayidx65 = getelementptr inbounds i8, i8* %call30, i64 272
  %42 = bitcast i8* %arrayidx65 to i64*
  store i64 116, i64* %42, align 8
  %arrayidx66 = getelementptr inbounds i8, i8* %call30, i64 280
  %43 = bitcast i8* %arrayidx66 to i64*
  store i64 32, i64* %43, align 8
  %arrayidx67 = getelementptr inbounds i8, i8* %call30, i64 288
  %44 = bitcast i8* %arrayidx67 to i64*
  store i64 61, i64* %44, align 8
  %arrayidx68 = getelementptr inbounds i8, i8* %call30, i64 296
  %45 = bitcast i8* %arrayidx68 to i64*
  store i64 32, i64* %45, align 8
  tail call void @printf_s(i64* %8, i64 38)
  %call69 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.21, i64 0, i64 0), i64 %call1) #6
  br label %blklab9

blklab9:                                          ; preds = %entry.split, %blklab13
