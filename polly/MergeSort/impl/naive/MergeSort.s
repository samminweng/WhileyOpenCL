...
if.end22:                                         ; preds = %blklab10
  ...
  %call23 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %45, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.20, i32 0, i32 0))
...
if.end28:                                         ; preds = %blklab12
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %51, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.20, i32 0, i32 0))
  call void @exit(i32 -1) #7
  unreachable

blklab13:                                         ; preds = %if.then27
  store i64 38, i64* %_26_size, align 8
  %call30 = call noalias i8* @malloc(i64 304) #6
  ...
  %call69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.21, i32 0, i32 0), i64 %93)
  br label %blklab9
