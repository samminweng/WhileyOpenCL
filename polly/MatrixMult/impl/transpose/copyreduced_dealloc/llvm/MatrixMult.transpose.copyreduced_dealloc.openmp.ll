...
entry:
  %polly.par.userContext398 = alloca { i64, i64, i64*, i64* }, align 8
  ...
  %cmp278 = icmp sgt i64 %1, 0
  br i1 %cmp278, label %polly.split_new_and_old348, label %entry.polly.split_new_and_old_crit_edge

entry.polly.split_new_and_old_crit_edge:          ; preds = %entry
  %.pre428 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %1, i64 1)
  %.pre429 = extractvalue { i64, i1 } %.pre428, 1
  %.pre430 = extractvalue { i64, i1 } %.pre428, 0
  %.pre431 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %.pre430, i64 %0)
  %.pre432 = extractvalue { i64, i1 } %.pre431, 1
  %.pre433 = or i1 %.pre429, %.pre432
  %.pre434 = extractvalue { i64, i1 } %.pre431, 0
  %.pre435 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %.pre434, i64 %0)
  %.pre436 = extractvalue { i64, i1 } %.pre435, 1
  %.pre437 = extractvalue { i64, i1 } %.pre435, 0
  %.pre438 = or i1 %.pre433, %.pre436
  br label %polly.split_new_and_old

polly.split_new_and_old348:                       ; preds = %entry
  %4 = icmp sge i64 %0, %1
  %5 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %1, i64 1)
  %.obit352 = extractvalue { i64, i1 } %5, 1
  %.res354 = extractvalue { i64, i1 } %5, 0
  %polly.access.mul.355 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %.res354, i64 %0)
  %polly.access.mul..obit356 = extractvalue { i64, i1 } %polly.access.mul.355, 1
  %polly.overflow.state357 = or i1 %.obit352, %polly.access.mul..obit356
  %polly.access.mul..res358 = extractvalue { i64, i1 } %polly.access.mul.355, 0
  %polly.access.add.359 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %polly.access.mul..res358, i64 %0)
  %polly.access.add..obit360 = extractvalue { i64, i1 } %polly.access.add.359, 1
  %polly.access.add..res362 = extractvalue { i64, i1 } %polly.access.add.359, 0
  %polly.access.363 = getelementptr i64, i64* %3, i64 %polly.access.add..res362
  %polly.overflow.state370 = or i1 %polly.overflow.state357, %polly.access.add..obit360
  %6 = icmp ule i64* %polly.access.363, %call36
  %7 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %0, i64 1)
  %.obit373 = extractvalue { i64, i1 } %7, 1
  %polly.overflow.state374 = or i1 %.obit373, %polly.overflow.state370
  %.res375 = extractvalue { i64, i1 } %7, 0
  %polly.access.mul.call36376 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %.res375, i64 %0)
  %polly.access.mul.call36.obit377 = extractvalue { i64, i1 } %polly.access.mul.call36376, 1
  %polly.overflow.state378 = or i1 %polly.access.mul.call36.obit377, %polly.overflow.state374
  %polly.access.mul.call36.res379 = extractvalue { i64, i1 } %polly.access.mul.call36376, 0
  %polly.access.add.call36380 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %polly.access.mul.call36.res379, i64 %1)
  %polly.access.add.call36.obit381 = extractvalue { i64, i1 } %polly.access.add.call36380, 1
  %polly.access.add.call36.res383 = extractvalue { i64, i1 } %polly.access.add.call36380, 0
  %polly.access.call36384 = getelementptr i64, i64* %call36, i64 %polly.access.add.call36.res383
  %polly.overflow.state391 = or i1 %polly.access.add.call36.obit381, %polly.overflow.state378
  %8 = icmp ule i64* %polly.access.call36384, %3
  %9 = or i1 %8, %6
  %10 = and i1 %4, %9
  %polly.rtc.overflown394 = xor i1 %polly.overflow.state391, true
  %polly.rtc.result395 = and i1 %10, %polly.rtc.overflown394
  br i1 %polly.rtc.result395, label %polly.parallel.for396, label %while.cond45.preheader.preheader

while.cond45.preheader.preheader:                 ; preds = %polly.split_new_and_old348
  %cmp47276 = icmp sgt i64 %0, 0
  br i1 %cmp47276, label %while.cond45.preheader.us.preheader, label %polly.split_new_and_old
...
while.cond45.preheader.us:                        ; preds = %while.cond45.preheader.us.preheader, %blklab15.loopexit.us
  %i.0279.us = phi i64 [ %add56.us, %blklab15.loopexit.us ], [ 0, %while.cond45.preheader.us.preheader ]
  %mul51.us = mul nsw i64 %i.0279.us, %0
...
if.end50.us.preheader:                            ; preds = %min.iters.checked, %vector.body, %vector.memcheck, %while.cond45.preheader.us
  %j.0277.us.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %min.iters.checked ], [ 0, %while.cond45.preheader.us ], [ %n.vec, %vector.body ]
  %12 = sub i64 %0, %j.0277.us.ph
  %13 = sub i64 %11, %j.0277.us.ph
  %xtraiter452 = and i64 %12, 3
...
if.end50.us.preheader.new:                        ; preds = %if.end50.us.preheader
  %unroll_iter454 = sub i64 %12, %xtraiter452
  br label %if.end50.us

if.end50.us:                                      ; preds = %if.end50.us, %if.end50.us.preheader.new
  %j.0277.us = phi i64 [ %j.0277.us.ph, %if.end50.us.preheader.new ], [ %add55.us.3, %if.end50.us ]
  %niter455 = phi i64 [ %unroll_iter454, %if.end50.us.preheader.new ], [ %niter455.nsub.3, %if.end50.us ]
  %add.us = add nsw i64 %j.0277.us, %mul51.us
  %arrayidx.us = getelementptr inbounds i64, i64* %3, i64 %add.us
  %15 = load i64, i64* %arrayidx.us, align 8, !tbaa !8
  %mul52.us = mul nsw i64 %j.0277.us, %0
  %add53.us = add nsw i64 %mul52.us, %i.0279.us
  %arrayidx54.us = getelementptr inbounds i64, i64* %call36, i64 %add53.us
  store i64 %15, i64* %arrayidx54.us, align 8, !tbaa !8
  %add55.us = or i64 %j.0277.us, 1
  ...
  %add53.us.3 = add nsw i64 %mul52.us.3, %i.0279.us
  %arrayidx54.us.3 = getelementptr inbounds i64, i64* %call36, i64 %add53.us.3
  store i64 %18, i64* %arrayidx54.us.3, align 8, !tbaa !8
  %add55.us.3 = add nsw i64 %j.0277.us, 4
  %niter455.nsub.3 = add i64 %niter455, -4
  %niter455.ncmp.3 = icmp eq i64 %niter455.nsub.3, 0
  br i1 %niter455.ncmp.3, label %blklab15.loopexit.us.loopexit.unr-lcssa.loopexit, label %if.end50.us, !llvm.loop !12
...
blklab15.loopexit.us.loopexit.unr-lcssa:          ; preds = %blklab15.loopexit.us.loopexit.unr-lcssa.loopexit, %if.end50.us.preheader
  %j.0277.us.unr = phi i64 [ %j.0277.us.ph, %if.end50.us.preheader ], [ %add55.us.3, %blklab15.loopexit.us.loopexit.unr-lcssa.loopexit ]
  %lcmp.mod453 = icmp eq i64 %xtraiter452, 0
  br i1 %lcmp.mod453, label %blklab15.loopexit.us.loopexit, label %if.end50.us.epil.preheader
...
if.end50.us.epil:                                 ; preds = %if.end50.us.epil, %if.end50.us.epil.preheader
  %j.0277.us.epil = phi i64 [ %add55.us.epil, %if.end50.us.epil ], [ %j.0277.us.unr, %if.end50.us.epil.preheader ]
  %epil.iter = phi i64 [ %epil.iter.sub, %if.end50.us.epil ], [ %xtraiter452, %if.end50.us.epil.preheader ]
  %add.us.epil = add nsw i64 %j.0277.us.epil, %mul51.us
  %arrayidx.us.epil = getelementptr inbounds i64, i64* %3, i64 %add.us.epil
  %19 = load i64, i64* %arrayidx.us.epil, align 8, !tbaa !8
  %mul52.us.epil = mul nsw i64 %j.0277.us.epil, %0
  %add53.us.epil = add nsw i64 %mul52.us.epil, %i.0279.us
  ...
  %add55.us.epil = add nuw nsw i64 %j.0277.us.epil, 1
...
blklab15.loopexit.us:                             ; preds = %blklab15.loopexit.us.loopexit, %vector.body
  %add56.us = add nuw nsw i64 %i.0279.us, 1
  %exitcond284.us = icmp eq i64 %add56.us, %1
  br i1 %exitcond284.us, label %polly.split_new_and_old.loopexit, label %while.cond45.preheader.us

polly.split_new_and_old.loopexit:                 ; preds = %blklab15.loopexit.us
  br label %polly.split_new_and_old

polly.split_new_and_old:                          ; preds = %polly.split_new_and_old.loopexit, %while.cond45.preheader.preheader, %entry.polly.split_new_and_old_crit_edge, %polly.parallel.for396
  %polly.overflow.state288.pre-phi = phi i1 [ %.pre438, %entry.polly.split_new_and_old_crit_edge ], [ %polly.overflow.state370, %polly.parallel.for396 ], [ %polly.overflow.state370, %while.cond45.preheader.preheader ], [ %polly.overflow.state370, %polly.split_new_and_old.loopexit ]
  %polly.access.add.call36.res.pre-phi = phi i64 [ %.pre437, %entry.polly.split_new_and_old_crit_edge ], [ %polly.access.add..res362, %polly.parallel.for396 ], [ %polly.access.add..res362, %while.cond45.preheader.preheader ], [ %polly.access.add..res362, %polly.split_new_and_old.loopexit ]
  ...
  %polly.access.call300 = getelementptr i64, i64* %call, i64 %polly.access.add.call36.res.pre-phi
  %21 = icmp ule i64* %polly.access.call300, %call36
  %22 = or i1 %20, %21
  %polly.access. = getelementptr i64, i64* %2, i64 %polly.access.add.call36.res.pre-phi
  %23 = icmp ule i64* %polly.access., %call
  %24 = icmp ule i64* %polly.access.call300, %2
  %25 = or i1 %23, %24
  %26 = and i1 %22, %25
  %polly.rtc.overflown = xor i1 %polly.overflow.state288.pre-phi, true
...
while.cond57.preheader:                           ; preds = %polly.split_new_and_old
  %cmp65270 = icmp sgt i64 %0, 0
  %or.cond = and i1 %cmp278, %cmp65270
...
while.cond63.preheader.us:                        ; preds = %while.cond63.preheader.us.preheader, %blklab19.loopexit.us-lcssa.us.us
  %i.1274.us = phi i64 [ %add91.us, %blklab19.loopexit.us-lcssa.us.us ], [ 0, %while.cond63.preheader.us.preheader ]
  %mul75.us = mul nsw i64 %i.1274.us, %0
...
while.cond69.preheader.us.us:                     ; preds = %while.cond63.preheader.us, %blklab21.loopexit.us.us
  %j.1271.us.us = phi i64 [ %add90.us.us, %blklab21.loopexit.us.us ], [ 0, %while.cond63.preheader.us ]
  %add76.us.us = add nsw i64 %j.1271.us.us, %mul75.us
...
blklab21.loopexit.us.us.unr-lcssa:                ; preds = %blklab21.loopexit.us.us.unr-lcssa.loopexit, %while.cond69.preheader.us.us
  ...
  %k.0269.us.us.unr = phi i64 [ 0, %while.cond69.preheader.us.us ], [ %add89.us.us.1, %blklab21.loopexit.us.us.unr-lcssa.loopexit ]
...
if.end74.us.us.epil:                              ; preds = %if.end74.us.us.epil.preheader
  %add79.us.us.epil = add nsw i64 %k.0269.us.us.unr, %mul75.us
...
blklab21.loopexit.us.us:                          ; preds = %blklab21.loopexit.us.us.unr-lcssa, %blklab21.loopexit.us.us.epilog-lcssa
  %add90.us.us = add nuw nsw i64 %j.1271.us.us, 1
  %exitcond281.us.us = icmp eq i64 %add90.us.us, %0
  br i1 %exitcond281.us.us, label %blklab19.loopexit.us-lcssa.us.us, label %while.cond69.preheader.us.us
...
if.end74.us.us:                                   ; preds = %if.end74.us.us, %while.cond69.preheader.us.us.new
  ...
  %k.0269.us.us = phi i64 [ 0, %while.cond69.preheader.us.us.new ], [ %add89.us.us.1, %if.end74.us.us ]
  %niter = phi i64 [ %unroll_iter, %while.cond69.preheader.us.us.new ], [ %niter.nsub.1, %if.end74.us.us ]
  %add79.us.us = add nsw i64 %k.0269.us.us, %mul75.us
  ...
  %add89.us.us = or i64 %k.0269.us.us, 1
  ...
  %add89.us.us.1 = add nsw i64 %k.0269.us.us, 2
...
blklab19.loopexit.us-lcssa.us.us:                 ; preds = %blklab21.loopexit.us.us
  %add91.us = add nuw nsw i64 %i.1274.us, 1
  %exitcond282.us = icmp eq i64 %add91.us, %1
  br i1 %exitcond282.us, label %if.end94.loopexit, label %while.cond63.preheader.us
...
if.end94:                                         ; preds = %if.end94.loopexit, %polly.parallel.for, %while.cond57.preheader
  ...
  br i1 %a_dealloc, label %if.then97, label %if.end98
...
if.end98:                                         ; preds = %if.then97, %if.end94
  br i1 %b_dealloc, label %if.then100, label %if.then115
...
if.then115:                                       ; preds = %if.end98, %if.then100
...
polly.parallel.for:                               ; preds = %polly.split_new_and_old
  ...
  %polly.subfn.storeaddr.345 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 1
  store i64 %0, i64* %polly.subfn.storeaddr.345, align 8
  ...
  store i64* %call, i64** %polly.subfn.storeaddr.call, align 8
  %polly.subfn.storeaddr.346 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 3
  store i64* %2, i64** %polly.subfn.storeaddr.346, align 8
...
polly.parallel.for396:                            ; preds = %polly.split_new_and_old348
  %49 = add nsw i64 %1, -1
  %polly.fdiv_q.shr397 = ashr i64 %49, 5
  %50 = bitcast { i64, i64, i64*, i64* }* %polly.par.userContext398 to i8*
  call void @llvm.lifetime.start(i64 32, i8* %50)
  %polly.subfn.storeaddr.399 = getelementptr inbounds { i64, i64, i64*, i64* }, { i64, i64, i64*, i64* }* %polly.par.userContext398, i64 0, i32 0
  store i64 %0, i64* %polly.subfn.storeaddr.399, align 8
  %polly.subfn.storeaddr.400 = getelementptr inbounds { i64, i64, i64*, i64* }, { i64, i64, i64*, i64* }* %polly.par.userContext398, i64 0, i32 1
  store i64 %1, i64* %polly.subfn.storeaddr.400, align 8
  %polly.subfn.storeaddr.401 = getelementptr inbounds { i64, i64, i64*, i64* }, { i64, i64, i64*, i64* }* %polly.par.userContext398, i64 0, i32 2
  store i64* %3, i64** %polly.subfn.storeaddr.401, align 8
  %polly.subfn.storeaddr.call36402 = getelementptr inbounds { i64, i64, i64*, i64* }, { i64, i64, i64*, i64* }* %polly.par.userContext398, i64 0, i32 3
  store i64* %call36, i64** %polly.subfn.storeaddr.call36402, align 8
  %51 = add nsw i64 %polly.fdiv_q.shr397, 1
