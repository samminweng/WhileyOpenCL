...
.Ltmp67:
	...
	jle	.LBB7_1
# BB#2:                                 # %polly.split_new_and_old353
	movq	%rbp, %r8
	decq	%r8
	seto	%al
	movq	%r8, %rbx
	...
	cmpq	%rbp, %r15
	jl	.LBB7_5
# BB#3:                                 # %polly.split_new_and_old353
	orb	%cl, %dl
	je	.LBB7_5
# BB#4:                                 # %polly.split_new_and_old353
	orb	%sil, %al
	orb	%dil, %al
	orb	%r12b, %al
	xorb	$1, %al
