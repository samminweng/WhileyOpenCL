...
.Ltmp93:
	...
	#DEBUG_VALUE: mat_mult:_14 <- [%RSP+16]
	setbe	%dl
	orb	%al, %dl
	movzbl	%dl, %eax
	cmpl	$1, %eax
...
.LBB5_18:                               # %polly.loop_header206
	...
	movq	%rdi, %r15
	.p2align	4, 0x90
.LBB5_19:                               # %polly.loop_header213
                                        #   Parent Loop BB5_14 Depth=1
                                        #     Parent Loop BB5_15 Depth=2
                                        #       Parent Loop BB5_16 Depth=3
                                        #         Parent Loop BB5_17 Depth=4
                                        #           Parent Loop BB5_18 Depth=5
...
.Ltmp97:
	...
	jle	.LBB5_19
.Ltmp98:
# BB#20:                                # %polly.loop_exit215
                                        #   in Loop: Header=BB5_18 Depth=5
	movq	%r10, %rbx
	movq	%rdx, (%rbx,%rbp,8)
	addq	$8, %rdi
	cmpq	%rcx, %rsi
...
# BB#21:                                # %polly.loop_exit208
	...
	leaq	1(%rsi), %rsi
	jle	.LBB5_17
# BB#22:                                # %polly.loop_exit202
                                        #   in Loop: Header=BB5_16 Depth=3
	movq	96(%rsp), %rdx          # 8-byte Reload
	incq	%rdx
	addq	$51200, 56(%rsp)        # 8-byte Folded Spill
                                        # imm = 0xC800
	movq	104(%rsp), %r12         # 8-byte Reload
	addq	$256, %r12              # imm = 0x100
	cmpq	$7, %rdx
	jne	.LBB5_16
# BB#23:                                # %polly.loop_exit196
