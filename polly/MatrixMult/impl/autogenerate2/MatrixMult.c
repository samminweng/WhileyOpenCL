...
int main(int argc, char** args){
	...
	//assert
	{
		...
		//sub %26 = %1, %25 : int
		_26=max-_25;
		//ifeq %24, %26 goto blklab24 : int
		if(_24==_26){goto blklab24;}
		//fail
		fprintf(stderr,"fail");
		exit(-1);
//.blklab24
blklab24:;
	...
	//assert
	{
		...
		//sub %36 = %1, %35 : int
		_36=max-_35;
		//ifeq %34, %36 goto blklab25 : int
		if(_34==_36){goto blklab25;}
		//fail
		fprintf(stderr,"fail");
		exit(-1);
//.blklab25
blklab25:;
	...
	//const %37 = 2000 : int
	_37 = 2000;
	//ifne %1, %37 goto blklab26 : int
	if(max!=_37){goto blklab26;}
	//assert
	{
		...
		_46 = 3996001000;
		//ifeq %45, %46 goto blklab27 : int
		if(_45==_46){goto blklab27;}
		//fail
		fprintf(stderr,"fail");
		exit(-1);
//.blklab27
