...
entry:
  ...
  %cmp197 = icmp sgt i64 %1, 0
  br i1 %cmp197, label %polly.split_new_and_old, label %if.end62
...
polly.split_new_and_old:                          ; preds = %entry
  ...
  %polly.overflow.state202 = or i1 %.obit, %polly.access.mul..obit
  ...
  %polly.overflow.state205 = or i1 %polly.overflow.state202, %polly.access.add..obit
  %5 = icmp ule i64* %polly.access., %call
  %polly.access.call217 = getelementptr i64, i64* %call, i64 %polly.access.add..res
  %6 = icmp ule i64* %polly.access.call217, %2
  %7 = or i1 %5, %6
  %8 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %0, i64 1)
  %.obit227 = extractvalue { i64, i1 } %8, 1
  %polly.overflow.state228 = or i1 %.obit227, %polly.overflow.state205
  %.res229 = extractvalue { i64, i1 } %8, 0
  %polly.access.mul.230 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %.res229, i64 %0)
  %polly.access.mul..obit231 = extractvalue { i64, i1 } %polly.access.mul.230, 1
  %polly.overflow.state232 = or i1 %polly.access.mul..obit231, %polly.overflow.state228
  %polly.access.mul..res233 = extractvalue { i64, i1 } %polly.access.mul.230, 0
  %polly.access.add.234 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %polly.access.mul..res233, i64 %0)
  %polly.access.add..obit235 = extractvalue { i64, i1 } %polly.access.add.234, 1
  %polly.access.add..res237 = extractvalue { i64, i1 } %polly.access.add.234, 0
  %polly.access.238 = getelementptr i64, i64* %3, i64 %polly.access.add..res237
  %polly.overflow.state245 = or i1 %polly.access.add..obit235, %polly.overflow.state232
  %9 = icmp ule i64* %polly.access.238, %call
  %polly.overflow.state249 = or i1 %.obit, %polly.overflow.state245
  %polly.overflow.state253 = or i1 %polly.access.mul..obit, %polly.overflow.state249
  %polly.overflow.state266 = or i1 %polly.access.add..obit, %polly.overflow.state253
  %10 = icmp ule i64* %polly.access.call217, %3
  %11 = or i1 %9, %10
  %12 = and i1 %7, %11
  %polly.rtc.overflown = xor i1 %polly.overflow.state266, true
...
while.cond33.preheader.preheader:                 ; preds = %polly.split_new_and_old
  %cmp35194 = icmp sgt i64 %0, 0
  br i1 %cmp35194, label %while.cond33.preheader.us.preheader, label %if.end62
...
while.cond33.preheader.us:                        ; preds = %while.cond33.preheader.us.preheader, %blklab15.loopexit.us-lcssa.us.us
  %i.0198.us = phi i64 [ %add59.us, %blklab15.loopexit.us-lcssa.us.us ], [ 0, %while.cond33.preheader.us.preheader ]
  %mul45.us = mul nsw i64 %i.0198.us, %0
...
while.cond39.preheader.us.us:                     ; preds = %while.cond33.preheader.us, %blklab17.loopexit.us.us
  %j.0195.us.us = phi i64 [ %add58.us.us, %blklab17.loopexit.us.us ], [ 0, %while.cond33.preheader.us ]
  %add.us.us = add nsw i64 %j.0195.us.us, %mul45.us
...
blklab17.loopexit.us.us.unr-lcssa:                ; preds = %blklab17.loopexit.us.us.unr-lcssa.loopexit, %while.cond39.preheader.us.us
  ...
  %k.0193.us.us.unr = phi i64 [ 0, %while.cond39.preheader.us.us ], [ %add57.us.us.1, %blklab17.loopexit.us.us.unr-lcssa.loopexit ]
...
if.end44.us.us.epil:                              ; preds = %if.end44.us.us.epil.preheader
  %add47.us.us.epil = add nsw i64 %k.0193.us.us.unr, %mul45.us
  ...
  %mul49.us.us.epil = mul nsw i64 %k.0193.us.us.unr, %0
  %add50.us.us.epil = add nsw i64 %mul49.us.us.epil, %j.0195.us.us
...
blklab17.loopexit.us.us:                          ; preds = %blklab17.loopexit.us.us.unr-lcssa, %blklab17.loopexit.us.us.epilog-lcssa
  %add58.us.us = add nuw nsw i64 %j.0195.us.us, 1
  %exitcond200.us.us = icmp eq i64 %add58.us.us, %0
  br i1 %exitcond200.us.us, label %blklab15.loopexit.us-lcssa.us.us, label %while.cond39.preheader.us.us
...
if.end44.us.us:                                   ; preds = %if.end44.us.us, %while.cond39.preheader.us.us.new
  ...
  %k.0193.us.us = phi i64 [ 0, %while.cond39.preheader.us.us.new ], [ %add57.us.us.1, %if.end44.us.us ]
  %niter = phi i64 [ %unroll_iter, %while.cond39.preheader.us.us.new ], [ %niter.nsub.1, %if.end44.us.us ]
  %add47.us.us = add nsw i64 %k.0193.us.us, %mul45.us
  %arrayidx48.us.us = getelementptr inbounds i64, i64* %2, i64 %add47.us.us
  %17 = load i64, i64* %arrayidx48.us.us, align 8, !tbaa !8
  %mul49.us.us = mul nsw i64 %k.0193.us.us, %0
  %add50.us.us = add nsw i64 %mul49.us.us, %j.0195.us.us
  ...
  %add57.us.us = or i64 %k.0193.us.us, 1
  ...
  %add50.us.us.1 = add nsw i64 %mul49.us.us.1, %j.0195.us.us
  ...
  %add57.us.us.1 = add nsw i64 %k.0193.us.us, 2
...
blklab15.loopexit.us-lcssa.us.us:                 ; preds = %blklab17.loopexit.us.us
  %add59.us = add nuw nsw i64 %i.0198.us, 1
  %exitcond201.us = icmp eq i64 %add59.us, %1
  br i1 %exitcond201.us, label %if.end62.loopexit, label %while.cond33.preheader.us
...
if.end62:                                         ; preds = %if.end62.loopexit, %while.cond33.preheader.preheader, %polly.parallel.for, %entry
  ...
  br i1 %a_dealloc, label %if.then68, label %if.end69
...
if.end69:                                         ; preds = %if.then68, %if.end62
  br i1 %b_dealloc, label %if.then71, label %if.end93
...
if.end93:                                         ; preds = %if.end69, %if.then71
...
polly.parallel.for:                               ; preds = %polly.split_new_and_old
  ...
  %polly.subfn.storeaddr.269 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 1
  store i64 %1, i64* %polly.subfn.storeaddr.269, align 8
  ...
  store i64* %call, i64** %polly.subfn.storeaddr.call, align 8
  %polly.subfn.storeaddr.270 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 3
  store i64* %2, i64** %polly.subfn.storeaddr.270, align 8
  %polly.subfn.storeaddr.271 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 4
  store i64* %3, i64** %polly.subfn.storeaddr.271, align 8
