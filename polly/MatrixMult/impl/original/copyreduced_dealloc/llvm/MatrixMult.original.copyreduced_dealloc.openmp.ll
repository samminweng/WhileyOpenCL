...
entry:
  ...
  br i1 %cmp194, label %polly.split_new_and_old, label %if.end62
...
polly.split_new_and_old:                          ; preds = %entry
  ...
  %polly.overflow.state199 = or i1 %.obit, %polly.access.mul..obit
  ...
  %polly.overflow.state202 = or i1 %polly.overflow.state199, %polly.access.add..obit
  %5 = icmp ule i64* %polly.access., %call
  %polly.access.call214 = getelementptr i64, i64* %call, i64 %polly.access.add..res
  %6 = icmp ule i64* %polly.access.call214, %2
  %7 = or i1 %5, %6
  %8 = tail call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %0, i64 1)
  %.obit224 = extractvalue { i64, i1 } %8, 1
  %polly.overflow.state225 = or i1 %.obit224, %polly.overflow.state202
  %.res226 = extractvalue { i64, i1 } %8, 0
  %polly.access.mul.227 = tail call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %.res226, i64 %0)
  %polly.access.mul..obit228 = extractvalue { i64, i1 } %polly.access.mul.227, 1
  %polly.overflow.state229 = or i1 %polly.access.mul..obit228, %polly.overflow.state225
  %polly.access.mul..res230 = extractvalue { i64, i1 } %polly.access.mul.227, 0
  %polly.access.add.231 = tail call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %polly.access.mul..res230, i64 %0)
  %polly.access.add..obit232 = extractvalue { i64, i1 } %polly.access.add.231, 1
  %polly.access.add..res234 = extractvalue { i64, i1 } %polly.access.add.231, 0
  %polly.access.235 = getelementptr i64, i64* %3, i64 %polly.access.add..res234
  %polly.overflow.state242 = or i1 %polly.access.add..obit232, %polly.overflow.state229
  %9 = icmp ule i64* %polly.access.235, %call
  %polly.overflow.state246 = or i1 %.obit, %polly.overflow.state242
  %polly.overflow.state250 = or i1 %polly.access.mul..obit, %polly.overflow.state246
  %polly.overflow.state263 = or i1 %polly.access.add..obit, %polly.overflow.state250
  %10 = icmp ule i64* %polly.access.call214, %3
  %11 = or i1 %9, %10
  %12 = and i1 %7, %11
  %polly.rtc.overflown = xor i1 %polly.overflow.state263, true
...
while.cond33.preheader.preheader:                 ; preds = %polly.split_new_and_old
  %cmp35191 = icmp sgt i64 %0, 0
  br i1 %cmp35191, label %while.cond33.preheader.us.preheader, label %if.end62
...
while.cond33.preheader.us:                        ; preds = %while.cond33.preheader.us.preheader, %blklab15.loopexit.us-lcssa.us.us
  %i.0195.us = phi i64 [ %add59.us, %blklab15.loopexit.us-lcssa.us.us ], [ 0, %while.cond33.preheader.us.preheader ]
  %mul45.us = mul nsw i64 %i.0195.us, %0
...
while.cond39.preheader.us.us:                     ; preds = %while.cond33.preheader.us, %blklab17.loopexit.us.us
  %j.0192.us.us = phi i64 [ %add58.us.us, %blklab17.loopexit.us.us ], [ 0, %while.cond33.preheader.us ]
  %add.us.us = add nsw i64 %j.0192.us.us, %mul45.us
...
blklab17.loopexit.us.us.unr-lcssa:                ; preds = %blklab17.loopexit.us.us.unr-lcssa.loopexit, %while.cond39.preheader.us.us
  ...
  %k.0190.us.us.unr = phi i64 [ 0, %while.cond39.preheader.us.us ], [ %add57.us.us.1, %blklab17.loopexit.us.us.unr-lcssa.loopexit ]
...
if.end44.us.us.epil:                              ; preds = %if.end44.us.us.epil.preheader
  %add47.us.us.epil = add nsw i64 %k.0190.us.us.unr, %mul45.us
  ...
  %mul49.us.us.epil = mul nsw i64 %k.0190.us.us.unr, %0
  %add50.us.us.epil = add nsw i64 %mul49.us.us.epil, %j.0192.us.us
...
blklab17.loopexit.us.us:                          ; preds = %blklab17.loopexit.us.us.unr-lcssa, %blklab17.loopexit.us.us.epilog-lcssa
  %add58.us.us = add nuw nsw i64 %j.0192.us.us, 1
  %exitcond197.us.us = icmp eq i64 %add58.us.us, %0
  br i1 %exitcond197.us.us, label %blklab15.loopexit.us-lcssa.us.us, label %while.cond39.preheader.us.us
...
if.end44.us.us:                                   ; preds = %if.end44.us.us, %while.cond39.preheader.us.us.new
  ...
  %k.0190.us.us = phi i64 [ 0, %while.cond39.preheader.us.us.new ], [ %add57.us.us.1, %if.end44.us.us ]
  %niter = phi i64 [ %unroll_iter, %while.cond39.preheader.us.us.new ], [ %niter.nsub.1, %if.end44.us.us ]
  %add47.us.us = add nsw i64 %k.0190.us.us, %mul45.us
  %arrayidx48.us.us = getelementptr inbounds i64, i64* %2, i64 %add47.us.us
  %17 = load i64, i64* %arrayidx48.us.us, align 8, !tbaa !8
  %mul49.us.us = mul nsw i64 %k.0190.us.us, %0
  %add50.us.us = add nsw i64 %mul49.us.us, %j.0192.us.us
  ...
  %add57.us.us = or i64 %k.0190.us.us, 1
  ...
  %add50.us.us.1 = add nsw i64 %mul49.us.us.1, %j.0192.us.us
  ...
  %add57.us.us.1 = add nsw i64 %k.0190.us.us, 2
...
blklab15.loopexit.us-lcssa.us.us:                 ; preds = %blklab17.loopexit.us.us
  %add59.us = add nuw nsw i64 %i.0195.us, 1
  %exitcond198.us = icmp eq i64 %add59.us, %1
  br i1 %exitcond198.us, label %if.end62.loopexit, label %while.cond33.preheader.us
...
if.end62:                                         ; preds = %if.end62.loopexit, %while.cond33.preheader.preheader, %polly.parallel.for, %entry
  ...
  br i1 %a_dealloc, label %if.then66, label %if.end67
...
if.end67:                                         ; preds = %if.then66, %if.end62
  br i1 %b_dealloc, label %if.then69, label %if.end91
...
if.end91:                                         ; preds = %if.end67, %if.then69
...
polly.parallel.for:                               ; preds = %polly.split_new_and_old
  ...
  %polly.subfn.storeaddr.266 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 1
  store i64 %1, i64* %polly.subfn.storeaddr.266, align 8
  ...
  store i64* %call, i64** %polly.subfn.storeaddr.call, align 8
  %polly.subfn.storeaddr.267 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 3
  store i64* %2, i64** %polly.subfn.storeaddr.267, align 8
  %polly.subfn.storeaddr.268 = getelementptr inbounds { i64, i64, i64*, i64*, i64* }, { i64, i64, i64*, i64*, i64* }* %polly.par.userContext, i64 0, i32 4
  store i64* %3, i64** %polly.subfn.storeaddr.268, align 8
...
polly.loop_header39.us:                           ; preds = %polly.loop_header29.us, %polly.loop_header39.us
  ...
  %_p_scalar_54.us = load i64, i64* %scevgep53.us, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !27
  %45 = mul i64 %43, %polly.subfunc.arg.
  %46 = add i64 %45, %40
  %scevgep55.us = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %46
  %_p_scalar_56.us = load i64, i64* %scevgep55.us, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !27
  ...
  %_p_scalar_54.us.1 = load i64, i64* %scevgep53.us.1, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !27
  %49 = mul i64 %47, %polly.subfunc.arg.
  %50 = add i64 %49, %40
  %scevgep55.us.1 = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %50
  %_p_scalar_56.us.1 = load i64, i64* %scevgep55.us.1, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !27
  ...
  %_p_scalar_54.us.2 = load i64, i64* %scevgep53.us.2, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !27
  %53 = mul i64 %51, %polly.subfunc.arg.
  %54 = add i64 %53, %40
  %scevgep55.us.2 = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %54
  %_p_scalar_56.us.2 = load i64, i64* %scevgep55.us.2, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !27
  ...
  %_p_scalar_54.us.3 = load i64, i64* %scevgep53.us.3, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !27
  %57 = mul i64 %55, %polly.subfunc.arg.
  %58 = add i64 %57, %40
  %scevgep55.us.3 = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %58
  %_p_scalar_56.us.3 = load i64, i64* %scevgep55.us.3, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !27
...
polly.loop_header58.us:                           ; preds = %polly.loop_header58.us, %polly.loop_header58.us.preheader.new
  ...
  %_p_scalar_71.us = load i64, i64* %scevgep70.us, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !29
  %61 = mul i64 %59, %polly.subfunc.arg.
  %62 = add i64 %61, %40
  %scevgep72.us = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %62
  %_p_scalar_73.us = load i64, i64* %scevgep72.us, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !29
  ...
  %_p_scalar_71.us.1 = load i64, i64* %scevgep70.us.1, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !29
  %65 = mul i64 %63, %polly.subfunc.arg.
  %66 = add i64 %65, %40
  %scevgep72.us.1 = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %66
  %_p_scalar_73.us.1 = load i64, i64* %scevgep72.us.1, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !29
...
polly.merge.loopexit.us.epilog-lcssa:             ; preds = %polly.loop_header58.us.epil
  ...
  %_p_scalar_73.us.epil = load i64, i64* %scevgep72.us.epil, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !29
  %70 = add i64 %67, %39
  %scevgep70.us.epil = getelementptr i64, i64* %polly.subfunc.arg.3, i64 %70
  %_p_scalar_71.us.epil = load i64, i64* %scevgep70.us.epil, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !29
...
polly.merge.loopexit.epilog-lcssa:                ; preds = %polly.loop_header58.epil
  ...
  %_p_scalar_73.epil = load i64, i64* %scevgep72.epil, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !29
  %76 = add i64 %73, %39
  %scevgep70.epil = getelementptr i64, i64* %polly.subfunc.arg.3, i64 %76
  %_p_scalar_71.epil = load i64, i64* %scevgep70.epil, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !29
...
polly.loop_header58:                              ; preds = %polly.loop_header58, %polly.loop_header29.new
  ...
  %_p_scalar_71 = load i64, i64* %scevgep70, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !29
  %79 = mul i64 %77, %polly.subfunc.arg.
  %80 = add i64 %79, %71
  %scevgep72 = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %80
  %_p_scalar_73 = load i64, i64* %scevgep72, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !29
  ...
  %_p_scalar_71.1 = load i64, i64* %scevgep70.1, align 8, !alias.scope !25, !noalias !26, !llvm.mem.parallel_loop_access !29
  %83 = mul i64 %81, %polly.subfunc.arg.
  %84 = add i64 %83, %71
  %scevgep72.1 = getelementptr i64, i64* %polly.subfunc.arg.4, i64 %84
  %_p_scalar_73.1 = load i64, i64* %scevgep72.1, align 8, !alias.scope !24, !noalias !28, !llvm.mem.parallel_loop_access !29
