...
blklab13:;
	...
	{
		void* C_data_tmp;
		_34 = matrix(_35, _36, _COPY_2DARRAY_PARAM_int64_t(C_data));
	}
	//return %34
	return _34;
	//return
...
blklab23:;
	...
	{
		void* rows_tmp;
		_15 = matrix(width, height, _COPY_2DARRAY_PARAM_int64_t(rows));
	}
	//return %15
	return _15;
	//return
...
int main(int argc, char** args){
	...
	//invoke (%17) = (%3, %4) MatrixMult_2DArray:multiply : function(MatrixMult_2DArray:Matrix,MatrixMult_2DArray:Matrix)->(MatrixMult_2DArray:Matrix)
	{
		void* A_tmp;
		void* B_tmp;
		_17 = multiply(_COPY_STRUCT_PARAM(A, Matrix), _COPY_STRUCT_PARAM(B, Matrix));
	}
