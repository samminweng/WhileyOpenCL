...
for.cond1.preheader:                              ; preds = %entry.split, %for.end
  %indvars.iv12 = phi i64 [ 0, %entry.split ], [ %indvars.iv.next13, %for.end ]
  br label %for.inc
...
for.inc:                                          ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv6 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next7, %for.inc ]
  %tmp.04 = phi i32 [ 0, %for.cond1.preheader ], [ %add9, %for.inc ]
  %0 = shl i64 %indvars.iv12, 6
  %1 = add nuw nsw i64 %indvars.iv6, %0
  %arrayidx = getelementptr inbounds i32, i32* %a, i64 %1
  %2 = load i32, i32* %arrayidx, align 4
  %3 = shl i64 %indvars.iv12, 6
  %4 = add nuw nsw i64 %indvars.iv6, %3
  %arrayidx7 = getelementptr inbounds i32, i32* %b, i64 %4
  %5 = load i32, i32* %arrayidx7, align 4
  %mul8 = mul nsw i32 %5, %2
  %add9 = add nsw i32 %mul8, %tmp.04
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond11 = icmp ne i64 %indvars.iv.next7, 64
  br i1 %exitcond11, label %for.inc, label %for.end

for.end:                                          ; preds = %for.inc
  %add9.lcssa = phi i32 [ %add9, %for.inc ]
  %arrayidx11 = getelementptr inbounds [64 x i32], [64 x i32]* %sum, i64 0, i64 %indvars.iv12
  store i32 %add9.lcssa, i32* %arrayidx11, align 4
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond16 = icmp ne i64 %indvars.iv.next13, 32
  br i1 %exitcond16, label %for.cond1.preheader, label %for.cond16.preheader

for.inc22:                                        ; preds = %for.cond16.preheader, %for.inc22
  %indvars.iv = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next, %for.inc22 ]
  %total.02 = phi i32 [ 0, %for.cond16.preheader ], [ %add21, %for.inc22 ]
  %arrayidx20 = getelementptr inbounds [64 x i32], [64 x i32]* %sum, i64 0, i64 %indvars.iv
  %6 = load i32, i32* %arrayidx20, align 4
  %add21 = add nsw i32 %6, %total.02
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 32
  br i1 %exitcond, label %for.inc22, label %for.end24

for.end24:                                        ; preds = %for.inc22
  %add21.lcssa = phi i32 [ %add21, %for.inc22 ]
  ret i32 %add21.lcssa
}
...
for.body:                                         ; preds = %entry.split, %for.inc10
  %indvars.iv3 = phi i64 [ 0, %entry.split ], [ %indvars.iv.next4, %for.inc10 ]
...
for.end12:                                        ; preds = %for.inc10
  %1 = load i32, i32* getelementptr inbounds ([2048 x [2048 x i32]], [2048 x [2048 x i32]]* @Z, i64 0, i64 2047, i64 2047), align 4
  %call13 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.2, i64 0, i64 0), i32 2048, i32 2048, i32 2047, i32 2047, i32 %1) #3
  ret i32 0
}
