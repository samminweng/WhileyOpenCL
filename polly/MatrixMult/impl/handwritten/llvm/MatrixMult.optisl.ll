...
polly.stmt.for.body3:                             ; preds = %polly.loop_header3
  ...
  %4 = mul nsw i64 15, %polly.indvar6
  %5 = mul nsw i64 15, %polly.indvar6
  %6 = add nsw i64 %5, 15
  br label %polly.loop_if

polly.loop_exit12:                                ; preds = %polly.stmt.for.body8, %polly.loop_if
...
polly.stmt.for.inc25:                             ; preds = %polly.loop_exit12
  ...
  %7 = add i64 %polly.indvar6, 1
  %p_exitcond6 = icmp eq i64 %7, 32, !dbg !48
...
polly.loop_preheader4:                            ; preds = %polly.loop_header
  ...
  %8 = shl i64 %polly.indvar, 5
  %scevgep21 = getelementptr i64, i64* getelementptr inbounds ([32 x [32 x i64]], [32 x [32 x i64]]* @A, i64 0, i64 0, i64 1), i64 %8
  %scevgep27 = getelementptr [32 x [32 x i64]], [32 x [32 x i64]]* @C, i64 0, i64 %polly.indvar, i64 0
  br label %polly.loop_header3

polly.loop_if:                                    ; preds = %polly.stmt.for.body3
  %polly.loop_guard = icmp sle i64 %4, %6
  br i1 %polly.loop_guard, label %polly.loop_preheader11, label %polly.loop_exit12

polly.loop_header10:                              ; preds = %polly.stmt.for.body8, %polly.loop_preheader11
  %polly.indvar13 = phi i64 [ %4, %polly.loop_preheader11 ], [ %polly.indvar_next14, %polly.stmt.for.body8 ]
  %9 = mul nsw i64 -15, %polly.indvar6
  %10 = add nsw i64 %9, %polly.indvar13
  br label %polly.stmt.for.body8

polly.stmt.for.body8:                             ; preds = %polly.loop_header10
  %add1.phiops.reload = load i64, i64* %add1.phiops
  %11 = shl i64 %10, 1
  %scevgep17 = getelementptr i64, i64* %scevgep16, i64 %11
  %_p_scalar_ = load i64, i64* %scevgep17, align 16, !alias.scope !75, !noalias !76
  %12 = shl i64 %10, 6
  %scevgep19 = getelementptr i64, i64* %scevgep18, i64 %12
  ...
  %13 = shl i64 %10, 1
  %scevgep22 = getelementptr i64, i64* %scevgep21, i64 %13
  %_p_scalar_23 = load i64, i64* %scevgep22, align 8, !alias.scope !75, !noalias !76
  %14 = shl i64 %10, 6
  %scevgep25 = getelementptr i64, i64* %scevgep24, i64 %14
  ...
  %15 = shl i64 %10, 1
  %16 = add i64 %15, 2
  %p_exitcond.1 = icmp eq i64 %16, 32, !dbg !58
  ...
  %polly.loop_cond15 = icmp sle i64 %polly.indvar13, %polly.adjust_ub
  br i1 %polly.loop_cond15, label %polly.loop_header10, label %polly.loop_exit12

polly.loop_preheader11:                           ; preds = %polly.loop_if
...
entry:
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !78, metadata !25), !dbg !79
...
entry:
  ...
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !95, metadata !25), !dbg !96
...
for.body:                                         ; preds = %polly.split_new_and_old, %mat_mult.exit
  ...
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !24, metadata !25), !dbg !101
...
for.body3.i3:                                     ; preds = %for.inc25.i, %for.cond1.preheader.i1
  ...
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !56, metadata !25), !dbg !116
...
mat_mult.exit:                                    ; preds = %for.inc28.i
  ...
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !95, metadata !25), !dbg !96
...
polly.stmt.vector.body:                           ; preds = %polly.loop_header8
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep14, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep1516, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep1718, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep1920, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep2122, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep2324, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep2526, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep2728, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep2930, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep3132, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep3334, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep3536, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep3738, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep3940, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep4142, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep4344, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep4546, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep4748, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep4950, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep5152, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep5354, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep5556, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep5758, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep5960, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep6162, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep6364, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep6566, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep6768, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep6970, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep7172, align 16, !alias.scope !133, !noalias !137
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep7374, align 16, !alias.scope !130, !noalias !132
  ...
  store <2 x i64> <i64 1, i64 1>, <2 x i64>* %scevgep7576, align 16, !alias.scope !133, !noalias !137
...
polly.stmt.for.body3.i3:                          ; preds = %polly.loop_header83
  ...
  store i64 0, i64* %scevgep90, align 8, !alias.scope !134, !noalias !138
  store i64 0, i64* %add1.i.phiops
  %85 = mul nsw i64 15, %polly.indvar86
  %86 = mul nsw i64 15, %polly.indvar86
  %87 = add nsw i64 %86, 15
  br label %polly.loop_if

polly.loop_exit93:                                ; preds = %polly.stmt.for.body8.i, %polly.loop_if
...
polly.stmt.for.inc25.i:                           ; preds = %polly.loop_exit93
  ...
  store i64 %add.i.1.lcssa.phiops.reload, i64* %scevgep109, align 8, !alias.scope !134, !noalias !138
  %88 = add i64 %polly.indvar86, 1
  %p_exitcond6.i = icmp eq i64 %88, 32, !dbg !111
...
polly.loop_preheader84:                           ; preds = %polly.loop_header77
  ...
  %89 = shl i64 %polly.indvar80, 5
  %scevgep102 = getelementptr i64, i64* getelementptr inbounds ([32 x [32 x i64]], [32 x [32 x i64]]* @A, i64 0, i64 0, i64 1), i64 %89
  %scevgep108 = getelementptr [32 x [32 x i64]], [32 x [32 x i64]]* @C, i64 0, i64 %polly.indvar80, i64 0
  br label %polly.loop_header83

polly.loop_if:                                    ; preds = %polly.stmt.for.body3.i3
  %polly.loop_guard = icmp sle i64 %85, %87
  br i1 %polly.loop_guard, label %polly.loop_preheader92, label %polly.loop_exit93

polly.loop_header91:                              ; preds = %polly.stmt.for.body8.i, %polly.loop_preheader92
  %polly.indvar94 = phi i64 [ %85, %polly.loop_preheader92 ], [ %polly.indvar_next95, %polly.stmt.for.body8.i ]
  %90 = mul nsw i64 -15, %polly.indvar86
  %91 = add nsw i64 %90, %polly.indvar94
...
polly.stmt.for.body8.i:                           ; preds = %polly.loop_header91
  ...
  %92 = shl i64 %91, 1
  %scevgep98 = getelementptr i64, i64* %scevgep97, i64 %92
  %_p_scalar_ = load i64, i64* %scevgep98, align 16, !alias.scope !130, !noalias !132
  %93 = shl i64 %91, 6
  %scevgep100 = getelementptr i64, i64* %scevgep99, i64 %93
  %_p_scalar_101 = load i64, i64* %scevgep100, align 8, !alias.scope !133, !noalias !137
  %p_mul.i = mul nsw i64 %_p_scalar_101, %_p_scalar_, !dbg !121
  %p_add.i = add nsw i64 %p_mul.i, %add1.i.phiops.reload, !dbg !122
  %94 = shl i64 %91, 1
  %scevgep103 = getelementptr i64, i64* %scevgep102, i64 %94
  %_p_scalar_104 = load i64, i64* %scevgep103, align 8, !alias.scope !130, !noalias !132
  %95 = shl i64 %91, 6
  %scevgep106 = getelementptr i64, i64* %scevgep105, i64 %95
  %_p_scalar_107 = load i64, i64* %scevgep106, align 8, !alias.scope !133, !noalias !137
  %p_mul.i.1 = mul nsw i64 %_p_scalar_107, %_p_scalar_104, !dbg !121
  %p_add.i.1 = add nsw i64 %p_mul.i.1, %p_add.i, !dbg !122
  %96 = shl i64 %91, 1
  %97 = add i64 %96, 2
  %p_exitcond.i6.1 = icmp eq i64 %97, 32, !dbg !117
  ...
  %polly.adjust_ub = sub i64 %87, 1
  %polly.loop_cond96 = icmp sle i64 %polly.indvar94, %polly.adjust_ub
  br i1 %polly.loop_cond96, label %polly.loop_header91, label %polly.loop_exit93

polly.loop_preheader92:                           ; preds = %polly.loop_if
...
!71 = !{!72, !73, !74, !75}
!72 = distinct !{!72, !70, !"polly.alias.scope.add.1.lcssa"}
!73 = distinct !{!73, !70, !"polly.alias.scope.B"}
!74 = distinct !{!74, !70, !"polly.alias.scope.add1"}
!75 = distinct !{!75, !70, !"polly.alias.scope.A"}
!76 = !{!72, !73, !74, !69}
!77 = !{!72, !74, !75, !69}
!78 = !DILocalVariable(name: "i", scope: !8, file: !1, line: 33, type: !12)
!79 = !DILocation(line: 33, column: 9, scope: !8)
...
!95 = !DILocalVariable(name: "r", scope: !9, file: !1, line: 49, type: !12)
!96 = !DILocation(line: 49, column: 9, scope: !9)
