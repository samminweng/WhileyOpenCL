...
polly.loop_header49:                              ; preds = %polly.loop_header49, %polly.loop_preheader50
  ...
  %_p_scalar_57 = load i64, i64* %scevgep56, align 16, !alias.scope !52, !noalias !53
  %scevgep58 = getelementptr [512 x [512 x i64]], [512 x [512 x i64]]* @B, i64 0, i64 %37, i64 %39
  %_p_scalar_59 = load i64, i64* %scevgep58, align 8, !alias.scope !51, !noalias !54
  ...
  %_p_scalar_57.1 = load i64, i64* %scevgep56.1, align 8, !alias.scope !52, !noalias !53
  %scevgep58.1 = getelementptr [512 x [512 x i64]], [512 x [512 x i64]]* @B, i64 0, i64 %38, i64 %39
  %_p_scalar_59.1 = load i64, i64* %scevgep58.1, align 8, !alias.scope !51, !noalias !54
...
polly.loop_header49.i:                            ; preds = %polly.loop_header49.i, %polly.loop_preheader50.i
  ...
  %_p_scalar_57.i = load i64, i64* %scevgep56.i, align 16, !dbg !99, !alias.scope !104, !noalias !105
  %scevgep58.i = getelementptr [512 x [512 x i64]], [512 x [512 x i64]]* @B, i64 0, i64 %54, i64 %56, !dbg !99
  %_p_scalar_59.i = load i64, i64* %scevgep58.i, align 8, !dbg !99, !alias.scope !103, !noalias !106
  ...
  %_p_scalar_57.i.1 = load i64, i64* %scevgep56.i.1, align 8, !dbg !99, !alias.scope !104, !noalias !105
  %scevgep58.i.1 = getelementptr [512 x [512 x i64]], [512 x [512 x i64]]* @B, i64 0, i64 %55, i64 %56, !dbg !99
  %_p_scalar_59.i.1 = load i64, i64* %scevgep58.i.1, align 8, !dbg !99, !alias.scope !103, !noalias !106
...
!52 = distinct !{!52, !49, !"polly.alias.scope.A"}
!53 = !{!51, !48}
!54 = !{!48, !52}
...
!104 = distinct !{!104, !101, !"polly.alias.scope.A"}
!105 = !{!103, !100}
!106 = !{!100, !104}
