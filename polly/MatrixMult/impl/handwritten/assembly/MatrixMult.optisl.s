...
.LBB1_2:                                # %polly.loop_if
	...
	leaq	(%rdi,%rdi,4), %rax
	leaq	(%rax,%rax,2), %rdx
	leaq	15(%rax,%rax,2), %r14
	movq	$-7680, %rcx            # imm = 0xFFFFFFFFFFFFE200
	cmpq	%r14, %rdx
	movq	%r9, %rdx
	movq	%r11, %rsi
	jg	.LBB1_4
...
.LBB3_9:                                # %polly.stmt.for.body8.i
	...
	movq	B+7680(%rcx,%rax,8), %rdi
.Ltmp37:
	.loc	1 25 45 prologue_end    # MatrixMult.c:25:45
	imulq	-8(%rsi), %rdi
	.loc	1 25 35 is_stmt 0       # MatrixMult.c:25:35
	addq	-32(%rbp), %rdi
	movq	B+7936(%rcx,%rax,8), %rdx
	.loc	1 25 45                 # MatrixMult.c:25:45
	imulq	(%rsi), %rdx
	.loc	1 25 35                 # MatrixMult.c:25:35
	addq	%rdi, %rdx
