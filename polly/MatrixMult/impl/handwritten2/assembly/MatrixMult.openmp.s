...
.LBB1_2:                                # %polly.stmt.for.body3
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	movl	B+16000000(%rax,%r10,4), %edx
	movl	%edx, -16(%rcx)
	movl	B+16008000(%rax,%r10,4), %edx
	movl	%edx, -12(%rcx)
	movl	B+16016000(%rax,%r10,4), %edx
	movl	%edx, -8(%rcx)
	movl	B+16024000(%rax,%r10,4), %edx
	movl	%edx, -4(%rcx)
	movl	B+16032000(%rax,%r10,4), %edx
	movl	%edx, (%rcx)
	addq	$20, %rcx
...
.LBB1_6:                                # %polly.stmt.for.body13
	...
	movl	-140(%rsp,%rdx,4), %eax
.Ltmp18:
	.loc	1 48 24 prologue_end    # MatrixMult.c:48:24
	imull	-12(%rsi), %eax
	.loc	1 48 15 is_stmt 0       # MatrixMult.c:48:15
	addl	%ecx, %eax
	movl	-136(%rsp,%rdx,4), %ecx
...
# BB#4:                                 # %polly.loop_exit74
	...
	jne	.LBB1_1
# BB#5:                                 # %polly.exiting
	.loc	1 53 1 is_stmt 1        # MatrixMult.c:53:1
...
.Linfo_string16:
	.asciz	"k"                     # string offset=307
.Linfo_string17:
	.asciz	"sum"                   # string offset=309
...
.Lcu_begin0:
	...
	.long	83                      # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	7                       # Abbrev [7] 0xd4:0x60 DW_TAG_subprogram
	...
	.byte	36                      # DW_AT_decl_line
	.long	83                      # DW_AT_type
	.byte	11                      # Abbrev [11] 0x11a:0x19 DW_TAG_lexical_block
	.quad	.Ltmp18                 # DW_AT_low_pc
	.long	.Ltmp19-.Ltmp18         # DW_AT_high_pc
	.byte	9                       # Abbrev [9] 0x127:0xb DW_TAG_variable
	...
	.byte	0                       # End Of Children Mark
	.byte	0                       # End Of Children Mark
	.byte	12                      # Abbrev [12] 0x134:0x19 DW_TAG_subprogram
	...
	.long	83                      # DW_AT_type
                                        # DW_AT_external
                                        # DW_AT_APPLE_optimized
	.byte	3                       # Abbrev [3] 0x14d:0xd DW_TAG_array_type
	.long	83                      # DW_AT_type
	.byte	4                       # Abbrev [4] 0x152:0x7 DW_TAG_subrange_type
	.long	90                      # DW_AT_type
	.short	2000                    # DW_AT_count
	.byte	0                       # End Of Children Mark
	.byte	0                       # End Of Children Mark
...
.LpubNames_begin0:
	...
	.long	347                     # Compilation Unit Length
	.long	42                      # DIE offset
