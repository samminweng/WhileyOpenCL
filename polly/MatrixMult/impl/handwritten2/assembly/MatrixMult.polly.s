...
# BB#2:                                 # %polly.loop_preheader
	movslq	-88(%rbp), %r13         # 4-byte Folded Reload
	leaq	-1(%r13), %rsi
	sarq	$5, %rsi
	movq	%r13, %rax
	shlq	$7, %rax
...
# BB#1:                                 # %for.cond7.preheader.lr.ph
	movslq	-228(%rbp), %rax        # 4-byte Folded Reload
	xorl	%ecx, %ecx
	testl	%eax, %eax
...
# BB#3:                                 # %polly.preload.merge
	cmpl	%ecx, -228(%rbp)        # 4-byte Folded Reload
	jl	.LBB1_5
...
# BB#42:                                # %polly.start
	...
	sarq	$5, -272(%rbp)          # 8-byte Folded Spill
	movq	%r10, %rbx
...
.LBB1_40:                               # %polly.loop_exit39.loopexit.us
	...
	subq	$-128, -72(%rbp)        # 8-byte Folded Spill
...
# BB#64:                                # %polly.loop_header119.preheader.us.preheader
	...
	leaq	-1(%rax), %r8
	cmpl	$1, -228(%rbp)          # 4-byte Folded Reload
	sete	%al
	andq	$-4, %r9
	setne	%dl
	andb	%al, %dl
	movb	%dl, -104(%rbp)         # 1-byte Spill
	movq	-128(%rbp), %xmm1       # 8-byte Folded Reload
                                        # xmm1 = mem[0],zero
...
# BB#66:                                # %polly.loop_header128.preheader.us.us.preheader
	...
	leaq	(%rcx,%rax), %r10
	imulq	-80(%rbp), %r10         # 8-byte Folded Reload
...
.LBB1_79:                               # %middle.block
	...
	paddd	%xmm2, %xmm3
	movd	%xmm3, %eax
	cmpq	%r9, -48(%rbp)          # 8-byte Folded Reload
	movq	%r9, %rdx
	movq	%rdi, %r11
	jne	.LBB1_69
	jmp	.LBB1_80
...
.LBB1_82:                               # %polly.loop_exit112
                                        #   in Loop: Header=BB1_62 Depth=3
	addq	$32, -96(%rbp)          # 8-byte Folded Spill
...
.LBB1_71:                               # %polly.loop_exit103
                                        #   in Loop: Header=BB1_60 Depth=2
	addq	$32, -168(%rbp)         # 8-byte Folded Spill
	movq	-248(%rbp), %rdx        # 8-byte Reload
...
# BB#23:                                # %polly.loop_header148.preheader
	sarq	$5, -264(%rbp)          # 8-byte Folded Spill
	xorl	%eax, %eax
	movq	%rax, -128(%rbp)        # 8-byte Spill
	movl	$1, %eax
	movd	%rax, %xmm0
...
# BB#28:                                # %polly.loop_header176.preheader.us.us.preheader
	...
	movq	-112(%rbp), %xmm1       # 8-byte Folded Reload
                                        # xmm1 = mem[0],zero
	pshufd	$68, %xmm1, %xmm1       # xmm1 = xmm1[0,1,0,1]
	andl	$1, %ecx
	movq	%rcx, -104(%rbp)        # 8-byte Spill
...
.LBB1_91:                               # %polly.loop_exit169.loopexit.us
                                        #   in Loop: Header=BB1_27 Depth=2
	addq	$32, -72(%rbp)          # 8-byte Folded Spill
...
.LBB1_92:                               # %polly.loop_exit160
                                        #   in Loop: Header=BB1_24 Depth=1
	addq	$32, -128(%rbp)         # 8-byte Folded Spill
