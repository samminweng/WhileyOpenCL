...
.LBB3_8:                                # %polly.loop_preheader8.i
	...
	movl	$32, %edx
	.p2align	4, 0x90
.LBB3_9:                                # %polly.loop_preheader14.i
                                        #   Parent Loop BB3_1 Depth=1
                                        #     Parent Loop BB3_7 Depth=2
                                        #       Parent Loop BB3_8 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	movdqa	B-208(%rsi), %xmm1
	movdqa	B-224(%rsi), %xmm2
	paddq	A-224(%rsi), %xmm2
	paddq	A-208(%rsi), %xmm1
	movdqa	%xmm1, C-208(%rsi)
	movdqa	%xmm2, C-224(%rsi)
	movdqa	B-176(%rsi), %xmm1
	movdqa	B-192(%rsi), %xmm2
	paddq	A-192(%rsi), %xmm2
	paddq	A-176(%rsi), %xmm1
	movdqa	%xmm1, C-176(%rsi)
	movdqa	%xmm2, C-192(%rsi)
	movdqa	B-144(%rsi), %xmm1
	movdqa	B-160(%rsi), %xmm2
	paddq	A-160(%rsi), %xmm2
	paddq	A-144(%rsi), %xmm1
	movdqa	%xmm1, C-144(%rsi)
	movdqa	%xmm2, C-160(%rsi)
	movdqa	B-112(%rsi), %xmm1
	movdqa	B-128(%rsi), %xmm2
	paddq	A-128(%rsi), %xmm2
	paddq	A-112(%rsi), %xmm1
	movdqa	%xmm1, C-112(%rsi)
	movdqa	%xmm2, C-128(%rsi)
	movdqa	B-80(%rsi), %xmm1
	movdqa	B-96(%rsi), %xmm2
	paddq	A-96(%rsi), %xmm2
	paddq	A-80(%rsi), %xmm1
	movdqa	%xmm1, C-80(%rsi)
	movdqa	%xmm2, C-96(%rsi)
	movdqa	B-48(%rsi), %xmm1
	movdqa	B-64(%rsi), %xmm2
	paddq	A-64(%rsi), %xmm2
	paddq	A-48(%rsi), %xmm1
	movdqa	%xmm1, C-48(%rsi)
	movdqa	%xmm2, C-64(%rsi)
	movdqa	B-16(%rsi), %xmm1
	movdqa	B-32(%rsi), %xmm2
	paddq	A-32(%rsi), %xmm2
	paddq	A-16(%rsi), %xmm1
	movdqa	%xmm1, C-16(%rsi)
	movdqa	%xmm2, C-32(%rsi)
	movdqa	B+16(%rsi), %xmm1
	movdqa	B(%rsi), %xmm2
	paddq	A(%rsi), %xmm2
	paddq	A+16(%rsi), %xmm1
...
.Lcu_begin0:
	...
	.byte	29                      # DW_AT_decl_line
                                        # DW_AT_external
	.byte	11                      # Abbrev [11] 0xd5:0x14 DW_TAG_subprogram
	.long	.Linfo_string8          # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	7                       # DW_AT_decl_line
                                        # DW_AT_external
	.byte	1                       # DW_AT_inline
	.byte	12                      # Abbrev [12] 0xdd:0xb DW_TAG_variable
	.long	.Linfo_string9          # DW_AT_name
	.byte	1                       # DW_AT_decl_file
	.byte	9                       # DW_AT_decl_line
	.long	233                     # DW_AT_type
	.byte	0                       # End Of Children Mark
	.byte	5                       # Abbrev [5] 0xe9:0x7 DW_TAG_base_type
	.long	.Linfo_string10         # DW_AT_name
	.byte	5                       # DW_AT_encoding
	.byte	4                       # DW_AT_byte_size
	.byte	13                      # Abbrev [13] 0xf0:0x3b DW_TAG_subprogram
	...
	.long	233                     # DW_AT_type
	.byte	15                      # Abbrev [15] 0x118:0x12 DW_TAG_inlined_subroutine
	.long	213                     # DW_AT_abstract_origin
	.long	.Ldebug_ranges0         # DW_AT_ranges
	.byte	1                       # DW_AT_call_file
	.byte	49                      # DW_AT_call_line
	.byte	16                      # Abbrev [16] 0x123:0x6 DW_TAG_variable
	.byte	0                       # DW_AT_const_value
...
.LpubNames_begin0:
	...
	.long	300                     # Compilation Unit Length
	.long	42                      # DIE offset
