; ModuleID = 'MatrixAdd.before.pollyvector.ll'
...
vector.body15:                                    ; preds = %vector.body15, %vector.ph19
  ...
  %index.next21.1 = add nuw nsw i64 %index20, 8, !dbg !99
...
vector.ph:                                        ; preds = %vector.ph.preheader, %for.inc14.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next.1 = add nuw nsw i64 %index, 8, !dbg !105
