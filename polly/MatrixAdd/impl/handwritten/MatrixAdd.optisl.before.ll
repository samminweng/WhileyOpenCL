...
polly.stmt.for.body3:                             ; preds = %polly.loop_header2
  ...
  %_p_scalar_ = load i64, i64* %scevgep8, align 8, !alias.scope !65, !noalias !67, !llvm.mem.parallel_loop_access !70
  %scevgep10 = getelementptr i64, i64* %scevgep9, i64 %polly.indvar5
  %_p_scalar_11 = load i64, i64* %scevgep10, align 8, !alias.scope !68, !noalias !72, !llvm.mem.parallel_loop_access !70
  %p_add = add nsw i64 %_p_scalar_11, %_p_scalar_, !dbg !58
  %scevgep13 = getelementptr i64, i64* %scevgep12, i64 %polly.indvar5
  store i64 %p_add, i64* %scevgep13, align 8, !alias.scope !69, !noalias !73, !llvm.mem.parallel_loop_access !70
  ...
  br i1 %polly.loop_cond7, label %polly.loop_header2, label %polly.loop_exit4, !llvm.loop !71
...
for.body3:                                        ; preds = %for.inc, %for.cond1.preheader
  ...
  %arrayidx5 = getelementptr inbounds [10240 x [10240 x i64]], [10240 x [10240 x i64]]* @C, i64 0, i64 %indvars.iv6, i64 %indvars.iv, !dbg !87
  %2 = load i64, i64* %arrayidx5, align 8, !dbg !87
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %2) #4, !dbg !88
  %3 = trunc i64 %indvars.iv to i32, !dbg !89
  %rem = srem i32 %3, 80, !dbg !89
  %cmp6 = icmp eq i32 %rem, 79, !dbg !91
  br i1 %cmp6, label %if.then, label %for.inc, !dbg !92

if.then:                                          ; preds = %for.body3
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !93
  %fputc3 = tail call i32 @fputc(i32 10, %struct._IO_FILE* %4), !dbg !95
  br label %for.inc, !dbg !95

for.inc:                                          ; preds = %if.then, %for.body3
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !85
  tail call void @llvm.dbg.value(metadata !2, i64 0, metadata !96, metadata !26), !dbg !97
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !80
  %exitcond = icmp ne i64 %indvars.iv.next, 10240, !dbg !85
...
for.end:                                          ; preds = %for.inc
  ...
  %exitcond8 = icmp ne i64 %indvars.iv.next7, 10240, !dbg !76
...
entry:
  br label %entry.split1, !dbg !100

entry.split1:                                     ; preds = %entry
  br label %entry.split, !dbg !100

entry.split:                                      ; preds = %entry.split1
  tail call void @init_array(), !dbg !100
  tail call void @mat_add(), !dbg !101
  %0 = load i64, i64* getelementptr inbounds ([10240 x [10240 x i64]], [10240 x [10240 x i64]]* @C, i64 0, i64 10239, i64 10239), align 8, !dbg !102
  %call = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i64 0, i64 0), i32 10240, i32 10240, i32 10239, i32 10239, i64 %0) #4, !dbg !103
  ret i32 0, !dbg !104
}
...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang version 3.9.0 (http://llvm.org/git/clang.git 3f10def1e46ea783186be08e2138d0f76a707712) (http://llvm.org/git/llvm.git 626ceb277f4fd20c1899e04490b0ea6c2b1a0da8)", isOptimized: false, runtimeVersion: 0, emissionKind: 1, enums: !2, subprograms: !3, globals: !13)
!1 = !DIFile(filename: "MatrixAdd.c", directory: "/home/mw169/workspace/WhileyOpenCL/polly/MatrixAdd/impl/handwritten")
!2 = !{}
!3 = !{!4, !7, !8, !9}
...
!23 = !{!"clang version 3.9.0 (http://llvm.org/git/clang.git 3f10def1e46ea783186be08e2138d0f76a707712) (http://llvm.org/git/llvm.git 626ceb277f4fd20c1899e04490b0ea6c2b1a0da8)"}
...
!75 = !DILocalVariable(name: "i", scope: !8, file: !1, line: 31, type: !12)
...
!79 = distinct !DILexicalBlock(scope: !8, file: !1, line: 33, column: 5)
!80 = !DILocation(line: 35, column: 21, scope: !81)
!81 = distinct !DILexicalBlock(scope: !82, file: !1, line: 34, column: 29)
...
!87 = !DILocation(line: 35, column: 38, scope: !81)
!88 = !DILocation(line: 35, column: 13, scope: !81)
!89 = !DILocation(line: 36, column: 18, scope: !90)
!90 = distinct !DILexicalBlock(scope: !81, file: !1, line: 36, column: 17)
!91 = !DILocation(line: 36, column: 22, scope: !90)
!92 = !DILocation(line: 36, column: 17, scope: !81)
!93 = !DILocation(line: 36, column: 37, scope: !94)
!94 = !DILexicalBlockFile(scope: !90, file: !1, discriminator: 1)
!95 = !DILocation(line: 36, column: 29, scope: !94)
!96 = !DILocalVariable(name: "j", scope: !8, file: !1, line: 31, type: !12)
!97 = !DILocation(line: 31, column: 12, scope: !8)
!98 = !DILocation(line: 38, column: 9, scope: !84)
!99 = !DILocation(line: 40, column: 1, scope: !8)
!100 = !DILocation(line: 49, column: 5, scope: !9)
!101 = !DILocation(line: 50, column: 5, scope: !9)
!102 = !DILocation(line: 53, column: 83, scope: !9)
!103 = !DILocation(line: 53, column: 5, scope: !9)
!104 = !DILocation(line: 54, column: 5, scope: !9)
