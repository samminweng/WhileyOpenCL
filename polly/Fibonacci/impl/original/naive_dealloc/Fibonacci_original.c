...
int64_t* fibonacci(_DECL_1DARRAY_PARAM(ls), _DECL_DEALLOC_PARAM(ls), int64_t n, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	_DECL_1DARRAY(_2);
	_DECL_DEALLOC(_2);
	int64_t _3 = 0;
	int64_t _4 = 0;
...
blklab0:;
	...
	//invoke (%8) = (%0, %10) Fibonacci_original:fibonacci : function(int[],int)->(int[])
	{
		void* ls_tmp;
		_DEALLOC(_8);
		_8 = fibonacci(_COPY_1DARRAY_PARAM_int64_t(ls), false, _10, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_8));
...
int main(int argc, char** args){
	...
	//invoke (%10) = (%3, %12) Fibonacci_original:fibonacci : function(int[],int)->(int[])
	{
		void* arr_tmp;
		_DEALLOC(_10);
		_10 = fibonacci(_COPY_1DARRAY_PARAM_int64_t(arr), false, _12, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_10));
