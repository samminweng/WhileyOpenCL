...
blklab0:                                          ; preds = %entry
  %sub = add nsw i64 %n, -1
  %call = tail call i64* @fibonacci(i64* %ls, i64 %ls_size, i1 zeroext %ls_dealloc, i64 %sub)
  %arrayidx13 = getelementptr inbounds i64, i64* %call, i64 %sub
  %1 = load i64, i64* %arrayidx13, align 8, !tbaa !1
  %sub14 = add nsw i64 %n, -2
  %arrayidx15 = getelementptr inbounds i64, i64* %call, i64 %sub14
  %2 = load i64, i64* %arrayidx15, align 8, !tbaa !1
  %add = add nsw i64 %2, %1
  %arrayidx16 = getelementptr inbounds i64, i64* %call, i64 %n
  store i64 %add, i64* %arrayidx16, align 8, !tbaa !1
  ret i64* %call
}
...
entry:
  ...
  br i1 %cmp, label %if.end94.critedge, label %if.then75
...
if.then75:                                        ; preds = %entry
  ...
  %call25 = tail call i64* @fibonacci(i64* %call14, i64 %1, i1 zeroext true, i64 %sub20)
  %sub33 = add nsw i64 %1, -3
  %arrayidx34 = getelementptr inbounds i64, i64* %call25, i64 %sub33
  %2 = load i64, i64* %arrayidx34, align 8, !tbaa !1
  %call35 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %2)
  %sub36 = add nsw i64 %1, -2
  %arrayidx37 = getelementptr inbounds i64, i64* %call25, i64 %sub36
  %3 = load i64, i64* %arrayidx37, align 8, !tbaa !1
  %call38 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %3)
  %arrayidx40 = getelementptr inbounds i64, i64* %call25, i64 %sub20
  %4 = load i64, i64* %arrayidx40, align 8, !tbaa !1
  %call41 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64 %4)
  %call46 = tail call i64* @create1DArray(i32 0, i32 24) #5
  %5 = bitcast i64* %call46 to <2 x i64>*
  store <2 x i64> <i64 80, i64 97>, <2 x i64>* %5, align 8, !tbaa !1
  %arrayidx49 = getelementptr inbounds i64, i64* %call46, i64 2
  %6 = bitcast i64* %arrayidx49 to <2 x i64>*
  store <2 x i64> <i64 115, i64 115>, <2 x i64>* %6, align 8, !tbaa !1
  %arrayidx51 = getelementptr inbounds i64, i64* %call46, i64 4
  %7 = bitcast i64* %arrayidx51 to <2 x i64>*
  store <2 x i64> <i64 32, i64 70>, <2 x i64>* %7, align 8, !tbaa !1
  %arrayidx53 = getelementptr inbounds i64, i64* %call46, i64 6
  %8 = bitcast i64* %arrayidx53 to <2 x i64>*
  store <2 x i64> <i64 105, i64 98>, <2 x i64>* %8, align 8, !tbaa !1
  %arrayidx55 = getelementptr inbounds i64, i64* %call46, i64 8
  %9 = bitcast i64* %arrayidx55 to <2 x i64>*
  store <2 x i64> <i64 111, i64 110>, <2 x i64>* %9, align 8, !tbaa !1
  %arrayidx57 = getelementptr inbounds i64, i64* %call46, i64 10
  %10 = bitcast i64* %arrayidx57 to <2 x i64>*
  store <2 x i64> <i64 97, i64 99>, <2 x i64>* %10, align 8, !tbaa !1
  %arrayidx59 = getelementptr inbounds i64, i64* %call46, i64 12
  %11 = bitcast i64* %arrayidx59 to <2 x i64>*
  store <2 x i64> <i64 99, i64 105>, <2 x i64>* %11, align 8, !tbaa !1
  %arrayidx61 = getelementptr inbounds i64, i64* %call46, i64 14
  %12 = bitcast i64* %arrayidx61 to <2 x i64>*
  store <2 x i64> <i64 32, i64 116>, <2 x i64>* %12, align 8, !tbaa !1
  %arrayidx63 = getelementptr inbounds i64, i64* %call46, i64 16
  %13 = bitcast i64* %arrayidx63 to <2 x i64>*
  store <2 x i64> <i64 101, i64 115>, <2 x i64>* %13, align 8, !tbaa !1
  %arrayidx65 = getelementptr inbounds i64, i64* %call46, i64 18
  %14 = bitcast i64* %arrayidx65 to <2 x i64>*
  store <2 x i64> <i64 116, i64 32>, <2 x i64>* %14, align 8, !tbaa !1
  %arrayidx67 = getelementptr inbounds i64, i64* %call46, i64 20
  %15 = bitcast i64* %arrayidx67 to <2 x i64>*
  store <2 x i64> <i64 99, i64 97>, <2 x i64>* %15, align 8, !tbaa !1
  %arrayidx69 = getelementptr inbounds i64, i64* %call46, i64 22
  %16 = bitcast i64* %arrayidx69 to <2 x i64>*
  store <2 x i64> <i64 115, i64 101>, <2 x i64>* %16, align 8, !tbaa !1
  tail call void @println_s(i64* %call46, i64 24) #5
  %phitmp = bitcast i64* %call46 to i8*
  %phitmp159 = bitcast i64* %call25 to i8*
  %17 = bitcast i64* %call1 to i8*
  tail call void @free(i8* %17) #5
  tail call void @free(i8* %phitmp159) #5
  tail call void @free2DArray(i64** %call, i64 %conv) #5
  tail call void @free(i8* %phitmp) #5
  br label %if.end94

if.end94.critedge:                                ; preds = %entry
  tail call void @free2DArray(i64** %call, i64 %conv) #5
  br label %if.end94

if.end94:                                         ; preds = %if.end94.critedge, %if.then75
