...
BYTE* compress(BYTE* data, size_t data_size, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	while(true){
		...
		{
			_14 = write_u1(_1DARRAY_PARAM(output), offset, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_14));
		}
		//assign %1 = %14  : byte[]
		...
		{
			_16 = append_byte(_1DARRAY_PARAM(output), _17, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_16));
		}
		//assign %1 = %16  : byte[]
...
blklab10:;
		...
		{
			_20 = write_u1(_1DARRAY_PARAM(output), len, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_20));
		}
		//assign %1 = %20  : byte[]
...
int main(int argc, char** args){
	...
	//invoke (%20) = (%2) LZ77_original:compress : function(byte[])->(byte[])
	{
	...
	//invoke (%30) = (%3) LZ77_original:decompress : function(byte[])->(byte[])
	{
