...
blklab10:;
	...
	{
		void* output_tmp;
		_33 = populate(_COPY_1DARRAY_PARAM_BYTE(output), _28, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_33));
	}
	//assign %1 = %33  : byte[]
...
int main(int argc, char** args){
	...
	{
		void* data_tmp;
		_23 = compress(_COPY_1DARRAY_PARAM_BYTE(data), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_23));
	}
	//assign %3 = %23  : byte[]
