...
//.blklab10
blklab10:;
	//invoke (%33) = (%1, %28) LZ77_original:populate : function(byte[],int)->(byte[])
	{
		_DEALLOC(_33);
		_33 = populate(_1DARRAY_PARAM(output), false, _28, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_33));
...
int main(int argc, char** args){
	...
	{
		_DEALLOC(_23);
		_23 = compress(_1DARRAY_PARAM(data), false, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_23));
	...
	{
		_DEALLOC(_33);
		_33 = decompress(_1DARRAY_PARAM(compress_data), false, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_33));
