...
BYTE* compress(BYTE* data, size_t data_size, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	while(true){
		...
		{
			_15 = findLongestMatch(_1DARRAY_PARAM(data), pos);
		}
...
blklab10:;
	...
	{
		_30 = populate(_1DARRAY_PARAM(output), size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_30));
	}
	//assign %1 = %30  : byte[]
...
int main(int argc, char** args){
	...
	{
		_20 = compress(_1DARRAY_PARAM(data), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_20));
	}
	//assign %3 = %20  : byte[]
	...
	{
		_30 = decompress(_1DARRAY_PARAM(compress_data), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_30));
	}
	//assign %4 = %30  : byte[]
