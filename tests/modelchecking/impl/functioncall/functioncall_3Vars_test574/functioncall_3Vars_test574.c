#include "functioncall_3Vars_test574.h"
...
int main(int argc, char** args){
	...
	while(true){
		...
		//const %20 = 11 : int
		_20 = 11;
		//invoke (%19) = (%2, %20) functioncall_3Vars_test574:func : function(int[],int)->(int[])
		{
			_FUNCTIONCALL_NO_COPY_PRE(_19, b, "false-MAYBE_RETURN-true" , "func");
			_DEALLOC(_19);
			void* tmp_x;
