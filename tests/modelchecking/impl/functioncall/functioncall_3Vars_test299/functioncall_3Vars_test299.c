#include "functioncall_3Vars_test299.h"
...
int main(int argc, char** args){
	...
	while(true){
		...
		//const %20 = 11 : int
		_20 = 11;
		//invoke (%19) = (%2, %20) functioncall_3Vars_test299:func : function(int[],int)->(int[])
		{
			_FUNCTIONCALL_NO_COPY_PRE(_19, b, "false-MAYBE_RETURN-false" , "func");
			_DEALLOC(_19);
