...
int main(int argc, char** args){
	...
	//invoke (%14) = (%1, %2, %3) 3parameter_test650:func : function(int[],int[],int[])->(int[])
	{
		_FUNCTIONCALL_NO_COPY_PRE(_14, c, "true-NEVER_RETURN-false" , "func");
		_FUNCTIONCALL_NO_COPY_PRE(_14, b, "true-NEVER_RETURN-false" , "func");
		_FUNCTIONCALL_NO_COPY_PRE(_14, a, "false-ALWAYS_RETURN-false" , "func");
		_DEALLOC(_14);
