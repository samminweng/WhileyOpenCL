...
int main(int argc, char** args){
	...
	//invoke (%14) = (%1, %2, %3) 3parameter_test218:func : function(int[],int[],int[])->(int[])
	{
		_FUNCTIONCALL_COPY_PRE(_14, c, "true-NEVER_RETURN-true" , "func");
		_FUNCTIONCALL_NO_COPY_PRE(_14, b, "true-MAYBE_RETURN-false" , "func");
