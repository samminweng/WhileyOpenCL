...
int main(int argc, char** args){
	...
	//invoke (%14) = (%1, %2, %3) 3parameter_test134:func : function(int[],int[],int[])->(int[])
	{
		_FUNCTIONCALL_NO_COPY_PRE(_14, c, "false-NEVER_RETURN-false" , "func");
		_FUNCTIONCALL_COPY_PRE(_14, b, "false-ALWAYS_RETURN-true" , "func");
