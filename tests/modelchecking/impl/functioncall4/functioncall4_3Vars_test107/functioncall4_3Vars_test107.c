#include "functioncall4_3Vars_test107.h"
...
int main(int argc, char** args){
	...
	while(true){
		...
		//const %21 = 3 : int
		_21 = 3;
		//invoke (%19) = (%2, %20, %21) functioncall4_3Vars_test107:func : function(int[],int,int)->(int[])
		{
			...
			_19 = _func_(tmp_a, b_size, _20, _21, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_19));
			if(_19 != tmp_a ){
				free(tmp_a);
			}
			_19_dealloc = true;
