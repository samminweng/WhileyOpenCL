#include "multiparameter_test38.h"
...
int main(int argc, char** args){
	...
	//invoke (%10) = (%1, %2) multiparameter_test38:func : function(int[],int[])->(int[])
	{
		_FUNCTIONCALL_NO_COPY_PRE(_10, b, "false-ALWAYS_RETURN-false" , "func");
