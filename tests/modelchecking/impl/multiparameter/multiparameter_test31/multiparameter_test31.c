#include "multiparameter_test31.h"
...
int main(int argc, char** args){
	...
	//invoke (%10) = (%1, %2) multiparameter_test31:func : function(int[],int[])->(int[])
	{
		_FUNCTIONCALL_NO_COPY_PRE(_10, b, "true-NEVER_RETURN-false" , "func");
		_FUNCTIONCALL_COPY_PRE(_10, a, "false-ALWAYS_RETURN-true" , "func");
		_DEALLOC(_10);
		void* tmp_a;
