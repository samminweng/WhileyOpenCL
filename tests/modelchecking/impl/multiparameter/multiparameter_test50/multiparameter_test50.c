#include "multiparameter_test50.h"
...
int main(int argc, char** args){
	...
	//invoke (%10) = (%1, %2) multiparameter_test50:func : function(int[],int[])->(int[])
	{
		_FUNCTIONCALL_COPY_PRE(_10, b, "false-ALWAYS_RETURN-true" , "func");
