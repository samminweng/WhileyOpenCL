...
int main(int argc, char** args){
	...
	//invoke (%10) = (%1, %11) FunctionCall2:func : function(int[],int)->(int[])
	{
		...
		_DEALLOC(_10);
		_10 = func(a_tmp = _COPY_1DARRAY_PARAM(a, T_INT), false, _11);
		_CALLER_DEALLOC(_10, a, "false-true-false" , "main");
		_ADD_DEALLOC(_10);
	}
	//assign %1 = %10  : int[]
	_DEALLOC(a);
...
blklab2:;
	...
	//invoke (%28) = (%2, %29) FunctionCall2:func : function(int[],int)->(int[])
	{
		...
		_DEALLOC(_28);
		_28 = func(b_tmp = _COPY_1DARRAY_PARAM(b, T_INT), false, _29);
		_CALLER_DEALLOC(_28, b, "false-true-true" , "main");
		_ADD_DEALLOC(_28);
	}
	//assign %3 = %28  : int[]
	_DEALLOC(c);
