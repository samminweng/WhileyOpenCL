...
int64_t* pickCoin(_DECL_1DARRAY_PARAM(moves), _DECL_DEALLOC_PARAM(moves), int64_t i, int64_t j, int64_t n, int64_t x, int64_t y, int64_t z, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	_DECL_1DARRAY(_7);
	_DECL_DEALLOC(_7);
	int64_t _8 = 0;
	int64_t _9 = 0;
...
blklab17:;
			//invoke (%41) = (%0, %5, %4, %1, %7, %6, %8) CoinGame4:pickCoin : function(int[],int,int,int,int,int,int)->(int[])
			{
				void* moves_tmp;
				_DEALLOC(_41);
				_41 = pickCoin(_COPY_1DARRAY_PARAM_int64_t(moves), false, i, j, n, x, y, z, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_41));
