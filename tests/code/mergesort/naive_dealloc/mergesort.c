...
_SLICE_ARRAY(_15, items, start, pivot);
	...
	_DEALLOC(_16);
	_16 = sortV1(_COPY_1DARRAY_PARAM(lhs), true, _17, pivot);
	_ADD_DEALLOC(_16);
	//assign %5 = %16  : int[]
	_DEALLOC(lhs);
...
_SLICE_ARRAY(_18, items, pivot, end);
	...
	_DEALLOC(_19);
	_19 = sortV1(_COPY_1DARRAY_PARAM(rhs), true, _20, _21);
	_ADD_DEALLOC(_19);
	//assign %6 = %19  : int[]
	_DEALLOC(rhs);
...
int main(int argc, char** args){
	...
	_DEALLOC(_11);
	_11 = sortV1(_COPY_1DARRAY_PARAM(ys), true, _12, _13);
	_ADD_DEALLOC(_11);
	//assign %1 = %11  : int[]
	_DEALLOC(ys);
...
blklab9:;
	...
	_DEALLOC(_25);
	_25 = sortV1(_COPY_1DARRAY_PARAM(ys), true, _26, _27);
	_ADD_DEALLOC(_25);
	//assign %1 = %25  : int[]
	_DEALLOC(ys);
...
blklab10:;
	...
	_DEALLOC(_38);
	_38 = sortV1(_COPY_1DARRAY_PARAM(ys), true, _39, _40);
	_ADD_DEALLOC(_38);
	//assign %1 = %38  : int[]
	_DEALLOC(ys);
...
blklab11:;
	...
	_DEALLOC(_52);
	_52 = sortV1(_COPY_1DARRAY_PARAM(ys), true, _53, _54);
	_ADD_DEALLOC(_52);
	//assign %1 = %52  : int[]
	_DEALLOC(ys);
...
blklab13:;
	...
	_DEALLOC(_70);
	_70 = sortV1(_COPY_1DARRAY_PARAM(arr), true, _71, _73);
	_ADD_DEALLOC(_70);
	//assign %4 = %70  : int[]
	_DEALLOC(arr);
