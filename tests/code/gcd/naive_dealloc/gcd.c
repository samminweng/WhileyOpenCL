...
int main(int argc, char** args){
	...
	_DEALLOC(_13);
	_NEW_1DARRAY_LONGLONG(_13, _12, _11);
	_ADD_DEALLOC(_13);
	//assign %2 = %13  : int[]
	_DEALLOC(gcds);
	_COPY_1DARRAY_LONGLONG(gcds, _13);
	_ADD_DEALLOC(gcds);
	//const %14 = 0 : int
	_14 = 0;
	//assign %3 = %14  : int
	...
	while(true){
		...
		while(true){
			...
			{
				void* gcds_tmp;
				_16 = gcd_cached(i, j, n, gcds_tmp = _COPY_1DARRAY_PARAM_LONGLONG(gcds), true);
