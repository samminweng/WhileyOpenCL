...
Image* sobelEdgeDetection(Image* input){
	...
	while(true){
		...
		while(true){
			...
			{
				_50 = convolution(_STRUCT_PARAM(input), x, y, _1DARRAY_PARAM(v_sobel));
			}
			//assign %11 = %50  : int
			v_g = _50;
			//invoke (%51) = (%0, %8, %9, %7) SobelEdge3:convolution : function(SobelEdge3:Image,int,int,int[])->(int)
			{
				_51 = convolution(_STRUCT_PARAM(input), x, y, _1DARRAY_PARAM(h_sobel));
			}
			//assign %12 = %51  : int
			h_g = _51;
...
blklab4:;
	...
	{
		_62 = image(width, height, _1DARRAY_PARAM(newPixels));
	}
	//return %62
	return _62;
	//return
...
int main(int argc, char** args){
	...
	//assign %3 = %10  : int
	size = _10;
	//const %12 = [105,109,97,103,101,46,106,112,103] : int[]
	_NEW_1DARRAY_int64_t(_12, 9, 0);
	_12[0] = 105; _12[1] = 109; _12[2] = 97; _12[3] = 103; _12[4] = 101; _12[5] = 46; _12[6] = 106; _12[7] = 112; _12[8] = 103; 
	...
	{
		_15 = image(width, height, _1DARRAY_PARAM(pixels));
	}
	...
	{
		_16 = sobelEdgeDetection(_STRUCT_PARAM(input));
	}
	...
	//invoke () = (%0, %6) SobelEdge3:print_image : method(whiley/lang/System:Console,SobelEdge3:Image)->()
	{
	...
	//const %22 = [79,117,116,112,117,116,32,73,109,97,103,101,58] : int[]
	_NEW_1DARRAY_int64_t(_22, 13, 0);
	_22[0] = 79; _22[1] = 117; _22[2] = 116; _22[3] = 112; _22[4] = 117; _22[5] = 116; _22[6] = 32; _22[7] = 73; _22[8] = 109; _22[9] = 97; _22[10] = 103; _22[11] = 101; _22[12] = 58; 
	//indirectinvoke () = %21 (%22) : method(int[])->()
	{
