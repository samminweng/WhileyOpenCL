...
blklab13:;
	...
	{
		void* C_data_tmp;
		_34 = matrix(_35, _36, _COPY_2DARRAY_PARAM_LONGLONG(C_data));
	}
	//return %34
	return _34;
	//return
...
blklab23:;
	...
	{
		void* rows_tmp;
		_15 = matrix(width, height, _COPY_2DARRAY_PARAM_LONGLONG(rows));
	}
	//return %15
	return _15;
	//return
...
blklab28:;
	...
	//invoke (%26) = (%2, %3) MatrixMult:multiply : function(MatrixMult:Matrix,MatrixMult:Matrix)->(MatrixMult:Matrix)
	{
		void* A_tmp;
		void* B_tmp;
		_26 = multiply(_COPY_STRUCT_PARAM(A, Matrix), _COPY_STRUCT_PARAM(B, Matrix));
	}
...
blklab29:;
	...
	{
		void* C_tmp;
		printMat(stdout, _COPY_STRUCT_PARAM(C, Matrix));
	}
