...
int main(int argc, char** args){
	...
	_DEALLOC(_11);
	_11 = bubbleSort(_1DARRAY_PARAM(ys), ys_dealloc);
...
blklab5:;
	...
	_DEALLOC(_25);
	_25 = bubbleSort(_1DARRAY_PARAM(ys), ys_dealloc);
...
blklab6:;
	...
	_DEALLOC(_38);
	_38 = bubbleSort(_1DARRAY_PARAM(ys), ys_dealloc);
...
blklab7:;
	...
	_DEALLOC(_52);
	_52 = bubbleSort(_1DARRAY_PARAM(ys), ys_dealloc);
...
blklab9:;
	...
	_DEALLOC(_68);
	_68 = bubbleSort(_1DARRAY_PARAM(arr), arr_dealloc);
	_TRANSFER_DEALLOC(_68, arr);
	//assign %4 = %68  : int[]
	_DEALLOC(arr);
