...
int main(int argc, char** args){
	...
	{
		_DEALLOC(_14);
		_14 = sobelEdgeDetection(_1DARRAY_PARAM(pixels), false, width, height, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_14));
	...
	//invoke () = (%0, %5, %1, %2) SobelEdge1:printImage : method(whiley/lang/System:Console,byte[],int,int)->()
	{
		...
		_RETAIN_DEALLOC(newPixels, "false-false-true" , "printImage");
	}
