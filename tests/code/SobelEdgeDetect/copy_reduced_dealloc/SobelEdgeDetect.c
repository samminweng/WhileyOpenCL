...
int main(int argc, char** args){
	...
	//assign %5 = %28  : int[]
	_DEALLOC(newPixels);
	_UPDATE_1DARRAY(newPixels, _28);
	_TRANSFER_DEALLOC(newPixels, _28);
	//const %29 = 1 : int
	_29 = 1;
	//neg %30 = %29 : int
	_30= -_29;
	...
	//assign %6 = %41  : int[]
	_DEALLOC(v_sobel);
	_UPDATE_1DARRAY(v_sobel, _41);
	_TRANSFER_DEALLOC(v_sobel, _41);
	//const %42 = 1 : int
	_42 = 1;
	//const %43 = 2 : int
	_43 = 2;
	...
	//assign %7 = %54  : int[]
	_DEALLOC(h_sobel);
	_UPDATE_1DARRAY(h_sobel, _54);
	_TRANSFER_DEALLOC(h_sobel, _54);
	//const %55 = 0 : int
	_55 = 0;
	//assign %8 = %55  : int
	x = _55;
	...
	while(true){
		...
		while(true){
			...
			_59 = convolution(_1DARRAY_PARAM(pixels), !pixels_dealloc, width, height, x, y, _1DARRAY_PARAM(v_sobel), !v_sobel_dealloc);
			//assign %11 = %59  : int
			v_g = _59;
			//invoke (%60) = (%4, %1, %2, %8, %9, %7) SobelEdgeDetect:convolution : function(int[],int,int,int,int,int[])->(int)
			_60 = convolution(_1DARRAY_PARAM(pixels), !pixels_dealloc, width, height, x, y, _1DARRAY_PARAM(h_sobel), !h_sobel_dealloc);
			//assign %12 = %60  : int
			h_g = _60;
			//add %61 = %11, %12 : int
			_61=v_g+h_g;
