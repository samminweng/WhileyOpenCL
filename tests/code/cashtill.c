...
int64_t* calculateChange(_DECL_1DARRAY_PARAM(till), int64_t change, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	{
		_7 = cash(_1DARRAYSIZE_PARAM_CALLBYREFERENCE(_7));
	}
	//return %7
	return _7;
	//goto blklab26
...
blklab25:;
	...
	while(true){
		...
		{
			void* tmp_tmp;
			_17 = calculateChange(_COPY_1DARRAY_PARAM_int64_t(tmp), _20);
		}
...
blklab34:;
		...
		{
			_18 = ArrayAppend(r, _19);
		}
		//assign %2 = %18  : int[]
		r = _18;
		//const %21 = [[49,99],[53,99],[49,48,99],[50,48,99],[53,48,99],[36,49],[36,53],[36,49,48]] : int[][]
		_NEW_1DARRAY_int64_t(_21, 8, 0);
		_21[0] = [49,99]; _21[1] = [53,99]; _21[2] = [49,48,99]; _21[3] = [50,48,99]; _21[4] = [53,48,99]; _21[5] = [36,49]; _21[6] = [36,53]; _21[7] = [36,49,48]; 
		//indexof %22 = %21, %4 : int[][]
		_22=_21[i];
		_22_size = _21_size_size;
		//invoke (%20) = (%2, %22) whiley/lang/Array:append : function(int[],int[])->(int[])
		{
			_20 = ArrayAppend(r, _22);
		}
		//assign %2 = %20  : int[]
		r = _20;
//.blklab33
...
int64_t* buy(FILE* console, _DECL_1DARRAY_PARAM(till), _DECL_1DARRAY_PARAM(given), int64_t cost, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	{
		void* given_tmp;
		_23 = toString(_COPY_1DARRAY_PARAM_int64_t(given), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_23));
	}
	...
	{
		void* given_tmp;
		_24 = total(_COPY_1DARRAY_PARAM_int64_t(given));
	}
...
blklab36:;
	...
	{
		void* given_tmp;
		_29 = total(_COPY_1DARRAY_PARAM_int64_t(given));
	}
	//sub %30 = %29, %3 : int
	_30=_29-cost;
	...
	{
		void* till_tmp;
		_28 = calculateChange(_COPY_1DARRAY_PARAM_int64_t(till), _30);
	}
...
blklab38:;
	...
	//invoke (%40) = (%1, %2) cashtill:add : function(cashtill:Cash,cashtill:Cash)->(cashtill:Cash)
	{
		void* till_tmp;
		void* given_tmp;
		_40 = add(_COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(given), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_40));
	}
	//assign %1 = %40  : int[]
	...
	{
		void* till_tmp;
		_47 = toString(_COPY_1DARRAY_PARAM_int64_t(till), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_47));
	}
...
int main(int argc, char** args){
	...
	{
		void* till_tmp;
		_16 = toString(_COPY_1DARRAY_PARAM_int64_t(till), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_16));
	}
	...
	//invoke (%17) = (%0, %1, %18, %21) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _18_tmp;
		_17 = buy(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_18), _21, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_17));
	}
	//assign %1 = %17  : int[]
	...
	//invoke (%22) = (%0, %1, %23, %26) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _23_tmp;
		_22 = buy(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_23), _26, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_22));
	}
	//assign %1 = %22  : int[]
	...
	//invoke (%27) = (%0, %1, %28, %31) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _28_tmp;
		_27 = buy(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_28), _31, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_27));
	}
	//assign %1 = %27  : int[]
	...
	//invoke (%32) = (%0, %1, %33, %36) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _33_tmp;
		_32 = buy(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_33), _36, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_32));
	}
	//assign %1 = %32  : int[]
