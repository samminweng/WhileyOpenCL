...
int64_t* func(_DECL_1DARRAY_PARAM(s), int64_t n, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	_DECL_1DARRAY(_2);
	_DECL_1DARRAY(t);
	_DECL_1DARRAY(new_t);
	int64_t _5 = 0;
...
int main(int argc, char** args){
	...
	{
		void* a_tmp;
		_10 = func(_COPY_1DARRAY_PARAM_int64_t(a), _11, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_10));
	}
	//assign %1 = %10  : int[]
...
blklab2:;
	...
	{
		void* b_tmp;
		_28 = func(_COPY_1DARRAY_PARAM_int64_t(b), _29, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_28));
	}
	//assign %3 = %28  : int[]
