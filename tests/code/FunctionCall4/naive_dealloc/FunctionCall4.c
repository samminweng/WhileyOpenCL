...
blklab0:;
	...
	//assign %4 = %13  : int[]
	_DEALLOC(new_t);
	_COPY_1DARRAY_LONGLONG(new_t, _13);
	_ADD_DEALLOC(new_t);
	//return %4
	_DEALLOC(s);
	_DEALLOC(_2);
...
int main(int argc, char** args){
	...
	//invoke (%10) = (%1, %11) FunctionCall4:func : function(int[],int)->(int[])
	{
		void* a_tmp;
		_DEALLOC(_10);
		_10 = func(_COPY_1DARRAY_PARAM_LONGLONG(a), true, _11, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_10));
...
blklab2:;
	...
	//invoke (%28) = (%2, %29) FunctionCall4:func : function(int[],int)->(int[])
	{
		void* b_tmp;
		_DEALLOC(_28);
		_28 = func(_COPY_1DARRAY_PARAM_LONGLONG(b), true, _29, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_28));
