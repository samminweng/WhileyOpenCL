...
int main(int argc, char** args){
	...
	_NEW_1DARRAY(_11, size, _10);
	//assign %4 = %11  : int[]
	_UPDATE_1DARRAY(pixels, _11);
	//const %12 = 0 : int
	_12 = 0;
	//const %13 = 0 : int
	_13 = 0;
	...
	{
		_19 = image(width, height, _1DARRAY_PARAM(pixels));
	}
	...
	{
		_20 = sobelEdgeDetection(_STRUCT_PARAM(input));
	}
