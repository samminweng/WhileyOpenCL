...
int64_t* _func_(_DECL_1DARRAY_PARAM(b), _DECL_1DARRAY_PARAM(c), int64_t i, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	{
		_FUNCTIONCALL_NO_COPY_PRE(_8, c, 1, "liveness: c = false, readonly: c = false, return:c = MAYBE_RETURN" , "func");
		_FUNCTIONCALL_COPY_PRE(_8, b, 0, "liveness: b = true, readonly: b = false, return:b = NEVER_RETURN" , "func");
		_DEALLOC(_8);
		void* tmp_b;
...
blklab0:;
	...
	{
		_FUNCTIONCALL_NO_COPY_PRE(_17, b, 1, "liveness: b = false, readonly: b = false, return:b = MAYBE_RETURN" , "func");
		_FUNCTIONCALL_NO_COPY_PRE(_17, c, 0, "liveness: c = false, readonly: c = false, return:c = NEVER_RETURN" , "func");
		_DEALLOC(_17);
...
int main(int argc, char** args){
	...
	{
		_FUNCTIONCALL_COPY_PRE(_13, c, 1, "liveness: c = true, readonly: c = false, return:c = MAYBE_RETURN" , "func");
		_FUNCTIONCALL_COPY_PRE(_13, b, 0, "liveness: b = true, readonly: b = false, return:b = NEVER_RETURN" , "func");
		_DEALLOC(_13);
		void* tmp_b;
		_COPY_1DARRAY_PARAM(b, tmp_b, int64_t);
		void* tmp_c;
	...
	{
		_FUNCTIONCALL_NO_COPY_PRE(_17, c, 1, "liveness: c = false, readonly: c = false, return:c = MAYBE_RETURN" , "func");
		_FUNCTIONCALL_NO_COPY_PRE(_17, b, 0, "liveness: b = false, readonly: b = false, return:b = NEVER_RETURN" , "func");
		_DEALLOC(_17);
		// isCopyEliminated of 'b at 0' = true
		// isCopyEliminated of 'c at 1' = true
		_17 = _func_(b, b_size, c, c_size, _18, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_17));
		if( _17 == c ){
			_17_dealloc = c_dealloc;
			c_dealloc = false;
		} else {
			_17_dealloc = true;
		}
