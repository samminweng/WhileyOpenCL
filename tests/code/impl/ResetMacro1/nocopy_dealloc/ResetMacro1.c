...
int main(int argc, char** args){
	...
	//invoke (%6) = (%1, %7) ResetMacro1:func : function(int[],int)->(int[])
	{
		...
		_RESET_DEALLOC(_6, x, "false-true-true" , "func");
	}
	//assign %2 = %6  : int[]
	_DEALLOC(y);
	// isCopyEliminated = true
...
blklab3:;
	...
	//const %19 = 10 : int
	_19 = 10;
	//invoke (%18) = (%1, %19) ResetMacro1:func : function(int[],int)->(int[])
	{
		_DEALLOC(_18);
		// isCopyEliminated of '_1' = true
		_18 = _func_(_1DARRAY_PARAM(x), false, _19, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_18));
		_RESET_DEALLOC(_18, x, "false-true-true" , "func");
	}
	//assign %2 = %18  : int[]
	_DEALLOC(y);
	// isCopyEliminated = true
...
blklab4:;
	...
	//const %31 = 9 : int
	_31 = 9;
	//invoke (%30) = (%1, %31) ResetMacro1:func : function(int[],int)->(int[])
	{
		_DEALLOC(_30);
		// isCopyEliminated of '_1' = true
		_30 = _func_(_1DARRAY_PARAM(x), false, _31, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_30));
