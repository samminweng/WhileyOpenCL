...
int64_t* _findMoves_(_DECL_1DARRAY_PARAM(moves), _DECL_DEALLOC_PARAM(moves), int64_t n, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	while(true){
		...
		_NEW1DARRAY_DEALLOC(_11, _10, n);
		//assign %4 = %11  : int[]
		_ADD_DEALLOC(x, _11, 1, int64_t);
		//const %12 = 0 : int
		_12 = 0;
		//arraygen %13 = [12; 1] : int[]
		_DEALLOC(_13);
		_NEW_1DARRAY_int64_t(_13, n, _12);
		_NEW1DARRAY_DEALLOC(_13, _12, n);
		//assign %5 = %13  : int[]
		_ADD_DEALLOC(y, _13, 1, int64_t);
		//const %14 = 0 : int
		_14 = 0;
		//arraygen %15 = [14; 1] : int[]
		_DEALLOC(_15);
		_NEW_1DARRAY_int64_t(_15, n, _14);
		_NEW1DARRAY_DEALLOC(_15, _14, n);
		//assign %6 = %15  : int[]
		_ADD_DEALLOC(z, _15, 1, int64_t);
		//assign %7 = %3  : int
		j = s;
		//const %16 = 0 : int
		_16 = 0;
