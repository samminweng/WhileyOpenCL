...
int main(int argc, char** args){
	...
	{
		_FUNCTIONCALL_COPY_PRE(_10, a, 0, "liveness: a = false, readonly: a = true, return:a = MAYBE_RETURN" , "func");
		_DEALLOC(_10);
		void* tmp_s;
...
blklab2:;
	...
	{
		_FUNCTIONCALL_COPY_PRE(_28, b, 0, "liveness: b = true, readonly: b = true, return:b = MAYBE_RETURN" , "func");
		_DEALLOC(_28);
		void* tmp_s;
