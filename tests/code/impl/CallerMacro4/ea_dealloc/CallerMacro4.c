...
int64_t* _func_(_DECL_1DARRAY_PARAM(x), _DECL_DEALLOC_PARAM(x), int64_t num, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	//assign %4 = %12  : int[]
	_ADD_DEALLOC(b, _12, 1, int64_t);
	//assign %5 = %3  : int[]
	_ADD_DEALLOC(c, a, 1, int64_t);
	//assign %6 = %4  : int[]
	_ADD_DEALLOC(d, b, 1, int64_t);
	//const %13 = 10 : int
	_13 = 10;
