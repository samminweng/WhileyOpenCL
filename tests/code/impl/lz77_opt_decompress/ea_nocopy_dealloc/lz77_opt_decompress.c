...
blklab18:;
	...
	//assign %1 = %39  : byte[]
	// isCopyEliminated = true
	_TRANSFER_DEALLOC(output, _39, 1);
	//return %1
	_DEALLOC(data);
	_DEALLOC(items);
	_DEALLOC(_13);
...
int main(int argc, char** args){
	...
	//assign %3 = %8  : byte[]
	// isCopyEliminated = true
	_TRANSFER_DEALLOC(decompress_data, _8, 1);
