...
int64_t* _buy_(FILE* console, _DECL_1DARRAY_PARAM(till), _DECL_1DARRAY_PARAM(given), int64_t cost, _DECL_1DARRAYSIZE_PARAM_CALLBYREFERENCE){
	...
	{
		void* given_tmp;
		_23 = _toString_(_COPY_1DARRAY_PARAM_int64_t(given), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_23));
	}
	...
	{
		void* given_tmp;
		_24 = _total_(_COPY_1DARRAY_PARAM_int64_t(given));
	}
...
blklab36:;
	...
	{
		void* given_tmp;
		_29 = _total_(_COPY_1DARRAY_PARAM_int64_t(given));
	}
	//sub %30 = %29, %3 : int
	_30=_29-cost;
	...
	{
		void* till_tmp;
		_28 = _calculateChange_(_COPY_1DARRAY_PARAM_int64_t(till), _30, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_28));
	}
...
blklab38:;
	...
	{
		void* change_tmp;
		_39 = _toString_(_COPY_1DARRAY_PARAM_int64_t(change), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_39));
	}
	...
	//invoke (%40) = (%1, %2) cashtill:add : function(cashtill:Cash,cashtill:Cash)->(cashtill:Cash)
	{
		void* till_tmp;
		void* given_tmp;
		_40 = _add_(_COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(given), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_40));
	}
	//assign %1 = %40  : int[]
	...
	//invoke (%41) = (%1, %5) cashtill:subtract : function(cashtill:Cash,cashtill:Cash)->(cashtill:Cash)
	{
		void* till_tmp;
		void* change_tmp;
		_41 = _subtract_(_COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(change), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_41));
	}
	//assign %1 = %41  : int[]
	...
	{
		void* till_tmp;
		_47 = _toString_(_COPY_1DARRAY_PARAM_int64_t(till), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_47));
	}
...
int main(int argc, char** args){
	...
	{
		void* till_tmp;
		_16 = _toString_(_COPY_1DARRAY_PARAM_int64_t(till), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_16));
	}
	...
	{
		void* _20_tmp;
		_18 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_20), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_18));
	}
	//const %21 = 85 : int
	_21 = 85;
	//invoke (%17) = (%0, %1, %18, %21) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _18_tmp;
		_17 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_18), _21, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_17));
	}
	//assign %1 = %17  : int[]
	...
	{
		void* _25_tmp;
		_23 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_25), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_23));
	}
	//const %26 = 105 : int
	_26 = 105;
	//invoke (%22) = (%0, %1, %23, %26) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _23_tmp;
		_22 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_23), _26, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_22));
	}
	//assign %1 = %22  : int[]
	...
	{
		void* _30_tmp;
		_28 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_30), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_28));
	}
	//const %31 = 5 : int
	_31 = 5;
	//invoke (%27) = (%0, %1, %28, %31) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _28_tmp;
		_27 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_28), _31, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_27));
	}
	//assign %1 = %27  : int[]
	...
	{
		void* _35_tmp;
		_33 = _Cash_1_(_COPY_1DARRAY_PARAM_int64_t(_35), _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_33));
	}
	//const %36 = 305 : int
	_36 = 305;
	//invoke (%32) = (%0, %1, %33, %36) cashtill:buy : method(whiley/lang/System:Console,cashtill:Cash,cashtill:Cash,int)->(cashtill:Cash)
	{
		void* till_tmp;
		void* _33_tmp;
		_32 = _buy_(stdout, _COPY_1DARRAY_PARAM_int64_t(till), _COPY_1DARRAY_PARAM_int64_t(_33), _36, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_32));
	}
	//assign %1 = %32  : int[]
