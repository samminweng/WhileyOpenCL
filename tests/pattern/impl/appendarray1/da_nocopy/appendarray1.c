...
blklab9:;
	...
	{
		// isCopyEliminated of '_1' = true
		_25 = _resize_(output, output_size, size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_25));
	}
	//assign %1 = %25  : byte[]
	// isCopyEliminated = true
	_UPDATE_1DARRAY(output, _25);
...
int main(int argc, char** args){
	...
	{
		// isCopyEliminated of '_1' = true
		_8 = _f_append_(input, input_size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_8));
	}
	//assign %2 = %8  : byte[]
	// isCopyEliminated = true
	...
	{
		// isCopyEliminated of '_1' = true
		_9 = _f_resize_(input, input_size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_9));
	}
	//assign %3 = %9  : byte[]
	// isCopyEliminated = true
