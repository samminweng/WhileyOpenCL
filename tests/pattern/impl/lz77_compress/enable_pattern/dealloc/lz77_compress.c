...
int main(int argc, char** args){
	...
	//invoke (%22) = (%2) lz77_compress:compress : function(byte[])->(byte[])
	{
		void* data_tmp;
		_DEALLOC(_22);
		_22 = _compress_(_COPY_1DARRAY_PARAM_BYTE(data), true, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_22));
	...
	//invoke (%37) = (%3) lz77_compress:decompress : function(byte[])->(byte[])
	{
		...
		_DEALLOC(_37);
		_37 = _decompress_(_COPY_1DARRAY_PARAM_BYTE(compress_data), true, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_37));
