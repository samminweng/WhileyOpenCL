...
int main(int argc, char** args){
	...
	//invoke (%22) = (%2) lz77_compress:compress : function(byte[])->(byte[])
	{
		...
		_22 = _compress_(data, data_size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_22));
	}
	//assign %3 = %22  : byte[]
	// isCopyEliminated = true
	...
	//invoke (%37) = (%3) lz77_compress:decompress : function(byte[])->(byte[])
	{
		...
		_37 = _decompress_(compress_data, compress_data_size, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_37));
	}
	//assign %5 = %37  : byte[]
	// isCopyEliminated = true
