...
blklab10:;
	...
	//invoke (%23) = (%1, %18) AppendArray:resize : function(byte[],int)->(byte[])
	{
		void* output_tmp;
		_DEALLOC(_23);
		_23 = resize(_COPY_1DARRAY_PARAM_BYTE(output), true, _18, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_23));
...
int main(int argc, char** args){
	...
	//invoke (%7) = (%1) AppendArray:f : function(byte[])->(byte[])
	{
		void* data_tmp;
		_DEALLOC(_7);
		_7 = f(_COPY_1DARRAY_PARAM_BYTE(data), true, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_7));
