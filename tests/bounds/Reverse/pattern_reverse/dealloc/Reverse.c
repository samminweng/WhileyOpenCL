...
int main(int argc, char** args){
	...
	//invoke (%3) = (%9) Reverse:reverse : function(int[])->(int[])
	{
		void* _9_tmp;
		_DEALLOC(_3);
		_3 = reverse(_COPY_1DARRAY_PARAM_int64_t(_9), true, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_3));
		_CALLEE_DEALLOC(_9, "false-false-false" , "reverse");
		_ADD_DEALLOC(_3);
	}
	//assign %1 = %3  : int[]
	_DEALLOC(rs);
...
blklab4:;
	...
	//invoke (%18) = (%29) Reverse:reverse : function(int[])->(int[])
	{
		void* _29_tmp;
		_DEALLOC(_18);
		_18 = reverse(_COPY_1DARRAY_PARAM_int64_t(_29), true, _1DARRAYSIZE_PARAM_CALLBYREFERENCE(_18));
		_CALLEE_DEALLOC(_29, "false-false-false" , "reverse");
		_ADD_DEALLOC(_18);
	}
	//assign %2 = %18  : int[]
	_DEALLOC(rs2);
