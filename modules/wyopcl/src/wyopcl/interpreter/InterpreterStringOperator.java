...
public class InterpreterStringOperator extends Interpreter {
	...
	public void interpret(Codes.StringOperator code, StackFrame stackframe) {		
		...
		Constant.Strung left = (Constant.Strung)stackframe.getRegister(code.leftOperand);
		Constant.Strung right = (Constant.Strung)stackframe.getRegister(code.rightOperand);
		//Check the operator
