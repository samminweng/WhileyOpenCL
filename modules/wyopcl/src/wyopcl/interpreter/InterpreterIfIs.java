...
public class InterpreterIfIs extends Interpreter{
	private static InterpreterIfIs instance;	
	public InterpreterIfIs(){		
	}
	
	/*Implement the Singleton pattern to ensure this class has one instance.*/
	public static InterpreterIfIs getInstance(){
		if (instance == null){
			instance = new InterpreterIfIs();
		}
		return instance;
	}
