...
//				wyilExcludes, classDir));
		...
		WyilInterpreter interpreter = new WyilInterpreter(project);
		
		if (verbose) {
			interpreter.setLogger(new Logger.Default(System.err));
		}
		
		project.add(new StdBuildRule(interpreter, wyilDir, wyilIncludes,
				wyilExcludes, classDir));
	}
