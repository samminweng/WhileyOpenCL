...
public final class TranslatorHelper {
	...
	/**
	 * Given a code block, tries to find the matching pattern and do the pattern transformation (if available).  
	 * @param params the list of input parameter types
	 * @param code_blk the list of code for a function
	 * @return the transformed code. If the pattern is not transformable, then return the original code block.
	 */
