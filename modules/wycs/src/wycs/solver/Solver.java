...
public final class Solver {
	...
	private final static class Reduction_68 extends AbstractRewriteRule implements ReductionRule {
		...
		public final boolean apply(Automaton automaton, Object _state) {
			...
			boolean r22 = false;           // |xs| le |ys| && wyrl.core.Expr$Comprehension@567e0121
			if(r21) {
	...
	private final static Pattern.Term pattern54 = new Pattern.Term("Div",
		new Pattern.List(false, new Pair[]{
			...
			new Pair(new Pattern.Term("Num",
				...
				"n"),null)}),
		null);
	private final static Pattern.Term pattern55 = new Pattern.Term("Sum",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type17), "n"), 
			new Pair(new Pattern.Bag(false, new Pair[]{}),null)}),
		null);
	private final static Pattern.Term pattern56 = new Pattern.Term("Sum",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type17), "n"), 
			new Pair(new Pattern.Bag(true, new Pair[]{
				new Pair(new Pattern.Leaf(type18), "x"), 
				new Pair(new Pattern.Leaf(type18), "rest")}),null)}),
		null);
	private final static Pattern.Term pattern57 = new Pattern.Term("Sum",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type17), "x"), 
			new Pair(new Pattern.Bag(true, new Pair[]{
				new Pair(new Pattern.Term("Num",
	...
	private final static Pattern.Term pattern59 = new Pattern.Term("Sum",
		new Pattern.List(false, new Pair[]{
			...
			new Pair(new Pattern.Bag(true, new Pair[]{
				...
				new Pair(new Pattern.Leaf(type18), "xs")}),null)}),
		null);
	private final static Pattern.Term pattern60 = new Pattern.Term("Equation",
		new Pattern.List(false, new Pair[]{
			...
			new Pair(new Pattern.Term("Num",
				...
				"v"),null)}),
		null);
	private final static Pattern.Term pattern61 = new Pattern.Term("And",
		new Pattern.Set(true, new Pair[]{
			...
			new Pair(new Pattern.Leaf(type10), "bs")}),
		null);
	private final static Pattern.Term pattern62 = new Pattern.Term("Not",
		new Pattern.Term("Equation",
			...
			null),
		null);
	private final static Pattern.Term pattern63 = new Pattern.Term("Not",
		new Pattern.Term("Equation",
			new Pattern.List(false, new Pair[]{
			...
			null),
		null);
	private final static Pattern.Term pattern64 = new Pattern.Term("Equals",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type22), "t"), 
			new Pair(new Pattern.Bag(false, new Pair[]{
		...
		null);
	private final static Pattern.Term pattern65 = new Pattern.Term("Inequality",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type22), "t"), 
			new Pair(new Pattern.Term("Num",
				new Pattern.Leaf(type17),
	...
	private final static Pattern.Term pattern67 = new Pattern.Term("And",
		...
		null);
	private final static Pattern.Term pattern68 = new Pattern.Term("Equals",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type2), "t"), 
			new Pair(new Pattern.Bag(false, new Pair[]{
				...
				new Pair(new Pattern.Term("Set",
					...
					null),null)}),null)}),
		null);
	private final static Pattern.Term pattern69 = new Pattern.Term("And",
		new Pattern.Set(true, new Pair[]{
			new Pair(new Pattern.Term("Equals",
				new Pattern.List(false, new Pair[]{
					new Pair(new Pattern.Leaf(type2), "t"), 
			...
			new Pair(new Pattern.Leaf(type10), "bs")}),
		null);
	private final static Pattern.Term pattern70 = new Pattern.Term("LengthOf",
		...
		new Pattern.List(false, new Pair[]{
			...
			new Pair(new Pattern.Bag(false, new Pair[]{
				...
				new Pair(new Pattern.Term("Num",
					...
					"y"),null)}),null)}),
		null);
	private final static Pattern.Term pattern72 = new Pattern.Term("SubsetEq",
		new Pattern.List(false, new Pair[]{
			...
			new Pair(new Pattern.Term("Set",
				...
				null), "s2")}),
		null);
	private final static Pattern.Term pattern73 = new Pattern.Term("SubsetEq",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Leaf(type28), "t"), 
			new Pair(new Pattern.Leaf(type27), "x"), 
			new Pair(new Pattern.Leaf(type27), "y")}),
		null);
	private final static Pattern.Term pattern74 = new Pattern.Term("SubsetEq",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Term("SetT",
				new Pattern.List(false, new Pair[]{
					new Pair(new Pattern.Leaf(type3), "b"), 
	...
	private final static Pattern.Term pattern77 = new Pattern.Term("And",
		new Pattern.Set(true, new Pair[]{
			...
			new Pair(new Pattern.Leaf(type10), "rest")}),
		null);
	private final static Pattern.Term pattern78 = new Pattern.Term("ForAll",
		new Pattern.List(false, new Pair[]{
		...
		null);
	private final static Pattern.Term pattern79 = new Pattern.Term("ForAll",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Set(true, new Pair[]{
				new Pair(new Pattern.List(false, new Pair[]{
					new Pair(new Pattern.Leaf(type31),null), 
			...
			new Pair(new Pattern.Term("ForAll",
				...
				null),null)}),
		null);
	private final static Pattern.Term pattern80 = new Pattern.Term("Not",
	...
	private final static Pattern.Term pattern84 = new Pattern.Term("And",
		new Pattern.Set(true, new Pair[]{
			...
			new Pair(new Pattern.Leaf(type10), "rs")}),
		null);
	private final static Pattern.Term pattern85 = new Pattern.Term("Exists",
		new Pattern.List(false, new Pair[]{
			new Pair(new Pattern.Set(true, new Pair[]{
				new Pair(new Pattern.List(false, new Pair[]{
					new Pair(new Pattern.Leaf(type31),null), 
	...
	public static final InferenceRule[] inferences = new InferenceRule[]{
		...
		new Inference_2(pattern61),
		new Inference_3(pattern67),
		new Inference_4(pattern74),
		new Inference_5(pattern77),
		new Inference_6(pattern81),
		new Inference_7(pattern82),
		new Inference_8(pattern83),
		new Inference_9(pattern84)
	};
	public static final ReductionRule[] reductions = new ReductionRule[]{
		...
		new Reduction_59(pattern62),
		new Reduction_60(pattern63),
		new Reduction_61(pattern64),
		new Reduction_62(pattern65),
		new Reduction_63(pattern66),
		new Reduction_64(pattern68),
		new Reduction_65(pattern69),
		new Reduction_66(pattern70),
		new Reduction_67(pattern71),
		new Reduction_68(pattern72),
		new Reduction_69(pattern73),
		new Reduction_70(pattern75),
		new Reduction_71(pattern76),
		new Reduction_72(pattern78),
		new Reduction_73(pattern79),
		new Reduction_74(pattern80),
		new Reduction_75(pattern85),
		new Reduction_76(pattern86),
		new Reduction_77(pattern87),
